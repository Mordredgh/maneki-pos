function showSection(sectionName) {
  ...
  if (sectionName === "reportes") {
    salesHistoryPage = 1;
    const si = document.getElementById("salesSearchInput");
    if (si) si.value = "";
    setTimeout(() => {
  ...
  if (sectionName === "analisis") setTimeout(() => {
  ...
  if (sectionName === "equipos") {
    ...
    setTimeout(() => {
      if (typeof renderGraficaROI === "function") renderGraficaROI();
    }, 300);
  }
