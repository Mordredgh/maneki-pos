"use strict";const CATEGORY_ICON_MAP={tazas:"tazas",llaveros:"llaveros",peluches:"peluches",otros:"otros",ropaytextiles:"ropa-y-textiles",cajasregalo:"cajas-de-regalo",vasosytumblers:"vasos-y-tumblers",velas:"velas",setsypacks:"sets-y-packs",cuadrosyarte:"cuadros-y-arte",stickers:"stickers",papeleria:"papeleria",globosydecoracion:"globos-y-decoracion"};function _catIconSlug(t){const e=String(t||"").toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").replace(/[^a-z0-9]/g,"");return CATEGORY_ICON_MAP[e]||null}function renderCategoriesGrid(){const t=document.getElementById("categoriesGrid");t.innerHTML=categories.map(e=>{const a=products.filter(c=>c.category===e.id).length,o=_esc(e.color||"#FFD166"),i=_esc(e.id),r=_catIconSlug(e.name),n=r?`<img src="img/categorias/${r}.webp" alt="" style="width:34px;height:34px;object-fit:contain;">`:_esc(e.emoji);return`
                    <div class="category-card bg-white p-6 rounded-2xl shadow-sm border-2 transition-all hover:shadow-md" style="border-color: ${o}20; border-top: 4px solid ${o}">
                        ...
                        <p class="text-sm font-medium" style="color: ${e.color||"#FFD166"}">${a} producto${a!==1?"s":""}</p>
                    </div>
                `}).join("")}document.addEventListener("click",function(t){const e=t.target.closest(".cat-action-btn[data-catid]");if(!e)return;const a=e.dataset.catid,o=e.dataset.cataction;o==="edit"?editCategory(a):o==="delete"&&deleteCategory(a)});function selectCategoryColor(t){_selectColorGeneric(t,"categoryColor","color-btn")}function closeAddCategoryModal(){closeModal("addCategoryModal"),document.getElementById("addCategoryForm").reset()}document.getElementById("addCategoryForm").addEventListener("submit",async function(t){t.preventDefault();const e=document.getElementById("categoryName").value,a=document.getElementById("categoryEmoji").value;let o=e.toLowerCase().replace(/\s+/g,"_").replace(/[^a-z0-9_\u00e0-\u00ff]/g,""),i=o,r=2;for(;categories.find(d=>d.id.toLowerCase()===i.toLowerCase());)i=o+"_"+r++;const n=document.getElementById("categoryColor")?.value||"#FFD166",c={id:i,name:e,emoji:a,color:n};categories.push(c),renderCategoriesGrid(),updateCategorySelects();try{await saveCategories(),typeof window._mkModalSaved=="function"&&window._mkModalSaved("addCategoryModal"),closeAddCategoryModal(),manekiToastExport("\u2705 Categor\xEDa creada exitosamente","ok")}catch{manekiToastExport("\u274C No se pudo guardar la categor\xEDa en la nube. Revisa tu conexi\xF3n e intenta de nuevo.","err")}});function deleteCategory(t){const e=products.filter(o=>o.category===t).length;if(e>0){manekiToastExport(`No puedes eliminar esta categor\xEDa: tiene ${e} producto(s) asociado(s).`,"error");return}const a=categories.find(o=>o.id===t);showConfirm(`La categor\xEDa "${a?a.name:"esta categor\xEDa"}" ser\xE1 eliminada permanentemente.`,"\u26A0\uFE0F Eliminar categor\xEDa").then(o=>{o&&(categories=categories.filter(i=>i.id!==t),renderCategoriesGrid(),updateCategorySelects(),typeof window.deleteCategoryFromDB=="function"&&window.deleteCategoryFromDB(t))})}function editCategory(t){const e=categories.find(a=>a.id===t);e&&(document.getElementById("editCategoryId").value=e.id,document.getElementById("editCategoryName").value=e.name,document.getElementById("editCategoryEmoji").value=e.emoji||"\u{1F4E6}",document.getElementById("editSelectedEmojiDisplay").textContent=e.emoji||"\u{1F4E6}",document.getElementById("editEmojiSearch").value="",document.getElementById("editCategoryColor").value=e.color||"#FFD166",openModal("editCategoryModal"),setTimeout(()=>{selectEditColor(e.color||"#FFD166"),renderEditEmojiGrid()},50))}function closeEditCategoryModal(){closeModal("editCategoryModal")}function selectEditColor(t){_selectColorGeneric(t,"editCategoryColor","edit-color-btn")}function renderEditEmojiGrid(t=""){_renderEmojiPickerGrid("editEmojiGrid",emojiCategories,CATEGORY_EMOJI_KEYWORDS,t,"edit-emoji-btn","selectEditEmoji")}function selectEditEmoji(t){_selectEmojiGeneric(t,"editCategoryEmoji","editSelectedEmojiDisplay","edit-emoji-btn")}function filterEditEmojis(t){renderEditEmojiGrid(t)}async function saveEditCategory(){const t=document.getElementById("editCategoryId").value,e=document.getElementById("editCategoryName").value.trim(),a=document.getElementById("editCategoryEmoji").value||"\u{1F4E6}",o=document.getElementById("editCategoryColor").value||"#FFD166";if(!e){manekiToastExport("\u26A0\uFE0F El nombre no puede estar vac\xEDo","warn");return}const i=categories.findIndex(r=>r.id===t);if(i!==-1){categories[i].name=e,categories[i].emoji=a,categories[i].color=o,products.forEach(r=>{r.category===t&&!r.imageUrl&&(r.image=a)}),renderCategoriesGrid(),updateCategorySelects(),saveProducts();try{await saveCategories(),typeof window._mkModalSaved=="function"&&window._mkModalSaved("editCategoryModal"),closeEditCategoryModal(),manekiToastExport("\u2705 Categor\xEDa actualizada","ok")}catch{manekiToastExport("\u274C No se pudo guardar la categor\xEDa en la nube. Revisa tu conexi\xF3n e intenta de nuevo.","err")}}}function updateCategorySelects(){const t=categories.map(e=>`<option value="${_esc(e.id)}">${_esc(e.emoji)} ${_esc(e.name)}</option>`).join("");["productCategory","ptCategory","mpCategory"].forEach(e=>{const a=document.getElementById(e);if(!a)return;const o=a.value;a.innerHTML=t,o&&a.querySelector(`option[value="${CSS.escape?CSS.escape(o):o}"]`)&&(a.value=o)})}
//# sourceMappingURL=categorias.js.map

;
"use strict";typeof window.showSection>"u"&&(window.showSection=function(t){document.querySelectorAll('section[id$="-section"], section[id$="Section"]').forEach(i=>{i.classList.add("hidden"),i.style.display=""});const e=document.getElementById(t+"-section")||document.getElementById(t+"Section");e&&e.classList.remove("hidden")}),(function(){const t={rojo:"#ef4444",roja:"#ef4444",red:"#ef4444",azul:"#3b82f6",azules:"#3b82f6",blue:"#3b82f6","azul marino":"#1e3a8a",marino:"#1e3a8a",verde:"#22c55e",green:"#22c55e",amarillo:"#eab308",amarilla:"#eab308",yellow:"#eab308",dorado:"#d97706",gold:"#d97706",negro:"#1f2937",negra:"#1f2937",black:"#1f2937",blanco:"#f9fafb",blanca:"#f9fafb",white:"#f9fafb",rosa:"#ec4899",pink:"#ec4899","rosa mexicano":"#e91e8c",morado:"#ab84d1",morada:"#ab84d1",violeta:"#8b5cf6",lila:"#c084fc",lavanda:"#c4b5fd",purple:"#ab84d1",naranja:"#f97316",orange:"#f97316",gris:"#9ca3af",grise:"#9ca3af",gray:"#9ca3af",grey:"#9ca3af",plateado:"#94a3b8",silver:"#94a3b8",caf\u00E9:"#92400e",cafe:"#92400e",marr\u00F3n:"#92400e",marron:"#92400e",brown:"#78350f",beige:"#e5c9a0",crema:"#fef3c7",turquesa:"#06b6d4",celeste:"#7dd3fc",cian:"#22d3ee",cyan:"#22d3ee",aqua:"#22d3ee",coral:"#f87171",salmon:"#fca5a5",salm\u00F3n:"#fca5a5",oliva:"#84cc16",olive:"#65a30d",magenta:"#e879f9",fucsia:"#e879f9",fuchsia:"#e879f9",vino:"#9f1239",burgundy:"#9f1239",guinda:"#9f1239",indigo:"#6366f1","azul cielo":"#7dd3fc","azul rey":"#2563eb","azul claro":"#93c5fd","verde militar":"#4d7c0f","verde lim\xF3n":"#a3e635","verde menta":"#6ee7b7","verde oliva":"#65a30d","rojo vino":"#9f1239"},e={rojo:"\u{1F534}",roja:"\u{1F534}",red:"\u{1F534}",azul:"\u{1F535}",blue:"\u{1F535}","azul marino":"\u{1F535}",marino:"\u{1F535}",verde:"\u{1F7E2}",green:"\u{1F7E2}",amarillo:"\u{1F7E1}",amarilla:"\u{1F7E1}",yellow:"\u{1F7E1}",dorado:"\u{1F7E1}",gold:"\u{1F7E1}",negro:"\u26AB",negra:"\u26AB",black:"\u26AB",blanco:"\u26AA",blanca:"\u26AA",white:"\u26AA",rosa:"\u{1FA77}",pink:"\u{1FA77}","rosa mexicano":"\u{1FA77}",morado:"\u{1F7E3}",morada:"\u{1F7E3}",violeta:"\u{1F7E3}",lila:"\u{1F7E3}",purple:"\u{1F7E3}",naranja:"\u{1F7E0}",orange:"\u{1F7E0}",caf\u00E9:"\u{1F7E4}",cafe:"\u{1F7E4}",marr\u00F3n:"\u{1F7E4}",marron:"\u{1F7E4}",brown:"\u{1F7E4}",beige:"\u{1F7E4}",crema:"\u{1F7E1}",gris:"\u{1FA76}",plateado:"\u{1FA76}",silver:"\u{1FA76}",gray:"\u{1FA76}",grey:"\u{1FA76}",turquesa:"\u{1F535}",celeste:"\u{1F535}",cian:"\u{1F535}",cyan:"\u{1F535}",coral:"\u{1F534}",salmon:"\u{1FA77}",salm\u00F3n:"\u{1FA77}",vino:"\u{1F534}",burgundy:"\u{1F534}",guinda:"\u{1F534}",magenta:"\u{1F7E3}",fucsia:"\u{1F7E3}",fuchsia:"\u{1F7E3}",indigo:"\u{1F7E3}"},i=o=>/color|colour|color\s*\/\s*tono/i.test(o||"");window._mkColorDot=function(o,n){const a=_esc;if(!i(o))return`<span style="font-weight:600;">${a(n)}</span>`;const r=(n||"").toLowerCase().trim(),l=t[r],d=r==="blanco"||r==="blanca"||r==="white"||r==="crema"?"#d1d5db":"transparent";return l?`<span style="display:inline-flex;align-items:center;gap:5px;font-weight:600;">
            <span style="display:inline-block;width:14px;height:14px;border-radius:50%;background:${l};border:1.5px solid ${d};flex-shrink:0;"></span>${a(n)}</span>`:`<span style="display:inline-flex;align-items:center;gap:5px;font-weight:600;">
            <span style="display:inline-block;width:14px;height:14px;border-radius:50%;background:${n.startsWith("#")||/^(rgb|hsl)/.test(n)?n:"#d1d5db"};border:1.5px solid #e5e7eb;flex-shrink:0;"></span>${a(n)}</span>`},window._mkColorEmoji=function(o,n){if(!i(o))return n;const a=(n||"").toLowerCase().trim(),r=e[a];return r?`${r} ${n}`:n}})(),window._normSearch=function(e){return String(e||"").toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"")},window._money=function(t){return Math.round((parseFloat(t)||0)*100)/100},window._sumLineas=function(t,e,i){return e=e||"price",i=i||"quantity",t.reduce((o,n)=>{const a=Math.round((parseFloat(n[e])||0)*100)*(parseInt(n[i])||1);return o+a},0)/100},window._ajustarStockId=window._ajustarStockId??null,window.currentVariants=window.currentVariants??[],window.currentProductImage=window.currentProductImage??null,window.currentProductImageFile=window.currentProductImageFile??null,window.modoEdicion=window.modoEdicion??!1,window.edicionProductoId=window.edicionProductoId??null,window._invSortCol=window._invSortCol??null,window._invSortDir=window._invSortDir??"asc",window._invCurrentPage=window._invCurrentPage??1,window._invPageSize=window._invPageSize??10,window.stockMovements=window.stockMovements??window.stockMovimientos??[],window._kitComponentes=window._kitComponentes??[];function saveStockMovements(){window.stockMovimientos=window.stockMovements}let _stockMovementsPrunedThisSession=!1;async function pruneStockMovementsTableOnce(){if(!_stockMovementsPrunedThisSession&&!(typeof db>"u"||!db)){_stockMovementsPrunedThisSession=!0;try{const{data:t,error:e}=await db.from("stock_movements").select("id").order("fecha",{ascending:!1}).range(500,1e4);if(e){console.warn("[Stock] No se pudo listar stock_movements para recorte:",e.message);return}const i=(t||[]).map(n=>n.id).filter(Boolean);if(!i.length)return;const{error:o}=await db.from("stock_movements").delete().in("id",i);o&&console.warn("[Stock] No se pudo recortar stock_movements:",o.message)}catch(t){console.warn("[Stock] Error recortando stock_movements:",t?.message||t)}}}window.pruneStockMovementsTableOnce=pruneStockMovementsTableOnce;function registrarMovimiento({productoId:t,productoNombre:e,tipo:i,cantidad:o,cantidadSolicitada:n,motivo:a,stockAntes:r,stockDespues:l}){const d=mkId(),c=new Date().toISOString();window.stockMovements.unshift({id:d,fecha:_fechaHoy()+"T"+new Date().toLocaleTimeString("es-MX"),productoId:t,productoNombre:e,tipo:i,cantidad:o,cantidadSolicitada:n,motivo:a||"",stockAntes:r,stockDespues:l}),window.stockMovements.length>500&&(window.stockMovements.splice(500),window.stockMovimientos=window.stockMovements),saveStockMovements(),typeof db<"u"&&db&&db.from("stock_movements").insert({id:d,producto_id:String(t),producto_nombre:e||null,tipo:i,cantidad:o,motivo:a||null,stock_antes:r!=null?Number(r):null,stock_despues:l!=null?Number(l):null,fecha:c}).then(({error:s})=>{s&&console.warn("[Stock] Fallo insert stock_movements:",s.message)})}window.registrarMovimiento=registrarMovimiento;function _genId(){return"p"+mkId().replace(/-/g,"")}function _stockFisicoParaFabricacion(t){return Array.isArray(t?.variants)&&t.variants.length>0?t.variants.reduce((e,i)=>e+(parseFloat(i.qty)||0),0):parseFloat(t?.stock)||0}function calcularPiezasFabricables(t){if(!Array.isArray(t?.mpComponentes)||t.mpComponentes.length===0)return 0;let e=1/0,i=!1;for(const o of t.mpComponentes){const n=(window.products||[]).find(c=>String(c.id)===String(o.id));if(!n)return 0;if(n.tipo==="servicio")continue;i=!0;const a=_stockFisicoParaFabricacion(n),r=parseFloat(o.qty)||1,l=parseFloat(o.rendimientoPorHoja)||parseFloat(t.rendimientoPorHoja)||1,d=Math.floor(a/r)*l;d<e&&(e=d)}return i?e===1/0?0:Math.floor(e):0}window.calcularPiezasFabricables=calcularPiezasFabricables;function getStockEfectivo(t){const e=t.variants&&t.variants.length>0,i=t.mpComponentes&&t.mpComponentes.length>0;function o(){return calcularPiezasFabricables(t)}if(e){const n=t.variants.reduce((a,r)=>a+(parseInt(r.qty)||0),0);return i?n+o():n}if(i){if(t.mpComponentes.every(l=>{const d=(window.products||[]).find(c=>String(c.id)===String(l.id));return d&&d.tipo==="servicio"}))return parseInt(t.stock)||0;const a=parseInt(t.stock)||0,r=o();return a+r}return parseInt(t.stock)||0}window.getStockEfectivo=getStockEfectivo;function _normVariante(t){return(t||"").replace(/\s*:\s*/g,":").trim().toLowerCase()}window._normVariante=_normVariante;let _listaComprasModo="ahora";function mostrarListaCompras(t){t||(window._listaComprasChecked={});const e=["confirmado","pago","produccion","envio","salida","retirar"],i=new Date;i.setHours(0,0,0,0);const o=new Date(i);o.setDate(o.getDate()+7);const n=(window.pedidos||[]).filter(c=>{if(!e.includes(c.status)||c.inventarioDescontado)return!1;if(_listaComprasModo==="ahora"){if(c.status==="produccion"||c.status==="salida"||c.status==="retirar")return!0;if(!c.entrega)return!1;const s=new Date(c.entrega+"T00:00:00");return s>=i&&s<=o}return!0}),a={};n.forEach(c=>{(c.productosInventario||[]).forEach(s=>{const p=(s.id||s.name)+"|"+(s.variante||s.variant||"");(s.id||s.name)&&(a[p]||(a[p]={id:s.id,nombre:s.name||s.nombre,variante:s.variante||s.variant||"",necesario:0,pedidosRef:[]}),a[p].necesario+=s.quantity||s.cantidad||1,a[p].pedidosRef.push(c.folio||c.id))})});const r=Object.values(a).map(c=>{const s=(window.products||[]).find(u=>String(u.id)===String(c.id));let p=0;if(s)if(c.variante){const u=(s.variants||[]).find(m=>_normVariante(m.value)===_normVariante(c.variante)||_normVariante(`${m.type}:${m.value}`)===_normVariante(c.variante));p=u?u.qty||0:getStockEfectivo(s)}else p=typeof getStockEfectivo=="function"?getStockEfectivo(s):s.stock||0;const f=Math.max(0,c.necesario-p);return{...c,disponible:p,faltan:f}}).sort((c,s)=>s.faltan-c.faltan);r.forEach(c=>{const s=(window.products||[]).find(p=>String(p.id)===String(c.id));c.costoUnit=s&&parseFloat(s.cost)||0,c.costoTotal=c.faltan*c.costoUnit});const l=document.getElementById("listaComprasContent");if(!l)return;const d=`
        <div style="display:flex;gap:0;border:1px solid #e5e7eb;border-radius:10px;overflow:hidden;margin-bottom:12px;font-size:.78rem;">
            <button onclick="_listaComprasModo='ahora';mostrarListaCompras(true)" style="flex:1;padding:7px 0;border:none;cursor:pointer;font-weight:700;background:${_listaComprasModo==="ahora"?"#FFD166":"#fff"};color:${_listaComprasModo==="ahora"?"#fff":"#6b7280"};">\u{1F525} Necesitas ahora</button>
            <button onclick="_listaComprasModo='pipeline';mostrarListaCompras(true)" style="flex:1;padding:7px 0;border:none;cursor:pointer;font-weight:700;background:${_listaComprasModo==="pipeline"?"#FFD166":"#fff"};color:${_listaComprasModo==="pipeline"?"#fff":"#6b7280"};">\u{1F4CB} Pipeline completo</button>
        </div>`;if(r.length===0)l.innerHTML=d+'<p style="color:#9ca3af;text-align:center;padding:32px 0;font-size:.875rem;">No hay pedidos activos con materiales asignados.</p>';else{const c=r.filter(u=>u.faltan>0),s=r.filter(u=>u.faltan===0);let p=d;if(c.length>0){const u=c.reduce((m,g)=>m+g.costoTotal,0);p+=`<p style="font-size:.7rem;font-weight:800;color:#b45309;text-transform:uppercase;letter-spacing:.08em;margin-bottom:8px;">\u26A0\uFE0F Necesitas comprar (${c.length})</p>`,p+=`<table style="width:100%;border-collapse:collapse;font-size:.78rem;margin-bottom:4px;">
                ...
                </div>`).join("")),c.length===0&&(p='<p style="color:#16a34a;text-align:center;padding:12px 0;font-size:.9rem;font-weight:700;">\u2705 Tienes stock suficiente para todos los pedidos activos.</p>'+p),c.length>0&&(p+=`<div style="display:flex;gap:8px;margin-top:14px;flex-wrap:wrap;">
                ...
                </div>`}),u+="</div></div>",p+=u}l.innerHTML=p}window._lcToggleComprado=function(c){window._listaComprasChecked||(window._listaComprasChecked={}),window._listaComprasChecked[c]=!0,mostrarListaCompras(!0)},window._lcWhatsApp=function(){const c=r.filter(m=>m.faltan>0);if(!c.length)return;const s=_fechaHoy(),p=c.reduce((m,g)=>m+g.costoTotal,0);let f=`\u{1F4E6} Lista de compras Bicho Capricho
Fecha: ${s}

`;c.forEach(m=>{const g=m.nombre+(m.variante?` (${m.variante})`:"");m.costoUnit>0?f+=`\u2022 ${g}: ${m.faltan} uds ($${m.costoUnit.toFixed(2)} c/u = $${m.costoTotal.toFixed(2)})
`:f+=`\u2022 ${g}: ${m.faltan} uds
`}),p>0&&(f+=`
\u{1F4B0} Total estimado: $${p.toFixed(2)}`);const u="https://api.whatsapp.com/send?text="+encodeURIComponent(f);window.open(u,"_blank")},window._lcExportCSV=function(){const c=r.filter(w=>w.faltan>0),s=["Producto","Variante","Cantidad requerida","Stock actual","Faltante","Costo unitario","Costo total"],p=c.map(w=>[w.nombre,w.variante||"",w.necesario,w.disponible,w.faltan,w.costoUnit.toFixed(2),w.costoTotal.toFixed(2)]);let f=s.join(",")+`
`;p.forEach(w=>{f+=w.map(y=>`"${String(y).replace(/"/g,'""')}"`).join(",")+`
`});const u=new Blob([f],{type:"text/csv;charset=utf-8;"}),m=URL.createObjectURL(u),g=document.createElement("a");g.href=m,g.download=`lista-compras-${_fechaHoy()}.csv`,g.click(),URL.revokeObjectURL(m)},openModal("listaComprasModal")}window.mostrarListaCompras=mostrarListaCompras,window._listaComprasModo=_listaComprasModo;function syncStockFromVariants(t){t.variants&&t.variants.length>0&&(t.stock=t.variants.reduce((e,i)=>e+(parseInt(i.qty)||0),0))}function setupImageUpload(){["productImage","mpProductImage"].forEach(t=>{const e=document.getElementById(t);!e||e._mkBound||(e._mkBound=!0,e.addEventListener("change",function(i){const o=i.target.files[0];if(!o)return;window.currentProductImageFile=o;const n=new FileReader,a=t==="mpProductImage";n.onload=r=>{const l=document.getElementById(a?"mpPreviewImg":"previewImg"),d=document.getElementById(a?"mpImagePreview":"imagePreview");l&&(l.src=r.target.result),d&&d.classList.remove("hidden")},n.readAsDataURL(o)}))})}window.setupImageUpload=setupImageUpload;function sortInventory(t){window._invSortDir=window._invSortCol===t&&window._invSortDir==="asc"?"desc":"asc",window._invSortCol=t,window._invCurrentPage=1,document.querySelectorAll(".sortable-th").forEach(e=>{e.classList.remove("asc","desc"),e.getAttribute("onclick")===`sortInventory('${t}')`&&e.classList.add(window._invSortDir)}),renderInventoryTable()}window.sortInventory=sortInventory;let _lastTelegramAlert=window._lastTelegramStockAlert||0;function _pedidosQueUsanMP(t){const e=["confirmado","pago","produccion","envio","salida","retirar","pendiente"];return(window.pedidos||[]).filter(i=>e.includes(i.status||"")?(i.productosInventario||[]).some(o=>{const n=(window.products||[]).find(a=>String(a.id)===String(o.id));return n?(n.mpComponentes||[]).some(a=>String(a.id)===String(t)):!1}):!1)}window._pedidosQueUsanMP=_pedidosQueUsanMP;function checkStockAlerts(){const t=window.products||[],e=t.filter(d=>getStockEfectivo(d)===0),i=t.filter(d=>{const c=getStockEfectivo(d);return c>0&&c<=(d.puntoReorden??d.stockMin??5)}),o=i.filter(d=>d.tipo==="materia_prima"),n=e.filter(d=>d.tipo==="materia_prima");[...n,...o].forEach(d=>{const c=_pedidosQueUsanMP(d.id);if(c.length>0){const s=c.map(p=>p.folio||p.id).slice(0,5).join(", ");manekiToastExport(`\u{1F6A8} URGENTE: "${d.name}" con stock cr\xEDtico \u2014 afecta pedidos: ${s}`,"err")}}),e.length&&manekiToastExport(`\u{1F534} ${e.length} producto(s) agotado(s)`,"warn"),i.length&&manekiToastExport(`\u26A0\uFE0F ${i.length} producto(s) con stock bajo`,"warn"),n.length?manekiToastExport(`\u{1F3ED} ${n.length} materia(s) prima(s) AGOTADAS \u2014 producci\xF3n bloqueada`,"err"):o.length&&manekiToastExport(`\u{1F3ED} ${o.length} materia(s) prima(s) con stock bajo`,"warn");const r=document.getElementById("sidebarBadgeMP");if(r){const d=o.length+n.length;d>0?(r.textContent=d,r.style.display="inline-block"):r.style.display="none"}(e.length>0||i.length>0)&&_notificarStockTelegram({agotados:e,bajos:i,mpAgotadas:n,mpBajas:o}),(n.length||o.length)&&_alertaStockWA(n,o)}window.checkStockAlerts=checkStockAlerts;async function _notificarStockTelegram({agotados:t,bajos:e,mpAgotadas:i,mpBajas:o}){const n=Date.now();if(n-_lastTelegramAlert<3600*1e3)return;window._lastTelegramStockAlert=n,_lastTelegramAlert=n;const a=window.storeConfig||{},r=a.telegramBotToken;if(!r){console.warn("Telegram: telegramBotToken no configurado, omitiendo notificaci\xF3n de stock.");return}const l=[a.telegramChatId1,a.telegramChatId2].filter(Boolean);if(!l.length)return;const d=[];t.length&&(d.push(`\u{1F534} *Agotados (${t.length}):*`),t.slice(0,10).forEach(s=>d.push(`  \u2022 ${s.name} \u2014 stock: 0`))),e.length&&(d.push(`\u26A0\uFE0F *Stock bajo (${e.length}):*`),e.slice(0,10).forEach(s=>d.push(`  \u2022 ${s.name} \u2014 stock: ${s.stock} (m\xEDn: ${s.stockMin||5})`))),i.length&&d.push(`\u{1F3ED} *MP AGOTADAS \u2014 producci\xF3n bloqueada:* ${i.map(s=>s.name).join(", ")}`);const c=`\u{1F4E6} *Alerta de inventario \u2014 Bicho Capricho*

${d.join(`
`)}`;for(const s of l)try{await fetch(`https://api.telegram.org/bot${r}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:s,text:c,parse_mode:"Markdown"})})}catch(p){console.warn("Telegram stock alert error:",p)}}window._notificarStockTelegram=_notificarStockTelegram;function _alertaStockWA(t,e){const i=document.getElementById("_mkStockWAAlert");i&&i.remove();const o=[];t.length&&o.push(`\u{1F534} Agotadas: ${t.map(r=>r.name).join(", ")}`),e.length&&o.push(`\u26A0\uFE0F Stock bajo: ${e.map(r=>r.name).join(", ")}`);const n=encodeURIComponent(`\u{1F3ED} *Bicho Capricho \u2014 Alerta de Inventario*
...
_Reabastece pronto para no detener producci\xF3n._`),a=document.createElement("div");a.id="_mkStockWAAlert",a.style.cssText="position:fixed;bottom:20px;right:20px;z-index:9999;background:#fff;border:2px solid #25D366;border-radius:14px;padding:14px 18px;box-shadow:0 4px 24px rgba(0,0,0,0.15);max-width:300px;font-size:13px;line-height:1.4;",a.innerHTML=`
        ...
        </button>`,document.body.appendChild(a)}window._alertaStockWA=_alertaStockWA;function exportarInventarioCSV(){const t=["SKU","Nombre","Categor\xEDa","Tipo","Costo","Precio","Stock","Stock M\xEDn","Margen%","Producibles","Proveedor","Proveedor URL","Estado","Tags","Variantes","\xDAltima actualizaci\xF3n"],e=(window.products||[]).map(r=>{const l=((window.categories||[]).find(u=>u.id===r.category)||{}).name||r.category,d=r.cost&&r.price?((r.price-r.cost)/r.price*100).toFixed(0)+"%":"",c=typeof getStockEfectivo=="function"?getStockEfectivo(r):r.stock||0,s=c===0?"Agotado":c<=(r.stockMin||5)?"Bajo Stock":"Disponible",p=typeof calcularProducibles=="function"?calcularProducibles(r)??"":"",f=r.updatedAt?new Date(r.updatedAt).toLocaleString("es-MX"):"";return[r.sku,r.name,l,r.tipo||"producto",r.cost||0,r.price||0,c,r.stockMin||5,d,p,r.proveedor||"",r.proveedorUrl||"",s,(r.tags||[]).join("; "),(r.variants||[]).map(u=>`${u.type}:${u.value}(${u.qty??0})`).join("; "),f].map(u=>`"${String(u).replace(/"/g,'""')}"`).join(",")}),i=[t.join(","),...e].join(`
...
`),a=new Blob([n],{type:"text/csv;charset=utf-8;"}),r=URL.createObjectURL(a),l=document.createElement("a");l.href=r,l.download=`snapshot_inventario_${t}.csv`,l.click(),URL.revokeObjectURL(r)}window.exportarSnapshotCSV=exportarSnapshotCSV;function abrirBulkEditPrecios(){const t=(window.products||[]).filter(n=>n.tipo!=="materia_prima"&&n.tipo!=="servicio"&&Number(n.price||0)>0);if(t.length===0){manekiToastExport("No hay productos con precio para editar","warn");return}let e=document.getElementById("_bulkEditModal");e||(e=document.createElement("div"),e.id="_bulkEditModal",e.style.cssText="position:fixed;inset:0;z-index:9998;background:rgba(0,0,0,0.5);display:flex;align-items:center;justify-content:center;",document.body.appendChild(e));const i=[...new Set(t.map(n=>n.category||n.categoria||"Sin categor\xEDa"))];e.innerHTML=`
        ...
        <table style="width:100%;border-collapse:collapse;">
            ...
            <tbody>
                ${o.slice(0,30).map(n=>{const a=_calcBulkPrecio(Number(n.price),e,i),r=a-Number(n.price),l=r>0?"#16A34A":r<0?"#DC2626":"#6B7280";return`<tr style="border-bottom:1px solid #F3F4F6;">
                        ...
                        <td style="padding:6px 10px;font-size:.78rem;font-weight:700;color:${l};text-align:right;">$${a.toFixed(2)}</td>
                    </tr>`}).join("")}
        ...
        <div style="width:63mm;height:38mm;border:1px solid #ddd;border-radius:6px;padding:5mm 4mm;
            ...
            <div style="display:flex;justify-content:space-between;align-items:flex-end;">
                <div style="font-size:16pt;font-weight:900;color:#FFD166;">$${Number(n.price).toLocaleString("es-MX",{minimumFractionDigits:0,maximumFractionDigits:2})}</div>
        ...
        <div class="header no-print">${e.length} etiquetas \xB7 Bicho Capricho \xB7 <button onclick="window.print()" style="padding:4px 12px;background:#FFD166;color:#fff;border:none;border-radius:6px;cursor:pointer;font-size:8pt;">\u{1F5A8}\uFE0F Imprimir</button></div>
        ${i}
...
"use strict";const TAGS_MATERIA_PRIMA=["Acr\xEDlico","Filamento","Tintas","Cuadro","Metales","Empaques","Vasos","Textil","Peluches","Otros"];window._mpTagsActuales=window._mpTagsActuales??[];function openAddMateriaPrimaModal(){window.modoEdicion=!1,window.edicionProductoId=null,window.currentProductImage=null,window.currentProductImageFile=null,window._mpTagsActuales=[];const i=document.getElementById("mpForm");i&&i.reset();const o=document.getElementById("mpImagePreview");o&&o.classList.add("hidden"),renderMpTags();const e=document.querySelector("#mpModal h3");e&&(e.textContent="\u{1F3ED} Nueva Materia Prima");const t=document.getElementById("mpSubmitBtn");t&&(t.textContent="\u2705 Guardar Materia Prima"),typeof openModal=="function"&&openModal("mpModal")}window.openAddMateriaPrimaModal=openAddMateriaPrimaModal,window._packComponentes=window._packComponentes??[];function injectPackModal(){const i=document.getElementById("packModal");i&&i.remove();const o=document.createElement("div");o.id="packModal",o.className="modal",o.innerHTML=`
    <div style="background:#fff;border-radius:20px;box-shadow:0 32px 80px rgba(21,4,50,0.2);max-width:640px;width:100%;margin:auto;max-height:94vh;overflow-y:auto;padding:32px;">
        ...
        </div>`}).join(""),packRecalcularCosto()}window.packRenderComponentes=packRenderComponentes;function packAbrirSelectorMP(){const i=document.getElementById("packMpSelector");if(!i)return;const o=i.style.display!=="none";if(i.style.display=o?"none":"block",!o){const e=document.getElementById("packMpSearch");e&&(e.value="",e.focus()),packFiltrarMP()}}window.packAbrirSelectorMP=packAbrirSelectorMP;function packFiltrarMP(){const i=(document.getElementById("packMpSearch")?.value||"").toLowerCase(),o=(window._packMpDirectos||[]).map(n=>String(n.id)),e=(window.products||[]).filter(n=>(n.tipo==="materia_prima"||n.tipo==="servicio")&&!o.includes(String(n.id))&&(!i||(n.name||"").toLowerCase().includes(i))),t=document.getElementById("packMpResults");if(t){if(!e.length){t.innerHTML='<p style="font-size:.8rem;color:#9ca3af;text-align:center;padding:8px;">Sin resultados</p>';return}t.innerHTML=e.map(n=>{const a=n.imageUrl?`<img src="${n.imageUrl}" alt="${_esc(n.name||"")}" style="width:30px;height:30px;object-fit:cover;border-radius:6px;">`:`<span style="font-size:1.2rem;">${n.image||"\u{1F3ED}"}</span>`,r=n.tipo==="servicio"?'<span style="font-size:10px;background:#f6ecff;color:#7d4fa3;padding:1px 6px;border-radius:99px;">Servicio</span>':'<span style="font-size:10px;background:#f0fdf4;color:#15803d;padding:1px 6px;border-radius:99px;">MP</span>';return`<div onclick="packSeleccionarMP('${String(n.id)}')"
            style="display:flex;align-items:center;gap:10px;padding:8px 12px;border-radius:10px;cursor:pointer;border:1.5px solid #e5e7eb;background:#fff;"
...
"use strict";function _resetMpVariantesUI(){window._mpVariantes=[];const t=document.getElementById("mpUsaVariantes");t&&(t.checked=!1);const e=document.getElementById("mpVariantesPanel");e&&(e.style.display="none");const o=document.getElementById("mpVariantesSlider");o&&(o.style.background="#d1d5db");const n=document.getElementById("mpVariantesThumb");n&&(n.style.left="3px");const a=document.getElementById("mpStockRow");a&&(a.style.opacity="1");const i=document.getElementById("mpStock");i&&(i.readOnly=!1,i.value=0);const r=document.getElementById("mpVariantesList");r&&(r.innerHTML='<span style="font-size:.8rem;color:#9ca3af;font-style:italic;">Sin variantes agregadas</span>');const d=document.getElementById("mpVariantesStockTotal");d&&(d.style.display="none")}function closeMateriaPrimaModal(){typeof closeModal=="function"&&closeModal("mpModal");const t=document.getElementById("mpForm");t&&t.reset(),window.modoEdicion=!1,window.edicionProductoId=null,window.currentProductImage=null,window.currentProductImageFile=null,window._mpTagsActuales=[],_resetMpVariantesUI(),renderMpTags()}window.closeMateriaPrimaModal=closeMateriaPrimaModal;function renderMpTags(){const t=document.getElementById("mpTagsGrid");if(!t)return;t.innerHTML=TAGS_MATERIA_PRIMA.map(o=>{const n=(window._mpTagsActuales||[]).includes(o);return`<button type="button" onclick="toggleMpTag('${o}')"
            ...
            style="padding:5px 12px;border-radius:99px;font-size:12px;font-weight:600;cursor:pointer;transition:all .15s;
                border:1.5px solid ${n?"#FFD166":"#e5e7eb"};
        ...
        <form id="mpForm" class="space-y-5" novalidate>
            ...
            <div style="background:linear-gradient(135deg,#faf5ff,#f5f3ff);border:1.5px solid #e9d5ff;border-radius:14px;padding:16px;">
                <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:12px;">
                    <label class="block text-sm font-semibold" style="color:#9669c4;">\u{1F4B0} Costo</label>
...
;
"use strict";async function guardarMateriaPrima(){const i=m=>{const h=document.getElementById(m);return h?h.value:""},e=i("mpNombre").trim(),o=parseInt(i("mpStock"))||0,n=parseInt(i("mpStockMin"))||5,r=i("mpSku").trim(),a=i("mpProveedor").trim(),t=i("mpProveedorUrl").trim(),s=i("mpUnidad")||"pza",l=i("mpNotas").trim(),d=document.getElementById("mpUsaPaquete")?.checked||!1,c=parseFloat(i("mpPaqueteCantidad"))||0,u=parseFloat(i("mpPaquetePrecio"))||0;let p=0;if(d){if(c<=0||u<=0){manekiToastExport("\u26A0\uFE0F Ingresa la cantidad y precio del paquete","warn");return}p=u/c}else p=parseFloat(i("mpCosto"))||0;if(!e){manekiToastExport("\u26A0\uFE0F El nombre es requerido","warn");return}if(p<=0){manekiToastExport("\u26A0\uFE0F El costo debe ser mayor a 0","warn");return}const b=window.modoEdicion?window.edicionProductoId:null,y=(window.products||[]).find(m=>m.name.trim().toLowerCase()===e.toLowerCase()&&String(m.id)!==String(b));if(y){manekiToastExport(`\u26A0\uFE0F Ya existe un producto llamado "${y.name}". Usa un nombre diferente o edita el existente.`,"warn");return}if(r&&!skuEsUnico(r,b)){manekiToastExport(`\u26A0\uFE0F El SKU "${r}" ya est\xE1 en uso`,"warn");return}if(window.currentProductImageFile){manekiToastExport("\u23F3 Subiendo imagen...","ok");const m=await subirImagenStorage(window.currentProductImageFile).catch(()=>null);m?window.currentProductImage=m:manekiToastExport("\u26A0\uFE0F No se pudo subir la imagen. Intenta de nuevo.","warn"),window.currentProductImageFile=null}const w=document.getElementById("mpEsEmpaque")?.checked||!1,f=[...window._mpTagsActuales||[]],v=mkId().split("-")[0].toUpperCase(),S=r||"MP-"+v,E=document.getElementById("mpUsaVariantes")?.checked||!1,k=E?[...window._mpVariantes||[]]:[],g=E?k.reduce((m,h)=>m+(parseInt(h.qty)||0),0):o;if(window.modoEdicion&&window.edicionProductoId!==null){const m=(window.products||[]).findIndex(I=>String(I.id)===String(window.edicionProductoId));if(m===-1){manekiToastExport("Error: producto no encontrado","err");return}const h=window.products[m].stock,M=window.products[m].cost||0,x=[...window.products[m].historialCostos||[]];p!==M&&x.push({fecha:new Date().toISOString(),costoAntes:M,costoNuevo:p}),window.products[m]=Object.assign({},window.products[m],{name:e,tipo:"materia_prima",cost:p,price:0,stock:g,stockMin:n,sku:S,tags:f,proveedor:a,proveedorUrl:t,unidad:s,notas:l,imageUrl:window.currentProductImage||window.products[m].imageUrl,compraPaquete:d?{cantidad:c,precio:u}:null,variants:k,usaVariantes:E,historialCostos:x,esEmpaque:w}),g!==h&&registrarMovimiento({productoId:window.edicionProductoId,productoNombre:e,tipo:"ajuste",cantidad:g-h,motivo:"Edici\xF3n",stockAntes:h,stockDespues:g}),p!==M&&_cascadeCostMP(window.edicionProductoId,p),E&&k.length>0&&_cascadeVariantesMP(window.edicionProductoId,k),saveProducts(),renderInventoryTable(),typeof updateDashboard=="function"&&updateDashboard(),typeof window._mkModalSaved=="function"&&window._mkModalSaved("mpModal"),closeMateriaPrimaModal(),window.MKS&&MKS.notify(),manekiToastExport("\u2705 Materia prima actualizada","ok")}else{const m={id:_genId(),name:e,tipo:"materia_prima",category:"materiales",cost:p,price:0,stock:g,stockMin:n,sku:S,tags:f,proveedor:a,proveedorUrl:t,unidad:s,notas:l,image:"\u{1F3ED}",imageUrl:window.currentProductImage||null,variants:k,usaVariantes:E,compraPaquete:d?{cantidad:c,precio:u}:null,esEmpaque:w};window.products.unshift(m),window._invCurrentPage=1,g>0&&registrarMovimiento({productoId:m.id,productoNombre:m.name,tipo:"creacion",cantidad:g,motivo:"Alta de materia prima",stockAntes:0,stockDespues:g}),saveProducts(),renderInventoryTable(),typeof updateDashboard=="function"&&updateDashboard(),typeof window._mkModalSaved=="function"&&window._mkModalSaved("mpModal"),closeMateriaPrimaModal(),window.MKS&&MKS.notify(),manekiToastExport("\u2705 Materia prima agregada","ok")}}window.guardarMateriaPrima=guardarMateriaPrima;function _cascadeCostMP(i,e){const o=[];(window.products||[]).forEach(t=>{if(t.tipo==="materia_prima"||t.tipo==="servicio"||!Array.isArray(t.mpComponentes)||!t.mpComponentes.length)return;const s=t.mpComponentes.find(c=>String(c.id)===String(i));if(!s)return;const l=t.cost||0;s.costUnit=e;const d=t.mpComponentes.reduce((c,u)=>c+(u.costUnit||0)*(u.qty||1),0);t.cost=Math.round(d*100)/100,t.historialPrecios||(t.historialPrecios=[]),t.historialPrecios.push({fecha:new Date().toISOString(),costoAntes:l,costoNuevo:t.cost,precioAntes:t.price,precioNuevo:t.price}),o.push(t.name)}),o.length&&manekiToastExport(`\u{1F4B0} Costo recalculado en: ${o.join(", ")}`,"ok");const n=(window.products||[]).filter(t=>(t.mpComponentes||[]).some(s=>String(s.id)===String(i))),r=new Set(n.map(t=>String(t.id))),a=(window.pedidos||[]).filter(t=>!["cancelado","finalizado"].includes(t.status||"")&&(t.productosInventario||[]).some(s=>r.has(String(s.id))));if(a.length>0){const t=a.map(s=>s.folio||s.id).join(", ");manekiToastExport(`\u{1F4A1} ${a.length} pedido(s) activo(s) usan productos afectados por este cambio de costo (${t}). Revisa sus precios.`,"warn")}}window._cascadeCostMP=_cascadeCostMP;function _cascadeVariantesMP(i,e){if(!Array.isArray(e)||!e.length)return;const o=[];(window.products||[]).forEach(n=>{n.tipo==="materia_prima"||n.tipo==="servicio"||!Array.isArray(n.mpComponentes)||!n.mpComponentes.length||n.mpComponentes.some(r=>String(r.id)===String(i))&&(n.variants=e.map(r=>{const a=(n.variants||[]).find(t=>(t.type||t.tipo)===(r.type||r.tipo)&&(t.value||t.valor)===(r.value||r.valor));return a?{...r,qty:a.qty??r.qty}:{...r}}),n.usaVariantes=!0,o.push(n.name))}),o.length&&manekiToastExport(`\u{1F3A8} Variantes sincronizadas en: ${o.join(", ")}`,"ok")}window._cascadeVariantesMP=_cascadeVariantesMP;function editProduct(i){const e=(window.products||[]).find(o=>String(o.id)===String(i));if(!e){console.warn("editProduct: no encontrado",i);return}e.tipo==="materia_prima"?(injectMpModal(),window.modoEdicion=!0,window.edicionProductoId=i,window.currentProductImage=e.imageUrl||null,window.currentProductImageFile=null,window._mpTagsActuales=[...e.tags||[]],setTimeout(()=>{const o=document.getElementById("mpForm");o&&o.reset();const n=(c,u)=>{const p=document.getElementById(c);p&&(p.value=u??"")};n("mpNombre",e.name),n("mpSku",e.sku||""),n("mpStock",e.stock||0),n("mpStockMin",e.stockMin||5),n("mpProveedor",e.proveedor||""),n("mpProveedorUrl",e.proveedorUrl||""),n("mpNotas",e.notas||""),setTimeout(()=>{const c=document.getElementById("mpUnidad");c&&(c.value=e.unidad||"pza")},10);const r=document.getElementById("mpUsaPaquete");if(e.compraPaquete&&e.compraPaquete.cantidad>0?(r&&(r.checked=!0,mpTogglePaquete()),n("mpPaqueteCantidad",e.compraPaquete.cantidad),n("mpPaquetePrecio",e.compraPaquete.precio),mpCalcCostoUnidad()):(r&&(r.checked=!1,mpTogglePaquete()),n("mpCosto",e.cost||0)),e.usaVariantes&&Array.isArray(e.variants)&&e.variants.length>0){window._mpVariantes=[...e.variants];const c=document.getElementById("mpUsaVariantes");c&&(c.checked=!0,mpToggleVariantes()),renderVariantesMp()}else _resetMpVariantesUI(),n("mpStock",e.stock||0);const a=document.getElementById("mpPreviewImg"),t=document.getElementById("mpImagePreview");e.imageUrl&&a?(a.src=e.imageUrl,t&&t.classList.remove("hidden")):t&&t.classList.add("hidden");const s=document.getElementById("mpEsEmpaque");s&&(s.checked=!!e.esEmpaque),renderMpTags();const l=document.querySelector("#mpModal h3");l&&(l.textContent="\u{1F3ED} Editar Materia Prima");const d=document.getElementById("mpSubmitBtn");d&&(d.textContent="\u{1F4BE} Guardar Cambios"),typeof openModal=="function"&&openModal("mpModal")},150)):e.tipo==="producto_variable"?(typeof injectVariableProductModal=="function"&&injectVariableProductModal(),typeof openVariableProductModal=="function"&&openVariableProductModal(i)):(injectPtModal(),window.modoEdicion=!0,window.edicionProductoId=i,window._ptVariants=Array.isArray(e.variants)?[...e.variants]:[],window._ptMpComponentes=Array.isArray(e.mpComponentes)?[...e.mpComponentes]:[],window._ptTagsActuales=[...e.tags||[]],window.currentVariants=[...window._ptVariants],window.currentProductImage=e.imageUrl||null,window.currentProductImageFile=null,window._ptGaleriaUrls=Array.isArray(e.imageUrls)?[...e.imageUrls]:[],window._ptGaleriaFiles=[],setTimeout(()=>{const o=(c,u)=>{const p=document.getElementById(c);p&&(p.value=u??"")};if(o("ptNombre",e.name),o("ptSku",e.sku||""),o("ptCosto",e.cost||0),o("ptPrecio",e.price||0),o("ptStockMin",e.stockMin??5),o("ptRendimientoPorHoja",e.rendimientoPorHoja||""),setTimeout(()=>{o("ptProveedorNombre",e.proveedorNombre||""),o("ptProveedorNotas",e.proveedorNotas||"")},200),poblarCategoriasPt(),setTimeout(()=>{const c=document.getElementById("ptCategory");c&&(c.value=e.category)},80),e.imageUrl){const c=document.getElementById("ptPreviewImg"),u=document.getElementById("ptImagePreview");c&&(c.src=e.imageUrl),u&&u.classList.remove("hidden")}ptRenderGaleria(),renderTagsPt(),renderVariantsListPt(),renderPtMpList(),recalcularCostoPt(),ptMostrarMargenInfo();const n=document.getElementById("ptPublicarTienda"),r=document.getElementById("ptToggleTrack"),a=document.getElementById("ptToggleThumb");n&&(n.checked=e.publicarTienda===!0||e.tipo==="producto",r&&(r.style.background=n.checked?"#10b981":"#d1d5db"),a&&(a.style.transform=n.checked?"translateX(22px)":"translateX(0)"));const t=document.getElementById("ptDescripcionWeb");t&&(t.value=e.descripcionWeb||""),["cumpleanos","san-valentin","bodas-xv","graduaciones","empresarial","navidad"].forEach(c=>{const u=document.getElementById(`ptOc_${c}`),p=document.getElementById(`ptOcLabel_${c}`);u&&(u.checked=Array.isArray(e.ocasiones)&&e.ocasiones.includes(c),p&&(p.style.borderColor=u.checked?"#FFD166":"#e5e7eb",p.style.background=u.checked?"#fdf8f0":""))});const l=document.querySelector("#ptModal h3");l&&(l.textContent="\u270F\uFE0F Editar Producto Terminado");const d=document.getElementById("ptSubmitBtn");d&&(d.textContent="\u{1F4BE} Guardar Cambios")},120),typeof openModal=="function"&&openModal("ptModal"))}window.editProduct=editProduct,document.addEventListener("DOMContentLoaded",function(){setTimeout(()=>{try{const n=localStorage.getItem("mkStockMovements");if(n){const r=JSON.parse(n);Array.isArray(r)&&r.length>0&&((!window.stockMovements||window.stockMovements.length===0)&&(window.stockMovements=r,window.stockMovimientos=r,saveStockMovements(),console.log("[Migraci\xF3n] stockMovements: "+r.length+" movimientos migrados a SQLite/Supabase.")),localStorage.removeItem("mkStockMovements"))}}catch(n){console.warn("[Migraci\xF3n] Error migrando stockMovements:",n)}},3e3),injectMpModal(),injectPtModal(),setupImageUpload(),["inventorySearch","inventoryTagFilter","inventoryTipoFilter","inventoryProveedorFilter"].forEach(n=>{function r(){const a=document.getElementById(n);if(a&&!a._invPagListenerAdded){const t=()=>{window._invCurrentPage=1,["pt","pv","mp","svc"].forEach(s=>{window[`_invPage_${s}`]=1}),renderInventoryTable()};a.addEventListener("input",t),a.addEventListener("change",t),a._invPagListenerAdded=!0}}r(),setTimeout(r,800),setTimeout(r,2e3)}),setTimeout(patchInventoryButtons,400);const e=document.getElementById("inventorySection")||document.querySelector('section[id*="inventor"]')||document.querySelector('[data-section="inventory"]');e&&new MutationObserver(r=>{for(const a of r)if(a.attributeName==="class"||a.attributeName==="style"){const t=a.target;!t.classList.contains("hidden")&&t.style.display!=="none"&&t.offsetParent!==null&&setTimeout(patchInventoryButtons,80)}}).observe(e,{attributes:!0});const o=document.getElementById("addProductForm");o&&!o._mkSubmitBound&&(o._mkSubmitBound=!0,o.addEventListener("submit",function(n){n.preventDefault(),openAddProductModal()}))});function patchInventoryButtons(){const i=document.querySelector('[onclick="openAddProductModal()"]');if(!i)return;const e=i.parentElement;if(i.innerHTML="\u{1F4E6} Producto Terminado",i.title="Agregar producto terminado",[{selector:'[onclick="toggleMovimientos()"]',html:"\u{1F550} Movimientos"},{selector:'[onclick="imprimirInventario()"]',html:"\u{1F5A8}\uFE0F Imprimir"},{selector:`[onclick="manekiExportar('inventario')"]`,html:"\u{1F4CA} Exportar Excel"}].forEach(({selector:n,html:r})=>{const a=document.querySelector(n);a&&(a.innerHTML=r)}),!e.querySelector("[data-mp-btn]")){const n=document.createElement("button");n.setAttribute("data-mp-btn","1"),n.onclick=()=>{injectMpModal(),openAddMateriaPrimaModal()},n.className="px-5 py-2.5 rounded-xl text-white text-sm font-semibold flex items-center gap-2",n.style.cssText="background:linear-gradient(135deg,#9669c4,#ab84d1);",n.innerHTML="\u{1F9EA} Materia Prima",n.title="Agregar materia prima",e.insertBefore(n,i)}}window.patchInventoryButtons=patchInventoryButtons;function ajustarStock(i){const e=(window.products||[]).find(u=>String(u.id)===String(i));if(!e)return;window._ajustarStockId=String(i),window.__ajustarStockIdBackup=String(i);const o=document.getElementById("ajustarStockNombre"),n=document.getElementById("ajustarStockActual"),r=document.getElementById("ajustarStockCantidad"),a=document.getElementById("ajustarStockMotivo");o&&(o.textContent=e.name),n&&(n.textContent=getStockEfectivo(e)),r&&(r.value="",setTimeout(()=>r.focus&&r.focus(),250)),a&&(a.value="");const t=document.getElementById("ajusteStockPuntoReorden");t&&(t.value=e.puntoReorden!=null?e.puntoReorden:"");const s=document.getElementById("_ajusteCostoPonderadoWrap"),l=document.getElementById("ajusteStockCostoNuevo");s&&(s.style.display="none"),l&&(l.value="");const d=document.getElementById("ajustarStockModal");d&&(d.dataset.productId=String(i)),_inyectarCamposAjusteStock(d),_renderUltimosMovimientosProducto(i,d),_renderSugerenciaReorden(e,d);const c=document.getElementById("ajustarStockCantidad");c&&!c._costoPondListener&&(c._costoPondListener=!0,c.addEventListener("input",function(){const u=document.getElementById("_ajusteCostoPonderadoWrap"),p=document.getElementById("ajusteStockCostoNuevo");u&&(u.style.display=parseInt(this.value)>0?"":"none"),p&&parseInt(this.value)<=0&&(p.value="")})),typeof openModal=="function"&&openModal("ajustarStockModal")}window.ajustarStock=ajustarStock;function _inyectarCamposAjusteStock(i){if(!i||i.querySelector("#ajusteStockMotivoSelect"))return;const e=i.querySelector(".space-y-3");if(!e)return;const o=e.querySelector("#ajusteStockPuntoReorden")?.parentElement,n=document.createElement("div");n.id="_ajusteStockExtraFields",n.innerHTML=`
        ...
        ${r.map(t=>{const s=new Date(t.fecha).toLocaleString("es-MX",{dateStyle:"short",timeStyle:"short"}),l=t.cantidad>=0?`+${t.cantidad}`:`${t.cantidad}`;return`<div style="display:flex;align-items:center;gap:8px;padding:5px 0;border-bottom:1px solid #f9fafb;font-size:.75rem;">
            ...
            </div>`}).join("")}`}window._renderUltimosMovimientosProducto=_renderUltimosMovimientosProducto;function confirmarAjusteStock(){const i=document.getElementById("ajustarStockModal"),e=i&&i.dataset.productId||window._ajustarStockId||window.__ajustarStockIdBackup;if(!e){manekiToastExport("\u274C Error: no se encontr\xF3 el producto","err");return}const o=(window.products||[]).find(f=>String(f.id)===String(e));if(!o){manekiToastExport("\u274C Error: producto no encontrado","err");return}const n=document.getElementById("ajustarStockCantidad"),r=document.getElementById("ajustarStockMotivo"),a=document.getElementById("ajusteStockMotivoSelect"),t=document.getElementById("ajusteStockNotasExtra");if(!n){manekiToastExport("\u274C Error: formulario no disponible","err");return}const s=parseInt(n.value),l=a?a.value.trim():"",d=r?r.value.trim():"",c=l||d||"",u=t?t.value.trim():"";if(isNaN(s)||n.value.trim()===""){manekiToastExport("\u26A0\uFE0F Ingresa una cantidad v\xE1lida (+para agregar / -para restar)","warn"),n.focus&&n.focus();return}const p=getStockEfectivo(o),b=parseInt(o.stock)||0;if(o.stock=Math.max(0,b+s),s>0){const f=document.getElementById("ajusteStockCostoNuevo");if(f&&f.value.trim()!==""){const v=parseFloat(f.value);if(!isNaN(v)&&v>0){const S=Number(o.cost||o.costo||0),E=b+s;o.cost=E>0?(b*S+s*v)/E:v,o.cost=Math.round(o.cost*100)/100;const k=(window.products||[]).findIndex(g=>String(g.id)===String(o.id));if(k>=0){const g=[...window.products[k].historialCostos||[]];g.push({fecha:new Date().toISOString(),costoAntes:S,costoNuevo:o.cost,motivo:"Promedio ponderado"}),window.products[k].historialCostos=g,o.historialCostos=g}}}}if(o.variants&&o.variants.length>0&&s!==0){if(s>0)o.variants[0].qty=(o.variants[0].qty||0)+s;else{let f=Math.abs(s);for(const v of o.variants){const S=Math.min(v.qty||0,f);if(v.qty=(v.qty||0)-S,f-=S,f<=0)break}}syncStockFromVariants(o)}const y=getStockEfectivo(o);registrarMovimiento({productoId:o.id,productoNombre:o.name,tipo:s>=0?"entrada":"salida",cantidad:s,motivo:c,stockAntes:p,stockDespues:y});const w=document.getElementById("ajusteStockPuntoReorden");if(w&&w.value.trim()!==""){const f=parseInt(w.value);!isNaN(f)&&f>=0&&(o.puntoReorden=f)}saveProducts(),renderInventoryTable(),typeof updateDashboard=="function"&&updateDashboard(),typeof closeModal=="function"&&closeModal("ajustarStockModal"),window._ajustarStockId=null,window.__ajustarStockIdBackup=null,i&&delete i.dataset.productId,window.MKS&&MKS.tick(),manekiToastExport(`\u2705 Stock de "${o.name}": ${p} \u2192 ${y}`,"ok")}window.confirmarAjusteStock=confirmarAjusteStock;function closeAjustarStockModal(){if(typeof closeModal=="function")closeModal("ajustarStockModal");else{const e=document.getElementById("ajustarStockModal");e&&(e.style.display="none")}window._ajustarStockId=null,window.__ajustarStockIdBackup=null;const i=document.getElementById("ajustarStockModal");i&&delete i.dataset.productId}window.closeAjustarStockModal=closeAjustarStockModal;function _renderSugerenciaReorden(i,e){if(!e)return;let o=e.querySelector("#_sugerenciaReorden");if(!o){const c=e.querySelector(".bg-white")||e.querySelector(".space-y-3")?.parentElement;if(!c)return;o=document.createElement("div"),o.id="_sugerenciaReorden",o.style.cssText="margin-top:12px;padding:10px 12px;background:#FFFBEB;border:1px solid #FDE68A;border-radius:12px;",c.appendChild(o)}const n=(window.salesHistory||[]).filter(c=>{if(!c.date||c.method==="Cancelado")return!1;const u=new Date;u.setDate(u.getDate()-30);const p=`${u.getFullYear()}-${String(u.getMonth()+1).padStart(2,"0")}-${String(u.getDate()).padStart(2,"0")}`;return c.date>=p});let r=0;n.forEach(c=>{(c.products||[]).forEach(u=>{(String(u.id)===String(i.id)||(u.name||"").toLowerCase()===(i.name||"").toLowerCase())&&(r+=Number(u.quantity||1))})});const a=r/30,t=i.leadTime||7,s=Math.ceil(a*3),l=Math.ceil(a*t)+s,d=Math.max(0,Math.ceil(a*30)-(getStockEfectivo(i)||0));if(r===0){o.innerHTML='<p style="font-size:.75rem;color:#92400E;margin:0;">\u{1F4CA} Sin ventas en los \xFAltimos 30 d\xEDas \u2014 no hay datos para sugerir reorden.</p>';return}o.innerHTML=`
...
Esta acci\xF3n no se puede deshacer.`,showConfirm(a,"\u{1F5D1}\uFE0F Eliminar producto permanentemente").then(async t=>{if(!t)return;window.MKS&&MKS.del();const s=JSON.parse(JSON.stringify(e)),l=window.products.findIndex(d=>String(d.id)===String(i));typeof window.mkPushUndo=="function"&&(window.mkPushUndo(`Eliminar "${e.name}"`,()=>{window.products.some(d=>String(d.id)===String(s.id))||(window.products.splice(l,0,s),typeof saveProducts=="function"&&saveProducts(),typeof renderInventoryTable=="function"&&renderInventoryTable(),typeof window._rebuildProductMap=="function"&&window._rebuildProductMap())}),typeof window.mkMostrarUndoHint=="function"&&window.mkMostrarUndoHint(`Eliminar "${e.name}"`)),window.products=window.products.filter(d=>String(d.id)!==String(i));try{products=window.products}catch{}saveProducts(),renderInventoryTable(),typeof updateDashboard=="function"&&updateDashboard();try{await db.from("products").delete().eq("id",String(i))}catch(d){console.warn("deleteProduct: no se pudo borrar de products:",d)}manekiToastExport(`\u{1F5D1}\uFE0F "${e.name}" eliminado`,"ok")})}window.deleteProduct=deleteProduct;function calcularDisponibilidadDesdeMP(i,e,o){if(!i.mpComponentes||i.mpComponentes.length===0)return null;const n=e||window.productMap,r=n?l=>n.get(String(l)):l=>(window.products||[]).find(d=>String(d.id)===String(l)),a=i.mpComponentes.some(l=>{const d=r(l.id);return!d||d.tipo!=="servicio"});if(i._tieneComponentesHuerfanos=!1,!a)return null;const t=[];for(const l of i.mpComponentes){const d=r(l.id);if(d&&d.tipo==="servicio")continue;if(!d)return i._tieneComponentesHuerfanos=!0,t.push({nombre:l.nombre||"?",stock:0,qty:l.qty||1,posibles:0}),{piezas:0,detalle:t};const c=o?o.get(String(d.id))??(Array.isArray(d.variants)&&d.variants.length?d.variants.reduce((y,w)=>y+(parseFloat(w.qty)||0),0):parseFloat(d.stock)||0):Array.isArray(d.variants)&&d.variants.length?d.variants.reduce((y,w)=>y+(parseFloat(w.qty)||0),0):parseFloat(d.stock)||0,u=l.qty||1,p=parseFloat(l.rendimientoPorHoja)||parseFloat(i.rendimientoPorHoja)||1,b=Math.floor(c/u)*p;t.push({nombre:l.nombre||(d?d.name:"?"),stock:c,qty:u,posibles:b})}return{piezas:typeof window.calcularPiezasFabricables=="function"?window.calcularPiezasFabricables(i):t.length?Math.min(...t.map(l=>l.posibles)):0,detalle:t}}window.calcularDisponibilidadDesdeMP=calcularDisponibilidadDesdeMP;async function _mkEditLeadTime(i,e){const o=document.getElementById("_mkLeadTimeModal");o&&o.remove();const n=document.createElement("div");n.id="_mkLeadTimeModal",n.innerHTML=`
...
"use strict";function _levenshtein(t,o){const r=t.length,s=o.length,i=Array.from({length:r+1},(a,n)=>Array.from({length:s+1},(d,l)=>l===0?n:0));for(let a=1;a<=s;a++)i[0][a]=a;for(let a=1;a<=r;a++)for(let n=1;n<=s;n++)i[a][n]=t[a-1]===o[n-1]?i[a-1][n-1]:1+Math.min(i[a-1][n],i[a][n-1],i[a-1][n-1]);return i[r][s]}window._levenshtein=_levenshtein;function _fuzzyMatch(t,o,r=2){return t=t.toLowerCase().trim(),o=o.toLowerCase(),!t||o.includes(t)?!0:o.split(/[\s,.-]+/).some(i=>{const a=i.substring(0,t.length+2);return a.length>=t.length-1&&_levenshtein(t,a)<=r})}window._fuzzyMatch=_fuzzyMatch;function calcularProducibles(t){return!Array.isArray(t.mpComponentes)||t.mpComponentes.length===0?null:typeof window.calcularPiezasFabricables=="function"?window.calcularPiezasFabricables(t):0}window.calcularProducibles=calcularProducibles;function abrirBulkPrecioModal(){let t=document.getElementById("bulkPrecioModal");t||(t=document.createElement("div"),t.id="bulkPrecioModal",t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;",t.addEventListener("click",s=>{s.target===t&&(t.style.display="none")}),document.body.appendChild(t));const r=[...new Set((window.products||[]).map(s=>s.category).filter(Boolean))].map(s=>{const i=(window.categories||[]).find(a=>String(a.id)===String(s));return`<option value="${_esc(s)}">${_esc(i?i.emoji?i.emoji+" "+i.name:i.name:s)}</option>`}).join("");t.innerHTML=`
    ...
    <div style="background:#fff;border-radius:20px;width:min(520px,95vw);max-height:88vh;overflow:hidden;display:flex;flex-direction:column;box-shadow:0 20px 60px rgba(0,0,0,0.25);">
        ...
        `,document.head.appendChild(e)}let u=document.getElementById("invExtraColToggle");if(u||(u=document.createElement("button"),u.id="invExtraColToggle",u.style.cssText="padding:6px 14px;border:1.5px solid #e5e7eb;border-radius:10px;background:#fff;font-size:.8rem;font-weight:600;color:#6b7280;cursor:pointer;margin-bottom:10px;",u.textContent="Mostrar SKU/Proveedor",u.addEventListener("click",()=>{const e=document.getElementById("invDualContainer");if(!e)return;const x=e.classList.toggle("inv-show-extra");u.textContent=x?"Ocultar SKU/Proveedor":"Mostrar SKU/Proveedor"}),n.parentNode.insertBefore(u,n)),d.length===0){n.innerHTML=`
        ...
        </div>`;return}const c=(document.getElementById("inventorySearch")||{}).value?.trim().toLowerCase()||"",w=(document.getElementById("inventoryTagFilter")||{}).value||"",v=(document.getElementById("inventoryProveedorFilter")||{}).value?.trim().toLowerCase()||"";function z(e){const x=window._normSearch||(y=>String(y||"").toLowerCase()),g=x(c),S=x(v),k=y=>!w||y.tags&&y.tags.includes(w),$=y=>!v||x(y.proveedor||"").includes(S);if(!c)return e.filter(y=>k(y)&&$(y));const E=e.filter(y=>(x(y.name).includes(g)||x(y.sku||"").includes(g)||x(y.proveedor||"").includes(g)||x(y.notas||"").includes(g)||(y.tags||[]).some(G=>x(G).includes(g)))&&k(y)&&$(y));return E.length>0?E:e.filter(y=>(_fuzzyMatch(g,y.name||"")||_fuzzyMatch(g,y.sku||"")||_fuzzyMatch(g,y.proveedor||""))&&k(y)&&$(y))}const b=z(d.filter(e=>e.tipo==="materia_prima")),L=z(d.filter(e=>e.tipo==="servicio")),F=z(d.filter(e=>e.tipo==="producto_variable")),U=z(d.filter(e=>!e.tipo||e.tipo==="producto"||e.tipo==="producto_interno"||e.tipo==="pack")),_=new Set([...U,...F].map(e=>String(e.id))),T=window.productMap||new Map(d.map(e=>[String(e.id),e])),B=new Map;for(const e of d)e.mpComponentes&&e.mpComponentes.length>0&&_.has(String(e.id))&&B.set(String(e.id),calcularDisponibilidadDesdeMP(e,T,l));function f(e){if(!window._invSortCol)return e;const x=window._invSortCol,g=window._invSortDir;return[...e].sort((S,k)=>{let $,E;return x==="name"?($=(S.name||"").toLowerCase(),E=(k.name||"").toLowerCase()):x==="sku"?($=(S.sku||"").toLowerCase(),E=(k.sku||"").toLowerCase()):x==="category"?($=(S.category||"").toLowerCase(),E=(k.category||"").toLowerCase()):x==="price"?($=Number(S.price)||0,E=Number(k.price)||0):x==="stock"?($=Number(S.stock)||0,E=Number(k.stock)||0):x==="margin"&&($=S.cost&&S.price?(S.price-S.cost)/S.price:-1,E=k.cost&&k.price?(k.price-k.cost)/k.price:-1),$<E?g==="asc"?-1:1:$>E?g==="asc"?1:-1:0})}function h(e,x){const g=String(e.id),S=l.get(g)??(typeof getStockEfectivo=="function"?getStockEfectivo(e):parseInt(e.stock)||0),k=e.imageUrl?`<img src="${e.imageUrl}" alt="${_esc(e.name||"")}" style="width:40px;height:40px;object-fit:cover;border-radius:8px;border:1px solid rgba(0,0,0,0.08);background:#f9fafb;" loading="lazy">`:`<span style="font-size:1.6rem;">${e.image||"\u{1F3ED}"}</span>`;let $;S===0?$='<span class="badge-danger"><i class="fas fa-circle-xmark"></i> Agotado</span>':S<=(e.stockMin||5)?$='<span class="badge-warning"><i class="fas fa-triangle-exclamation"></i> Bajo Stock</span>':$='<span class="badge-success"><i class="fas fa-circle-check"></i> Disponible</span>';const E=(window.categories||[]).find(N=>N.id===e.category),y=E?E.name:e.category||"";return`
        <tr style="animation:mkSectionIn 0.3s ease both;animation-delay:${x*.03}s" class="hover:bg-purple-50">
            ...
            <td class="px-4 py-3">
                <div>
                    ...
                    ${e.tags&&e.tags.length?`<div style="display:flex;flex-wrap:wrap;gap:2px;margin-top:2px;">${e.tags.map(N=>`<span style="padding:1px 6px;border-radius:99px;font-size:10px;background:#f3e8ff;color:#9669c4;border:1px solid #e9d5ff;">${_esc(N)}</span>`).join("")}</div>`:""}
                </div>
            </td>
            ...
            <td class="px-4 py-3 font-semibold" id="stock-cell-${g}">
                <div style="display:flex;flex-direction:column;align-items:flex-start;gap:2px;">
                    <span data-dblclick="editarStockInline" data-arg="${g}" title="Doble clic para editar"
                        ...
                        ${S} <span style="font-size:10px;color:#9ca3af;font-weight:400;">${_esc(e.unidad||"pza")}</span>
                    </span>
                </div>
            </td>
        ...
        </tr>`}function P(e,x){const g=String(e.id),S=`<span style="font-size:1.6rem;">${e.image||"\u2699\uFE0F"}</span>`;return`
        <tr style="animation:mkSectionIn 0.3s ease both;animation-delay:${x*.03}s" class="hover:bg-indigo-50">
            ...
            <td class="px-4 py-3">
                <div>
                    <span class="font-semibold text-gray-800" style="font-size:.9rem;">${_esc(e.name)}</span>
                    ${e.notas?`<div class="text-xs text-gray-400 truncate" style="max-width:160px;" title="${_esc(e.notas)}">${_esc(e.notas)}</div>`:""}
                    ${e.tags&&e.tags.length?`<div style="display:flex;flex-wrap:wrap;gap:2px;margin-top:2px;">${e.tags.map(k=>`<span style="padding:1px 6px;border-radius:99px;font-size:10px;background:#f6ecff;color:#7d4fa3;border:1px solid #dfbfff;">${_esc(k)}</span>`).join("")}</div>`:""}
                </div>
            </td>
            <td class="px-4 py-3 text-gray-500 text-xs inv-col-hidden-sku">${_esc(e.sku||"\u2014")}</td>
            ...
            <td class="px-2 py-3">
        ...
        </tr>`}function K(e,x){const g=String(e.id),S=e.imageUrl?`<img src="${e.imageUrl}" alt="${_esc(e.name||"")}" style="width:40px;height:40px;object-fit:cover;border-radius:8px;border:1px solid rgba(0,0,0,0.08);background:#f9fafb;" loading="lazy">`:`<span style="font-size:1.6rem;">${e.image||"\u{1F4E6}"}</span>`,k=(window.categories||[]).find(m=>m.id===e.category),$=k?k.name:e.category||"",E=B.get(g)??null;let y,N;if(E!==null){const m=E.piezas,I=m===0?"#ef4444":m<=3?"#f59e0b":"#10b981",j=m===0?"#fee2e2":m<=3?"#fef3c7":"#d1fae5",M=E.detalle.map(R=>`${R.nombre}: ${R.stock}\xF7${R.qty}=${R.posibles}pzs`).join(" | ");y=`
                <div style="display:flex;flex-direction:column;align-items:flex-start;gap:2px;">
                    <span title="${_esc(M)}"
                ...
                <button data-action="_mkInvToggleVarCollapse" data-arg="${g}" style="font-size:.68rem;color:#6b7280;background:#f3f4f6;border:1px solid #e5e7eb;border-radius:99px;padding:2px 8px;cursor:pointer;font-weight:600;white-space:nowrap;">
                    ${H?"\u25B2":"\u25B6"} ${e.variants.length} variante${e.variants.length!==1?"s":""}
                </button>
                ${H?'<div style="margin-top:4px;display:flex;flex-direction:column;gap:2px;">'+e.variants.map(m=>`
               ...
               </div>`:'<span class="text-xs text-gray-400">Sin variantes</span>',J=Number(e.cost)||0,q=Number(e.price)||0,X=J&&q?(()=>{const m=(q-J)/q*100,I=m>=40?"#10b981":m>=20?"#f59e0b":"#ef4444";return`<div style="min-width:56px;">
        ...
        <tr style="animation:mkSectionIn 0.3s ease both;animation-delay:${x*.03}s" class="hover:bg-amber-50">
            ...
            <td class="px-4 py-3">
                <div>
                    ...
                    ${(()=>{const m=calcularProducibles(e);if(m===null)return"";const I=m>=5?"#16a34a":m>=1?"#d97706":"#dc2626",j=m>=5?"#d1fae5":m>=1?"#fef3c7":"#fee2e2",M=m===0?"Sin stock MP":`Producibles: ${m}`;return`<div style="margin-top:3px;"><span style="font-size:9px;font-weight:700;padding:1px 7px;border-radius:99px;background:${j};color:${I};border:1px solid ${I}33;">\u{1F3ED} ${M}</span></div>`})()}
                </div>
            </td>
            <td class="px-4 py-3 text-gray-500 text-xs inv-col-hidden-sku">${_esc(e.sku||"\u2014")}</td>
            <td class="px-4 py-3 text-gray-600 text-sm capitalize">${_esc($)}</td>
            <td class="px-4 py-3">${Q}</td>
            <td class="px-4 py-3 text-right text-gray-800 font-semibold" data-dblclick="invInlineEditPrice" data-arg="${g}" data-pass-el="true" style="font-size:.95rem;cursor:pointer;" title="Doble-click para editar precio">$${Number(e.price||0).toFixed(2)}</td>
            ...
            <td class="px-2 py-3">
                <div style="display:flex;gap:3px;flex-wrap:wrap;">
                    ${e.tipo==="pack"?`<button type="button" data-action="openPackModal" data-arg="${g}" title="Editar Pack" aria-label="Editar pack"
                    ...
                    ${e.tipo!=="pack"?`<button type="button" data-action="cambiarTipoProducto" data-arg="${g}" title="Convertir a Materia Prima" aria-label="Convertir tipo de producto"
                    ...
                    ${e.movimientos&&e.movimientos.length?`<button type="button" data-action="verMovimientosProducto" data-arg="${g}" title="Ver movimientos de stock (${e.movimientos.length})" aria-label="Ver movimientos de stock"
                    ...
                    <button type="button" data-action="archivarProducto" data-arg="${g}" title="${e.activo===!1?"Desarchivar producto (activar)":"Archivar producto (ocultar)"}" aria-label="Archivar/Desarchivar"
        ...
        </tr>`}function O(e,x){const g=String(e.id),S=e.imageUrl?`<img src="${e.imageUrl}" alt="${_esc(e.name||"")}" style="width:40px;height:40px;object-fit:cover;border-radius:8px;border:1px solid rgba(0,0,0,0.08);background:#f9fafb;" loading="lazy">`:`<span style="font-size:1.6rem;">${e.image||"\u{1F3AF}"}</span>`,k=(e.tablaPreciosVariable||[]).slice().sort((C,W)=>C.cantidadMin-W.cantidadMin),$=k.length?k.map(C=>`<span style="font-size:10px;background:#e0f2fe;color:#0369a1;padding:1px 7px;border-radius:99px;white-space:nowrap;">${C.cantidadMin} pzas = $${Number(C.precio).toFixed(2)}</span>`).join(" "):'<span style="font-size:10px;color:#9ca3af;">Sin rangos</span>',E=(e.mpComponentes||[]).length,y=(window.categories||[]).find(C=>String(C.id)===String(e.category)),N=y?`${y.emoji||""} ${y.name}`:"\u2014",G=k,H=G.length?G[0].precio/(G[0].cantidadMin||1):0,at=H>0?`<div><span class="font-semibold text-gray-800" style="font-size:.95rem;">$${H.toFixed(2)}</span><div style="font-size:10px;color:#9ca3af;">por pieza</div></div>`:'<span style="color:#9ca3af;font-size:.8rem;">\u2014</span>',Q=B.get(String(e.id))??null;let J,q;if(Q!==null){const C=Q.piezas,W=C===0?"#ef4444":C<=3?"#f59e0b":"#10b981",ct=C===0?"#fee2e2":C<=3?"#fef3c7":"#d1fae5",rt=Q.detalle.map(et=>`${et.nombre}: ${et.stock}\xF7${et.qty}=${et.posibles}pzs`).join(" | ");J=`<div style="display:flex;flex-direction:column;align-items:flex-start;gap:2px;">
                <span title="${_esc(rt)}" style="padding:3px 12px;border-radius:8px;background:${ct};color:${W};font-weight:700;font-size:.95rem;border:1px solid ${W}33;cursor:help;">${C}</span>
                <span style="font-size:10px;color:#6b7280;">desde MP</span>
            </div>`,q=C===0?'<span class="badge-danger">Sin stock MP</span>':C<=3?'<span class="badge-warning">MP bajo</span>':'<span class="badge-success">Disponible</span>'}else J='<span style="font-size:.8rem;color:#9ca3af;font-style:italic;">Sin MP config.</span>',q='<span style="font-size:11px;background:#f3f4f6;color:#9ca3af;padding:2px 8px;border-radius:99px;">Sin MP config.</span>';const X=(e.mpComponentes||[]).reduce((C,W)=>C+(parseFloat(W.costUnit)||0)*(parseFloat(W.qty)||1),0),m=e.rendimientoPorHoja||1,I=m>0?X/m:X,j=H>0?Math.round((H-I)/H*100):0,M=j>=40?"#10b981":j>=20?"#f59e0b":"#ef4444",R=H>0?`<div style="min-width:48px;">
        ...
        <tr style="animation:mkSectionIn 0.3s ease both;animation-delay:${x*.03}s" class="hover:bg-sky-50">
            ...
            <td class="px-4 py-3">
                <div>
                    ...
                    ${e.notas?`<div class="text-xs text-gray-400 truncate" style="max-width:160px;" title="${_esc(e.notas)}">${_esc(e.notas)}</div>`:""}
                    ${e.tags&&e.tags.length?`<div style="display:flex;flex-wrap:wrap;gap:2px;margin-top:2px;">${e.tags.map(C=>`<span style="padding:1px 6px;border-radius:99px;font-size:10px;background:#e0f2fe;color:#0369a1;border:1px solid #bae6fd;">${_esc(C)}</span>`).join("")}</div>`:""}
                </div>
            </td>
            <td class="px-4 py-3 text-gray-500 text-xs inv-col-hidden-sku">${_esc(e.sku||"\u2014")}</td>
        ...
        </tr>`}function Y({id:e,title:x,titleColor:g,titleBg:S,btnLabel:k,btnOnclick:$,btnColor:E,extraBtnHTML:y,products:N,renderFila:G,headers:H,emptyMsg:at}){const Q=document.getElementById("inventoryTipoFilter")?.value||"";if(Q==="materia"&&e!=="mp"||Q==="producto"&&e==="mp")return"";const J=(document.getElementById("inventorySearch")?.value?.trim()||"").length>0;if(N.length===0&&J)return"";const q=f(N),X=`_invPage_${e}`,m=window._invPageSize||10;window[X]=window[X]||1;const I=q.length,j=Math.max(1,Math.ceil(I/m));window[X]>j&&(window[X]=1);const M=window[X],R=(M-1)*m,C=q.slice(R,R+m),W=C.length===0?`<tr><td colspan="${H.length}" style="padding:32px;text-align:center;color:#9ca3af;font-size:.85rem;">${at}</td></tr>`:C.map((V,nt)=>G(V,nt)).join(""),ct=H.map(V=>{const nt=V.colId==="sku"?" inv-col-hidden-sku":V.colId==="proveedor"?" inv-col-hidden-prov":"",it=V.align==="right"?" text-right":" text-left";return V.sortKey?`<th class="px-4 py-3${it} text-xs font-semibold text-gray-500 uppercase tracking-wide sortable-th cursor-pointer select-none${nt}" data-action="sortInventory" data-arg="${V.sortKey}" style="white-space:nowrap;">${V.label} \u2195</th>`:`<th class="px-4 py-3${it} text-xs font-semibold text-gray-500 uppercase tracking-wide${nt}" style="white-space:nowrap;">${V.label}</th>`}).join("");let rt="";if(j>1||I>m){const V=Math.min(R+m,I);rt=`
            <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;
                ...
                <div style="display:flex;gap:4px;">
                    <button data-action="invSectionPage" data-arg="${e}" data-arg2="${M-1}" onclick="invSectionPage('${e}', ${M-1})" ${M<=1?"disabled":""} style="padding:4px 10px;border:1px solid #e5e7eb;border-radius:7px;background:#fff;cursor:${M<=1?"default":"pointer"};opacity:${M<=1?.4:1};font-size:13px;">\u2039</button>
                    ${Array.from({length:Math.min(5,j)},(nt,it)=>{let D=M<=3?it+1:M+it-2;return D<1&&(D=null),D>j&&(D=null),D===null?"":`<button data-action="invSectionPage" data-arg="${e}" data-arg2="${D}" onclick="invSectionPage('${e}', ${D})" style="min-width:30px;padding:4px 8px;border:1px solid ${D===M?"#FFD166":"#e5e7eb"};border-radius:7px;background:${D===M?"#FFD166":"#fff"};color:${D===M?"#fff":"#374151"};font-weight:${D===M?700:400};font-size:13px;cursor:${D===M?"default":"pointer"};" ${D===M?"disabled":""}>${D}</button>`}).join("")}
                    <button data-action="invSectionPage" data-arg="${e}" data-arg2="${M+1}" onclick="invSectionPage('${e}', ${M+1})" ${M>=j?"disabled":""} style="padding:4px 10px;border:1px solid #e5e7eb;border-radius:7px;background:#fff;cursor:${M>=j?"default":"pointer"};opacity:${M>=j?.4:1};font-size:13px;">\u203A</button>
                </div>
            </div>`}const et=`_invSec_${e}_collapsed`,pt=window[et]===!0;return`
        <div style="margin-bottom:32px;border-radius:16px;overflow:hidden;border:1.5px solid ${g}33;box-shadow:0 2px 12px ${g}11;">
            ...
            <div style="display:flex;align-items:center;justify-content:space-between;padding:14px 20px;background:${S};border-bottom:${pt?"none":"1.5px solid "+g+"33"};cursor:pointer;" data-action="_mkInvToggleCollapse" data-arg="${e}">
                <div style="display:flex;align-items:center;gap:10px;">
                    ...
                    <span style="background:${g};color:#fff;font-size:11px;font-weight:700;padding:2px 10px;border-radius:99px;">${I}</span>
                </div>
            ...
            ${rt}`}
        </div>`}const A=d.filter(e=>!e.deletedAt),Z=A.length,tt=A.reduce((e,x)=>{const g=l.get(String(x.id))??(typeof getStockEfectivo=="function"?getStockEfectivo(x):parseInt(x.stock)||0);return e+(Number(x.cost)||0)*Math.max(0,g)},0),st=A.filter(e=>(l.get(String(e.id))??(typeof getStockEfectivo=="function"?getStockEfectivo(e):parseInt(e.stock)||0))<=(e.stockMin||5)).length,dt=A.filter(e=>(!e.tipo||e.tipo==="producto"||e.tipo==="producto_interno"||e.tipo==="pack")&&Number(e.price)>0),lt=dt.length?dt.reduce((e,x)=>{const g=Number(x.price)||0,S=Number(x.cost)||0;return e+(g>0?(g-S)/g*100:0)},0)/dt.length:0;let ot=document.getElementById("invKpiBar");ot||(ot=document.createElement("div"),ot.id="invKpiBar",n.parentNode.insertBefore(ot,n)),ot.innerHTML=`
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:20px;">
        ...
        </div>`)}function invSectionPage(t,o){const r=`_invPage_${t}`,s=window.products||[],i=t==="mp"?s.filter(c=>c.tipo==="materia_prima"):t==="svc"?s.filter(c=>c.tipo==="servicio"):t==="pv"?s.filter(c=>c.tipo==="producto_variable"):s.filter(c=>!c.tipo||c.tipo==="producto"||c.tipo==="producto_interno"||c.tipo==="pack"),a=(document.getElementById("inventorySearch")||{}).value?.trim().toLowerCase()||"",n=(document.getElementById("inventoryTagFilter")||{}).value||"",d=(document.getElementById("inventoryProveedorFilter")||{}).value?.trim().toLowerCase()||"",l=i.filter(c=>{const w=!a||c.name.toLowerCase().includes(a)||(c.sku||"").toLowerCase().includes(a)||(c.proveedor||"").toLowerCase().includes(a)||(c.notas||"").toLowerCase().includes(a)||(c.tags||[]).some(b=>b.toLowerCase().includes(a)),v=!n||c.tags&&c.tags.includes(n),z=!d||(c.proveedor||"").toLowerCase().includes(d);return w&&v&&z}),u=Math.max(1,Math.ceil(l.length/(window._invPageSize||10)));window[r]=Math.max(1,Math.min(o,u)),renderInventoryTable()}window.invSectionPage=invSectionPage;function _renderInventoryPagination(t,o,r,s,i){let a=document.getElementById("inventoryPaginationBar");if(!a){const u=document.getElementById("inventoryTable")?.closest('table, .overflow-x-auto, [class*="overflow"]');if(!u)return;a=document.createElement("div"),a.id="inventoryPaginationBar",u.insertAdjacentElement("afterend",a)}if(o<=1&&r<=i){a.innerHTML="";return}const n=Math.min(s+i,r),d=`Mostrando <b>${s+1}\u2013${n}</b> de <b>${r}</b> productos`;function l(){const u=[],c=(w,v)=>{for(let z=w;z<=v;z++)u.push(z)};return o<=7?c(1,o):(u.push(1),t>4&&u.push("..."),c(Math.max(2,t-2),Math.min(o-1,t+2)),t<o-3&&u.push("..."),u.push(o)),u.map(w=>{if(w==="...")return'<span style="padding:0 4px;color:#9ca3af;">\u2026</span>';const v=w===t;return`<button data-action="invGoToPage" data-arg="${w}"
...
`});const U=new Blob([F],{type:"text/csv;charset=utf-8;"}),_=URL.createObjectURL(U),T=document.createElement("a");T.href=_,T.download=`movimientos-${a}.csv`,T.click(),URL.revokeObjectURL(_)},o.parentNode.insertBefore(v,o)),!i.length){o.innerHTML='<p class="text-gray-400 text-sm text-center py-4">Sin movimientos registrados</p>';return}const z={entrada:"\u{1F7E2}",salida:"\u{1F534}",ajuste:"\u{1F7E1}",creacion:"\u{1F535}",venta:"\u{1F7E0}",merma:"\u{1F7E4}"};o.innerHTML=i.slice(0,200).map(b=>{const L=new Date(b.fecha).toLocaleString("es-MX",{dateStyle:"short",timeStyle:"short"}),F=b.cantidad>=0?`+${b.cantidad}`:`${b.cantidad}`;return`<div style="display:flex;align-items:center;gap:10px;padding:8px 12px;border-bottom:1px solid #f3f4f6;font-size:13px;">
        ...
        </div>`}).join("")}window.renderStockMovements=renderStockMovements;function duplicarProducto(t){const o=(window.products||[]).find(s=>String(s.id)===String(t));if(!o){manekiToastExport("Producto no encontrado","err");return}const r=JSON.parse(JSON.stringify(o));r.id=_genId(),r.name="Copia de "+o.name,r.sku=(o.sku||"")+"-C",r.stock=0,r.historialPrecios=[],r.historialCostos=[],window.products.unshift(r),saveProducts(),renderInventoryTable(),manekiToastExport(`\u{1F4CB} "${r.name}" creado \u2014 ed\xEDtalo para ajustar stock y SKU`,"ok")}window.duplicarProducto=duplicarProducto;function abrirReporteRentabilidad(){const t=(window.products||[]).filter(n=>!n.tipo||n.tipo==="producto"||n.tipo==="producto_interno"),o=t.map(n=>{const d=n.price>0&&n.cost>0?(n.price-n.cost)/n.price*100:null;return{...n,_margen:d}}).sort((n,d)=>(d._margen??-1/0)-(n._margen??-1/0)),r=o.map((n,d)=>{const l=n._margen!==null?n._margen.toFixed(1)+"%":"\u2014",u=n.price>0&&n.cost>0?"$"+(n.price-n.cost).toFixed(2):"\u2014",c=n._margen===null?"#9ca3af":n._margen>=50?"#16a34a":n._margen>=30?"#d97706":"#dc2626";return`<tr style="border-bottom:1px solid #f3f4f6;">
        ...
        </tr>`}).join(""),s=o.filter(n=>n._margen!==null).reduce((n,d,l,u)=>n+d._margen/u.length,0),i=o[0];let a=document.getElementById("_mkRentabilidadModal");a||(a=document.createElement("div"),a.id="_mkRentabilidadModal",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;",a.addEventListener("click",n=>{n.target===a&&(a.style.display="none")}),document.body.appendChild(a)),a.innerHTML=`
...
`),a=new Blob([i],{type:"text/csv;charset=utf-8;"}),n=URL.createObjectURL(a),d=document.createElement("a");d.href=n,d.download="inventario_seleccion.csv",d.click(),URL.revokeObjectURL(n),manekiToastExport(`\u{1F4E5} ${o.length} productos exportados`,"ok")}window.invBulkExportar=invBulkExportar;async function invBulkCambiarCategoria(){const t=invGetSelectedIds();if(!t.length)return;const o=await new Promise(s=>{const i=document.getElementById("mkBatchCatModal");i&&i.remove();const n=(window.categories||[]).map(l=>`<option value="${l.id}">${l.emoji||""} ${l.name}</option>`).join(""),d=document.createElement("div");d.id="mkBatchCatModal",d.className="mk-modal-overlay",d.innerHTML=`<div class="mk-modal-box" style="max-width:360px">
    ...
    <div style="margin-top:18px;display:flex;gap:10px;justify-content:flex-end;">
      ...
      <button onclick="_mkAplicarConteoFisico()" class="mk-btn-primary" style="padding:9px 24px;">\u2705 Aplicar ajustes</button>
        ...
        <td style="padding:6px 10px;font-size:.78rem;color:#6b7280;">${o(c.unidad||"pza")}</td></tr>`}).join(""),l=encodeURIComponent(`Hola, necesito reabastecer:
...
`),s=document.createElement("a");s.href=URL.createObjectURL(new Blob([r],{type:"text/csv;charset=utf-8;"}));const i=new Date,a=`${i.getFullYear()}-${String(i.getMonth()+1).padStart(2,"0")}-${String(i.getDate()).padStart(2,"0")}`;s.download=`reabastecimiento_${a}.csv`,s.click()};function mostrarDonutCategoria(){const t=_esc,o={};(window.products||[]).forEach(d=>{if(d.tipo==="servicio"||d.activo===!1)return;const l=typeof getStockEfectivo=="function"?getStockEfectivo(d):Number(d.stock)||0,u=(Number(d.price)||0)*l,c=d.category||"Sin categor\xEDa";o[c]=(o[c]||0)+u});const r=Object.entries(o).sort((d,l)=>l[1]-d[1]),s=r.reduce((d,[,l])=>d+l,0),i=["#FFD166","#9669c4","#10b981","#3b82f6","#f59e0b","#ef4444","#06b6d4","#9669c4","#f97316","#14b8a6"],a=r.map(([d,l],u)=>{const c=s>0?(l/s*100).toFixed(1):"0";return`<tr>
    ...
    <div style="background:#f9fafb;border-radius:10px;padding:10px;margin-bottom:14px;">
      ...
      <td style="padding:6px 10px;font-size:.78rem;">${o(K)}</td>
