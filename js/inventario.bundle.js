...
"use strict";async function guardarMateriaPrima(){const i=m=>{const E=document.getElementById(m);return E?E.value:""},e=i("mpNombre").trim(),o=parseInt(i("mpStock"))||0,n=parseInt(i("mpStockMin"))||5,r=i("mpSku").trim(),s=i("mpProveedor").trim(),t=i("mpProveedorUrl").trim(),a=i("mpUnidad")||"pza",l=i("mpNotas").trim(),c=document.getElementById("mpUsaPaquete")?.checked||!1,d=parseFloat(i("mpPaqueteCantidad"))||0,u=parseFloat(i("mpPaquetePrecio"))||0;let p=0;if(c){if(d<=0||u<=0){manekiToastExport("\u26A0\uFE0F Ingresa la cantidad y precio del paquete","warn");return}p=u/d}else p=parseFloat(i("mpCosto"))||0;if(!e){manekiToastExport("\u26A0\uFE0F El nombre es requerido","warn");return}if(p<=0){manekiToastExport("\u26A0\uFE0F El costo debe ser mayor a 0","warn");return}const w=window.modoEdicion?window.edicionProductoId:null,M=(window.products||[]).find(m=>m.name.trim().toLowerCase()===e.toLowerCase()&&String(m.id)!==String(w));if(M){manekiToastExport(`\u26A0\uFE0F Ya existe un producto llamado "${M.name}". Usa un nombre diferente o edita el existente.`,"warn");return}if(r&&!skuEsUnico(r,w)){manekiToastExport(`\u26A0\uFE0F El SKU "${r}" ya est\xE1 en uso`,"warn");return}if(window.currentProductImageFile){manekiToastExport("\u23F3 Subiendo imagen...","ok");const m=await subirImagenStorage(window.currentProductImageFile).catch(()=>null);m?window.currentProductImage=m:manekiToastExport("\u26A0\uFE0F No se pudo subir la imagen. Intenta de nuevo.","warn"),window.currentProductImageFile=null}const b=document.getElementById("mpEsEmpaque")?.checked||!1,f=[...window._mpTagsActuales||[]],v=mkId().split("-")[0].toUpperCase(),k=r||"MP-"+v,S=document.getElementById("mpUsaVariantes")?.checked||!1,y=S?[...window._mpVariantes||[]]:[],g=S?y.reduce((m,E)=>m+(parseInt(E.qty)||0),0):o;if(window.modoEdicion&&window.edicionProductoId!==null){const m=(window.products||[]).findIndex(I=>String(I.id)===String(window.edicionProductoId));if(m===-1){manekiToastExport("Error: producto no encontrado","err");return}const E=window.products[m].stock,h=window.products[m].cost||0,x=[...window.products[m].historialCostos||[]];p!==h&&x.push({fecha:new Date().toISOString(),costoAntes:h,costoNuevo:p}),window.products[m]=Object.assign({},window.products[m],{name:e,tipo:"materia_prima",cost:p,price:0,stock:g,stockMin:n,sku:k,tags:f,proveedor:s,proveedorUrl:t,unidad:a,notas:l,imageUrl:window.currentProductImage||window.products[m].imageUrl,compraPaquete:c?{cantidad:d,precio:u}:null,variants:y,usaVariantes:S,historialCostos:x,esEmpaque:b}),g!==E&&registrarMovimiento({productoId:window.edicionProductoId,productoNombre:e,tipo:"ajuste",cantidad:g-E,motivo:"Edici\xF3n",stockAntes:E,stockDespues:g}),p!==h&&_cascadeCostMP(window.edicionProductoId,p),S&&y.length>0&&_cascadeVariantesMP(window.edicionProductoId,y),saveProducts(),renderInventoryTable(),typeof updateDashboard=="function"&&updateDashboard(),typeof window._mkModalSaved=="function"&&window._mkModalSaved("mpModal"),closeMateriaPrimaModal(),window.MKS&&MKS.notify(),manekiToastExport("\u2705 Materia prima actualizada","ok")}else{const m={id:_genId(),name:e,tipo:"materia_prima",category:"materiales",cost:p,price:0,stock:g,stockMin:n,sku:k,tags:f,proveedor:s,proveedorUrl:t,unidad:a,notas:l,image:"\u{1F3ED}",imageUrl:window.currentProductImage||null,variants:y,usaVariantes:S,compraPaquete:c?{cantidad:d,precio:u}:null,esEmpaque:b};window.products.unshift(m),window._invCurrentPage=1,g>0&&registrarMovimiento({productoId:m.id,productoNombre:m.name,tipo:"creacion",cantidad:g,motivo:"Alta de materia prima",stockAntes:0,stockDespues:g}),saveProducts(),renderInventoryTable(),typeof updateDashboard=="function"&&updateDashboard(),typeof window._mkModalSaved=="function"&&window._mkModalSaved("mpModal"),closeMateriaPrimaModal(),window.MKS&&MKS.notify(),manekiToastExport("\u2705 Materia prima agregada","ok")}}window.guardarMateriaPrima=guardarMateriaPrima;function _cascadeCostMP(i,e){const o=[];(window.products||[]).forEach(t=>{if(t.tipo==="materia_prima"||t.tipo==="servicio"||!Array.isArray(t.mpComponentes)||!t.mpComponentes.length)return;const a=t.mpComponentes.find(d=>String(d.id)===String(i));if(!a)return;const l=t.cost||0;a.costUnit=e;const c=t.mpComponentes.reduce((d,u)=>d+(u.costUnit||0)*(u.qty||1),0);t.cost=Math.round(c*100)/100,t.historialPrecios||(t.historialPrecios=[]),t.historialPrecios.push({fecha:new Date().toISOString(),costoAntes:l,costoNuevo:t.cost,precioAntes:t.price,precioNuevo:t.price}),o.push(t.name)}),o.length&&manekiToastExport(`\u{1F4B0} Costo recalculado en: ${o.join(", ")}`,"ok");const n=(window.products||[]).filter(t=>(t.mpComponentes||[]).some(a=>String(a.id)===String(i))),r=new Set(n.map(t=>String(t.id))),s=(window.pedidos||[]).filter(t=>!["cancelado","finalizado"].includes(t.status||"")&&(t.productosInventario||[]).some(a=>r.has(String(a.id))));if(s.length>0){const t=s.map(a=>a.folio||a.id).join(", ");manekiToastExport(`\u{1F4A1} ${s.length} pedido(s) activo(s) usan productos afectados por este cambio de costo (${t}). Revisa sus precios.`,"warn")}}window._cascadeCostMP=_cascadeCostMP;function _cascadeVariantesMP(i,e){if(!Array.isArray(e)||!e.length)return;const o=[];(window.products||[]).forEach(n=>{n.tipo==="materia_prima"||n.tipo==="servicio"||!Array.isArray(n.mpComponentes)||!n.mpComponentes.length||n.mpComponentes.some(r=>String(r.id)===String(i))&&(n.variants=e.map(r=>{const s=(n.variants||[]).find(t=>(t.type||t.tipo)===(r.type||r.tipo)&&(t.value||t.valor)===(r.value||r.valor));return s?{...r,qty:s.qty??r.qty}:{...r}}),n.usaVariantes=!0,o.push(n.name))}),o.length&&manekiToastExport(`\u{1F3A8} Variantes sincronizadas en: ${o.join(", ")}`,"ok")}window._cascadeVariantesMP=_cascadeVariantesMP;function editProduct(i){const e=(window.products||[]).find(o=>String(o.id)===String(i));if(!e){console.warn("editProduct: no encontrado",i);return}e.tipo==="materia_prima"?(injectMpModal(),window.modoEdicion=!0,window.edicionProductoId=i,window.currentProductImage=e.imageUrl||null,window.currentProductImageFile=null,window._mpTagsActuales=[...e.tags||[]],setTimeout(()=>{const o=document.getElementById("mpForm");o&&o.reset();const n=(d,u)=>{const p=document.getElementById(d);p&&(p.value=u??"")};n("mpNombre",e.name),n("mpSku",e.sku||""),n("mpStock",e.stock||0),n("mpStockMin",e.stockMin||5),n("mpProveedor",e.proveedor||""),n("mpProveedorUrl",e.proveedorUrl||""),n("mpNotas",e.notas||""),setTimeout(()=>{const d=document.getElementById("mpUnidad");d&&(d.value=e.unidad||"pza")},10);const r=document.getElementById("mpUsaPaquete");if(e.compraPaquete&&e.compraPaquete.cantidad>0?(r&&(r.checked=!0,mpTogglePaquete()),n("mpPaqueteCantidad",e.compraPaquete.cantidad),n("mpPaquetePrecio",e.compraPaquete.precio),mpCalcCostoUnidad()):(r&&(r.checked=!1,mpTogglePaquete()),n("mpCosto",e.cost||0)),e.usaVariantes&&Array.isArray(e.variants)&&e.variants.length>0){window._mpVariantes=[...e.variants];const d=document.getElementById("mpUsaVariantes");d&&(d.checked=!0,mpToggleVariantes()),renderVariantesMp()}else _resetMpVariantesUI(),n("mpStock",e.stock||0);const s=document.getElementById("mpPreviewImg"),t=document.getElementById("mpImagePreview");e.imageUrl&&s?(s.src=e.imageUrl,t&&t.classList.remove("hidden")):t&&t.classList.add("hidden");const a=document.getElementById("mpEsEmpaque");a&&(a.checked=!!e.esEmpaque),renderMpTags();const l=document.querySelector("#mpModal h3");l&&(l.textContent="\u{1F3ED} Editar Materia Prima");const c=document.getElementById("mpSubmitBtn");c&&(c.textContent="\u{1F4BE} Guardar Cambios"),typeof openModal=="function"&&openModal("mpModal")},150)):e.tipo==="producto_variable"?(typeof injectVariableProductModal=="function"&&injectVariableProductModal(),typeof openVariableProductModal=="function"&&openVariableProductModal(i)):(injectPtModal(),window.modoEdicion=!0,window.edicionProductoId=i,window._ptVariants=Array.isArray(e.variants)?[...e.variants]:[],window._ptMpComponentes=Array.isArray(e.mpComponentes)?[...e.mpComponentes]:[],window._ptTagsActuales=[...e.tags||[]],window.currentVariants=[...window._ptVariants],window.currentProductImage=e.imageUrl||null,window.currentProductImageFile=null,window._ptGaleriaUrls=Array.isArray(e.imageUrls)?[...e.imageUrls]:[],window._ptGaleriaFiles=[],setTimeout(()=>{const o=(d,u)=>{const p=document.getElementById(d);p&&(p.value=u??"")};if(o("ptNombre",e.name),o("ptSku",e.sku||""),o("ptCosto",e.cost||0),o("ptPrecio",e.price||0),o("ptStockMin",e.stockMin??5),o("ptRendimientoPorHoja",e.rendimientoPorHoja||""),setTimeout(()=>{o("ptProveedorNombre",e.proveedorNombre||""),o("ptProveedorNotas",e.proveedorNotas||"")},200),poblarCategoriasPt(),setTimeout(()=>{const d=document.getElementById("ptCategory");d&&(d.value=e.category)},80),e.imageUrl){const d=document.getElementById("ptPreviewImg"),u=document.getElementById("ptImagePreview");d&&(d.src=e.imageUrl),u&&u.classList.remove("hidden")}ptRenderGaleria(),renderTagsPt(),renderVariantsListPt(),renderPtMpList(),recalcularCostoPt(),ptMostrarMargenInfo();const n=document.getElementById("ptPublicarTienda"),r=document.getElementById("ptToggleTrack"),s=document.getElementById("ptToggleThumb");n&&(n.checked=e.publicarTienda===!0||e.tipo==="producto",r&&(r.style.background=n.checked?"#10b981":"#d1d5db"),s&&(s.style.transform=n.checked?"translateX(22px)":"translateX(0)"));const t=document.getElementById("ptDescripcionWeb");t&&(t.value=e.descripcionWeb||""),["cumpleanos","san-valentin","bodas-xv","graduaciones","empresarial","navidad"].forEach(d=>{const u=document.getElementById(`ptOc_${d}`),p=document.getElementById(`ptOcLabel_${d}`);u&&(u.checked=Array.isArray(e.ocasiones)&&e.ocasiones.includes(d),p&&(p.style.borderColor=u.checked?"#FFD166":"#e5e7eb",p.style.background=u.checked?"#fdf8f0":""))});const l=document.querySelector("#ptModal h3");l&&(l.textContent="\u270F\uFE0F Editar Producto Terminado");const c=document.getElementById("ptSubmitBtn");c&&(c.textContent="\u{1F4BE} Guardar Cambios")},120),typeof openModal=="function"&&openModal("ptModal"))}window.editProduct=editProduct,document.addEventListener("DOMContentLoaded",function(){setTimeout(()=>{try{const n=localStorage.getItem("mkStockMovements");if(n){const r=JSON.parse(n);Array.isArray(r)&&r.length>0&&((!window.stockMovements||window.stockMovements.length===0)&&(window.stockMovements=r,window.stockMovimientos=r,saveStockMovements(),console.log("[Migraci\xF3n] stockMovements: "+r.length+" movimientos migrados a SQLite/Supabase.")),localStorage.removeItem("mkStockMovements"))}}catch(n){console.warn("[Migraci\xF3n] Error migrando stockMovements:",n)}},3e3),injectMpModal(),injectPtModal(),setupImageUpload(),["inventorySearch","inventoryTagFilter","inventoryTipoFilter","inventoryProveedorFilter"].forEach(n=>{function r(){const s=document.getElementById(n);if(s&&!s._invPagListenerAdded){const t=()=>{window._invCurrentPage=1,["pt","pv","mp","svc"].forEach(a=>{window[`_invPage_${a}`]=1}),renderInventoryTable()};s.addEventListener("input",t),s.addEventListener("change",t),s._invPagListenerAdded=!0}}r(),setTimeout(r,800),setTimeout(r,2e3)}),setTimeout(patchInventoryButtons,400);const e=document.getElementById("inventorySection")||document.querySelector('section[id*="inventor"]')||document.querySelector('[data-section="inventory"]');e&&new MutationObserver(r=>{for(const s of r)if(s.attributeName==="class"||s.attributeName==="style"){const t=s.target;!t.classList.contains("hidden")&&t.style.display!=="none"&&t.offsetParent!==null&&setTimeout(patchInventoryButtons,80)}}).observe(e,{attributes:!0});const o=document.getElementById("addProductForm");o&&!o._mkSubmitBound&&(o._mkSubmitBound=!0,o.addEventListener("submit",function(n){n.preventDefault(),openAddProductModal()}))});function patchInventoryButtons(){const i=document.querySelector('[onclick="openAddProductModal()"]');if(!i)return;const e=i.parentElement;if(i.innerHTML="\u{1F4E6} Producto Terminado",i.title="Agregar producto terminado",[{selector:'[onclick="toggleMovimientos()"]',html:"\u{1F550} Movimientos"},{selector:'[onclick="imprimirInventario()"]',html:"\u{1F5A8}\uFE0F Imprimir"},{selector:`[onclick="manekiExportar('inventario')"]`,html:"\u{1F4CA} Exportar Excel"}].forEach(({selector:n,html:r})=>{const s=document.querySelector(n);s&&(s.innerHTML=r)}),!e.querySelector("[data-mp-btn]")){const n=document.createElement("button");n.setAttribute("data-mp-btn","1"),n.onclick=()=>{injectMpModal(),openAddMateriaPrimaModal()},n.className="px-5 py-2.5 rounded-xl text-white text-sm font-semibold flex items-center gap-2",n.style.cssText="background:linear-gradient(135deg,#9669c4,#ab84d1);",n.innerHTML="\u{1F9EA} Materia Prima",n.title="Agregar materia prima",e.insertBefore(n,i)}}window.patchInventoryButtons=patchInventoryButtons;function ajustarStock(i){const e=(window.products||[]).find(u=>String(u.id)===String(i));if(!e)return;window._ajustarStockId=String(i),window.__ajustarStockIdBackup=String(i);const o=document.getElementById("ajustarStockNombre"),n=document.getElementById("ajustarStockActual"),r=document.getElementById("ajustarStockCantidad"),s=document.getElementById("ajustarStockMotivo");o&&(o.textContent=e.name),n&&(n.textContent=getStockEfectivo(e)),r&&(r.value="",setTimeout(()=>r.focus&&r.focus(),250)),s&&(s.value="");const t=document.getElementById("ajusteStockPuntoReorden");t&&(t.value=e.puntoReorden!=null?e.puntoReorden:"");const a=document.getElementById("_ajusteCostoPonderadoWrap"),l=document.getElementById("ajusteStockCostoNuevo");a&&(a.style.display="none"),l&&(l.value="");const c=document.getElementById("ajustarStockModal");c&&(c.dataset.productId=String(i)),_inyectarCamposAjusteStock(c),_renderUltimosMovimientosProducto(i,c),_renderSugerenciaReorden(e,c);const d=document.getElementById("ajustarStockCantidad");d&&!d._costoPondListener&&(d._costoPondListener=!0,d.addEventListener("input",function(){const u=document.getElementById("_ajusteCostoPonderadoWrap"),p=document.getElementById("ajusteStockCostoNuevo");u&&(u.style.display=parseInt(this.value)>0?"":"none"),p&&parseInt(this.value)<=0&&(p.value="")})),typeof openModal=="function"&&openModal("ajustarStockModal")}window.ajustarStock=ajustarStock;function _inyectarCamposAjusteStock(i){if(!i||i.querySelector("#ajusteStockMotivoSelect"))return;const e=i.querySelector(".space-y-3");if(!e)return;const o=e.querySelector("#ajusteStockPuntoReorden")?.parentElement,n=document.createElement("div");n.id="_ajusteStockExtraFields",n.innerHTML=`
        ...
        ${r.map(t=>{const a=new Date(t.fecha).toLocaleString("es-MX",{dateStyle:"short",timeStyle:"short"}),l=t.cantidad>=0?`+${t.cantidad}`:`${t.cantidad}`;return`<div style="display:flex;align-items:center;gap:8px;padding:5px 0;border-bottom:1px solid #f9fafb;font-size:.75rem;">
...
Esta acci\xF3n no se puede deshacer.`,showConfirm(s,"\u{1F5D1}\uFE0F Eliminar producto permanentemente").then(async t=>{if(!t)return;window.MKS&&MKS.del();const a=JSON.parse(JSON.stringify(e)),l=window.products.findIndex(c=>String(c.id)===String(i));typeof window.mkPushUndo=="function"&&(window.mkPushUndo(`Eliminar "${e.name}"`,()=>{window.products.some(c=>String(c.id)===String(a.id))||(window.products.splice(l,0,a),typeof saveProducts=="function"&&saveProducts(),typeof renderInventoryTable=="function"&&renderInventoryTable(),typeof window._rebuildProductMap=="function"&&window._rebuildProductMap())}),typeof window.mkMostrarUndoHint=="function"&&window.mkMostrarUndoHint(`Eliminar "${e.name}"`)),window.products=window.products.filter(c=>String(c.id)!==String(i));try{products=window.products}catch{}saveProducts(),renderInventoryTable(),typeof updateDashboard=="function"&&updateDashboard();try{await db.from("products").delete().eq("id",String(i))}catch(c){console.warn("deleteProduct: no se pudo borrar de products:",c)}manekiToastExport(`\u{1F5D1}\uFE0F "${e.name}" eliminado`,"ok")})}window.deleteProduct=deleteProduct;function calcularDisponibilidadDesdeMP(i,e,o){if(!i.mpComponentes||i.mpComponentes.length===0)return null;const n=e||window.productMap,r=n?c=>n.get(String(c)):c=>(window.products||[]).find(d=>String(d.id)===String(c)),s=o?c=>o.get(String(c.id))??(typeof getStockEfectivo=="function"?getStockEfectivo(c):parseInt(c.stock)||0):c=>typeof getStockEfectivo=="function"?getStockEfectivo(c):parseInt(c.stock)||0;if(!i.mpComponentes.some(c=>{const d=r(c.id);return!d||d.tipo!=="servicio"}))return null;let a=1/0;const l=[];for(const c of i.mpComponentes){const d=r(c.id);if(d&&d.tipo==="servicio")continue;if(!d){i._tieneComponentesHuerfanos=!0;continue}const u=s(d),p=c.qty||1,w=Math.floor(u/p);l.push({nombre:c.nombre||(d?d.name:"?"),stock:u,qty:p,posibles:w}),w<a&&(a=w)}return{piezas:a===1/0?0:a,detalle:l}}window.calcularDisponibilidadDesdeMP=calcularDisponibilidadDesdeMP;async function _mkEditLeadTime(i,e){const o=document.getElementById("_mkLeadTimeModal");o&&o.remove();const n=document.createElement("div");n.id="_mkLeadTimeModal",n.innerHTML=`
