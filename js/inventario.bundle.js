...
;
"use strict";typeof window.showSection>"u"&&(window.showSection=function(e){document.querySelectorAll('section[id$="-section"], section[id$="Section"]').forEach(o=>{o.classList.add("hidden"),o.style.display=""});const t=document.getElementById(e+"-section")||document.getElementById(e+"Section");t&&t.classList.remove("hidden")}),(function(){const e={rojo:"#ef4444",roja:"#ef4444",red:"#ef4444",azul:"#3b82f6",azules:"#3b82f6",blue:"#3b82f6","azul marino":"#1e3a8a",marino:"#1e3a8a",verde:"#22c55e",green:"#22c55e",amarillo:"#eab308",amarilla:"#eab308",yellow:"#eab308",dorado:"#d97706",gold:"#d97706",negro:"#1f2937",negra:"#1f2937",black:"#1f2937",blanco:"#f9fafb",blanca:"#f9fafb",white:"#f9fafb",rosa:"#ec4899",pink:"#ec4899","rosa mexicano":"#e91e8c",morado:"#a855f7",morada:"#a855f7",violeta:"#8b5cf6",lila:"#c084fc",lavanda:"#c4b5fd",purple:"#a855f7",naranja:"#f97316",orange:"#f97316",gris:"#9ca3af",grise:"#9ca3af",gray:"#9ca3af",grey:"#9ca3af",plateado:"#94a3b8",silver:"#94a3b8",caf\u00E9:"#92400e",cafe:"#92400e",marr\u00F3n:"#92400e",marron:"#92400e",brown:"#78350f",beige:"#e5c9a0",crema:"#fef3c7",turquesa:"#06b6d4",celeste:"#7dd3fc",cian:"#22d3ee",cyan:"#22d3ee",aqua:"#22d3ee",coral:"#f87171",salmon:"#fca5a5",salm\u00F3n:"#fca5a5",oliva:"#84cc16",olive:"#65a30d",magenta:"#e879f9",fucsia:"#e879f9",fuchsia:"#e879f9",vino:"#9f1239",burgundy:"#9f1239",guinda:"#9f1239",indigo:"#6366f1","azul cielo":"#7dd3fc","azul rey":"#2563eb","azul claro":"#93c5fd","verde militar":"#4d7c0f","verde lim\xF3n":"#a3e635","verde menta":"#6ee7b7","verde oliva":"#65a30d","rojo vino":"#9f1239"},t={rojo:"\u{1F534}",roja:"\u{1F534}",red:"\u{1F534}",azul:"\u{1F535}",blue:"\u{1F535}","azul marino":"\u{1F535}",marino:"\u{1F535}",verde:"\u{1F7E2}",green:"\u{1F7E2}",amarillo:"\u{1F7E1}",amarilla:"\u{1F7E1}",yellow:"\u{1F7E1}",dorado:"\u{1F7E1}",gold:"\u{1F7E1}",negro:"\u26AB",negra:"\u26AB",black:"\u26AB",blanco:"\u26AA",blanca:"\u26AA",white:"\u26AA",rosa:"\u{1FA77}",pink:"\u{1FA77}","rosa mexicano":"\u{1FA77}",morado:"\u{1F7E3}",morada:"\u{1F7E3}",violeta:"\u{1F7E3}",lila:"\u{1F7E3}",purple:"\u{1F7E3}",naranja:"\u{1F7E0}",orange:"\u{1F7E0}",caf\u00E9:"\u{1F7E4}",cafe:"\u{1F7E4}",marr\u00F3n:"\u{1F7E4}",marron:"\u{1F7E4}",brown:"\u{1F7E4}",beige:"\u{1F7E4}",crema:"\u{1F7E1}",gris:"\u{1FA76}",plateado:"\u{1FA76}",silver:"\u{1FA76}",gray:"\u{1FA76}",grey:"\u{1FA76}",turquesa:"\u{1F535}",celeste:"\u{1F535}",cian:"\u{1F535}",cyan:"\u{1F535}",coral:"\u{1F534}",salmon:"\u{1FA77}",salm\u00F3n:"\u{1FA77}",vino:"\u{1F534}",burgundy:"\u{1F534}",guinda:"\u{1F534}",magenta:"\u{1F7E3}",fucsia:"\u{1F7E3}",fuchsia:"\u{1F7E3}",indigo:"\u{1F7E3}"},o=i=>/color|colour|color\s*\/\s*tono/i.test(i||"");window._mkColorDot=function(i,n){const r=typeof _esc=="function"?_esc:(p=>String(p||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"));if(!o(i))return`<span style="font-weight:600;">${r(n)}</span>`;const a=(n||"").toLowerCase().trim(),d=e[a],s=a==="blanco"||a==="blanca"||a==="white"||a==="crema"?"#d1d5db":"transparent";return d?`<span style="display:inline-flex;align-items:center;gap:5px;font-weight:600;">
            <span style="display:inline-block;width:14px;height:14px;border-radius:50%;background:${d};border:1.5px solid ${s};flex-shrink:0;"></span>${r(n)}</span>`:`<span style="display:inline-flex;align-items:center;gap:5px;font-weight:600;">
            <span style="display:inline-block;width:14px;height:14px;border-radius:50%;background:${n.startsWith("#")||/^(rgb|hsl)/.test(n)?n:"#d1d5db"};border:1.5px solid #e5e7eb;flex-shrink:0;"></span>${r(n)}</span>`},window._mkColorEmoji=function(i,n){if(!o(i))return n;const r=(n||"").toLowerCase().trim(),a=t[r];return a?`${a} ${n}`:n}})(),window._normSearch=function(t){return String(t||"").toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"")},window._money=function(e){return Math.round((parseFloat(e)||0)*100)/100},window._sumLineas=function(e,t,o){return t=t||"price",o=o||"quantity",e.reduce((i,n)=>{const r=Math.round((parseFloat(n[t])||0)*100)*(parseInt(n[o])||1);return i+r},0)/100},window._ajustarStockId=window._ajustarStockId??null,window.currentVariants=window.currentVariants??[],window.currentProductImage=window.currentProductImage??null,window.currentProductImageFile=window.currentProductImageFile??null,window.modoEdicion=window.modoEdicion??!1,window.edicionProductoId=window.edicionProductoId??null,window._invSortCol=window._invSortCol??null,window._invSortDir=window._invSortDir??"asc",window._invCurrentPage=window._invCurrentPage??1,window._invPageSize=window._invPageSize??10,window.stockMovements=window.stockMovements??window.stockMovimientos??[],window._kitComponentes=window._kitComponentes??[];function saveStockMovements(){window.stockMovimientos=window.stockMovements,sbSave("stockMovimientos",window.stockMovements)}function registrarMovimiento({productoId:e,productoNombre:t,tipo:o,cantidad:i,motivo:n,stockAntes:r,stockDespues:a}){window.stockMovements.unshift({id:mkId(),fecha:(typeof _fechaHoy=="function"?_fechaHoy():new Date().toISOString().split("T")[0])+"T"+new Date().toLocaleTimeString("es-MX"),productoId:e,productoNombre:t,tipo:o,cantidad:i,motivo:n||"",stockAntes:r,stockDespues:a}),window.stockMovements.length>500&&(window.stockMovements.splice(500),window.stockMovimientos=window.stockMovements),saveStockMovements()}window.registrarMovimiento=registrarMovimiento,typeof _esc>"u"&&(window._esc=function(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")});function _genId(){return"p"+mkId().replace(/-/g,"")}function getStockEfectivo(e){if(e.variants&&e.variants.length>0)return e.variants.reduce((t,o)=>t+(parseInt(o.qty)||0),0);if(e.mpComponentes&&e.mpComponentes.length>0){if(e.mpComponentes.every(r=>{const a=(window.products||[]).find(d=>String(d.id)===String(r.id));return a&&a.tipo==="servicio"}))return parseInt(e.stock)||0;let o=1/0;return e.mpComponentes.forEach(r=>{const a=(window.products||[]).find(d=>String(d.id)===String(r.id));if(a&&a.tipo!=="servicio"){const d=a.stock||0,s=parseFloat(r.qty)||1,p=Math.floor(d/s);p<o&&(o=p)}}),(parseInt(e.stock)||0)+(o===1/0?0:o)}return parseInt(e.stock)||0}window.getStockEfectivo=getStockEfectivo;function mostrarListaCompras(e){e||(window._listaComprasChecked={});const t=["confirmado","pago","produccion","envio","salida","retirar"],o=(window.pedidos||[]).filter(a=>t.includes(a.status)&&!a.inventarioDescontado),i={};o.forEach(a=>{(a.productosInventario||[]).forEach(d=>{const s=(d.id||d.name)+"|"+(d.variante||d.variant||"");(d.id||d.name)&&(i[s]||(i[s]={id:d.id,nombre:d.name||d.nombre,variante:d.variante||d.variant||"",necesario:0,pedidosRef:[]}),i[s].necesario+=d.quantity||d.cantidad||1,i[s].pedidosRef.push(a.folio||a.id))})});const n=Object.values(i).map(a=>{const d=(window.products||[]).find(c=>String(c.id)===String(a.id));let s=0;if(d)if(a.variante){const c=(d.variants||[]).find(l=>l.value===a.variante||`${l.type}: ${l.value}`===a.variante);s=c?c.qty||0:getStockEfectivo(d)}else s=typeof getStockEfectivo=="function"?getStockEfectivo(d):d.stock||0;const p=Math.max(0,a.necesario-s);return{...a,disponible:s,faltan:p}}).sort((a,d)=>d.faltan-a.faltan);n.forEach(a=>{const d=(window.products||[]).find(s=>String(s.id)===String(a.id));a.costoUnit=d&&parseFloat(d.cost)||0,a.costoTotal=a.faltan*a.costoUnit});const r=document.getElementById("listaComprasContent");if(r){if(n.length===0)r.innerHTML='<p style="color:#9ca3af;text-align:center;padding:32px 0;font-size:.875rem;">No hay pedidos activos con materiales asignados.</p>';else{const a=n.filter(c=>c.faltan>0),d=n.filter(c=>c.faltan===0);let s="";if(a.length>0){const c=a.reduce((l,f)=>l+f.costoTotal,0);s+=`<p style="font-size:.7rem;font-weight:800;color:#b45309;text-transform:uppercase;letter-spacing:.08em;margin-bottom:8px;">\u26A0\uFE0F Necesitas comprar (${a.length})</p>`,s+=`<table style="width:100%;border-collapse:collapse;font-size:.78rem;margin-bottom:4px;">
                <thead><tr style="background:#fef9c3;color:#92400e;font-size:.68rem;">
                ...
                </tr></thead><tbody>`,a.forEach(l=>{const f=(l.id||l.nombre)+"|"+(l.variante||""),u=!!window._listaComprasChecked[f],w=u?"background:#f0fdf4;text-decoration:line-through;color:#6b7280;":"background:#fef3c7;",v=f.replace(/\\/g,"\\\\").replace(/'/g,"\\'"),g=(window.products||[]).find(b=>String(b.id)===String(l.id)),m=g&&g.proveedorUrl?g.proveedorUrl.trim():"",y=m?`<a href="${_esc(m)}" target="_blank" rel="noopener noreferrer" style="display:inline-block;margin-top:3px;font-size:.65rem;padding:2px 6px;border-radius:999px;background:#dbeafe;color:#1d4ed8;text-decoration:none;font-weight:700;">\u{1F6D2} Comprar</a>`:"";s+=`<tr style="${w}border-bottom:1px solid #fde68a;">
                    ...
                    <td style="text-align:center;padding:8px 6px;">
                        ${u?'<span style="color:#16a34a;font-size:.75rem;font-weight:700;">\u2713 Comprado</span>':`<input type="checkbox" onchange="window._lcToggleComprado('${v}')" style="width:16px;height:16px;cursor:pointer;">`}
                    </td>
                </tr>`}),s+=`</tbody><tfoot><tr style="background:#fef9c3;font-weight:800;color:#b45309;">
                ...
                <td></td>
            </tr></tfoot></table>`}d.length>0&&(s+=`<p style="font-size:.7rem;font-weight:800;color:#16a34a;text-transform:uppercase;letter-spacing:.08em;margin:16px 0 8px;">\u2705 Stock suficiente (${d.length})</p>`,s+=d.map(c=>`
                ...
                </div>`).join("")),a.length===0&&(s='<p style="color:#16a34a;text-align:center;padding:12px 0;font-size:.9rem;font-weight:700;">\u2705 Tienes stock suficiente para todos los pedidos activos.</p>'+s),a.length>0&&(s+=`<div style="display:flex;gap:8px;margin-top:14px;flex-wrap:wrap;">
                ...
                <div style="display:flex;flex-direction:column;gap:6px;">`;p.forEach(({prod:l,producibles:f})=>{const u=f>=5?"#16a34a":f>=1?"#d97706":"#dc2626",w=f>=5?"#d1fae5":f>=1?"#fef3c7":"#fee2e2";c+=`<div style="display:flex;justify-content:space-between;align-items:center;padding:6px 10px;background:#fff;border-radius:8px;border:1px solid #e5e7eb;">
                    <span style="font-size:.8rem;font-weight:600;color:#374151;">${_esc(l.name)}</span>
                    <span style="padding:2px 10px;border-radius:99px;font-size:.75rem;font-weight:700;background:${w};color:${u};">${f} uds</span>
                </div>`}),c+="</div></div>",s+=c}r.innerHTML=s}window._lcToggleComprado=function(a){window._listaComprasChecked||(window._listaComprasChecked={}),window._listaComprasChecked[a]=!0,mostrarListaCompras(!0)},window._lcWhatsApp=function(){const a=n.filter(l=>l.faltan>0);if(!a.length)return;const d=_fechaHoy(),s=a.reduce((l,f)=>l+f.costoTotal,0);let p=`\u{1F4E6} Lista de compras Maneki Store
Fecha: ${d}

`;a.forEach(l=>{const f=l.nombre+(l.variante?` (${l.variante})`:"");l.costoUnit>0?p+=`\u2022 ${f}: ${l.faltan} uds ($${l.costoUnit.toFixed(2)} c/u = $${l.costoTotal.toFixed(2)})
`:p+=`\u2022 ${f}: ${l.faltan} uds
`}),s>0&&(p+=`
\u{1F4B0} Total estimado: $${s.toFixed(2)}`);const c="https://api.whatsapp.com/send?text="+encodeURIComponent(p);window.open(c,"_blank")},window._lcExportCSV=function(){const a=n.filter(u=>u.faltan>0),d=["Producto","Variante","Cantidad requerida","Stock actual","Faltante","Costo unitario","Costo total"],s=a.map(u=>[u.nombre,u.variante||"",u.necesario,u.disponible,u.faltan,u.costoUnit.toFixed(2),u.costoTotal.toFixed(2)]);let p=d.join(",")+`
`;s.forEach(u=>{p+=u.map(w=>`"${String(w).replace(/"/g,'""')}"`).join(",")+`
`});const c=new Blob([p],{type:"text/csv;charset=utf-8;"}),l=URL.createObjectURL(c),f=document.createElement("a");f.href=l,f.download=`lista-compras-${_fechaHoy()}.csv`,f.click(),URL.revokeObjectURL(l)},openModal("listaComprasModal")}}window.mostrarListaCompras=mostrarListaCompras;function syncStockFromVariants(e){e.variants&&e.variants.length>0&&(e.stock=e.variants.reduce((t,o)=>t+(parseInt(o.qty)||0),0))}function setupImageUpload(){["productImage","mpProductImage"].forEach(e=>{const t=document.getElementById(e);!t||t._mkBound||(t._mkBound=!0,t.addEventListener("change",function(o){const i=o.target.files[0];if(!i)return;window.currentProductImageFile=i;const n=new FileReader,r=e==="mpProductImage";n.onload=a=>{const d=document.getElementById(r?"mpPreviewImg":"previewImg"),s=document.getElementById(r?"mpImagePreview":"imagePreview");d&&(d.src=a.target.result),s&&s.classList.remove("hidden")},n.readAsDataURL(i)}))})}window.setupImageUpload=setupImageUpload;function sortInventory(e){window._invSortDir=window._invSortCol===e&&window._invSortDir==="asc"?"desc":"asc",window._invSortCol=e,window._invCurrentPage=1,document.querySelectorAll(".sortable-th").forEach(t=>{t.classList.remove("asc","desc"),t.getAttribute("onclick")===`sortInventory('${e}')`&&t.classList.add(window._invSortDir)}),renderInventoryTable()}window.sortInventory=sortInventory;let _lastTelegramAlert=window._lastTelegramStockAlert||0;function _pedidosQueUsanMP(e){const t=["confirmado","pago","produccion","envio","salida","retirar","pendiente"];return(window.pedidos||[]).filter(o=>t.includes(o.status||"")?(o.productosInventario||[]).some(i=>{const n=(window.products||[]).find(r=>String(r.id)===String(i.id));return n?(n.mpComponentes||[]).some(r=>String(r.id)===String(e)):!1}):!1)}window._pedidosQueUsanMP=_pedidosQueUsanMP;function checkStockAlerts(){const e=window.products||[],t=e.filter(s=>getStockEfectivo(s)===0),o=e.filter(s=>{const p=getStockEfectivo(s);return p>0&&p<=(s.puntoReorden??s.stockMin??5)}),i=o.filter(s=>s.tipo==="materia_prima"),n=t.filter(s=>s.tipo==="materia_prima");[...n,...i].forEach(s=>{const p=_pedidosQueUsanMP(s.id);if(p.length>0){const c=p.map(l=>l.folio||l.id).slice(0,5).join(", ");manekiToastExport(`\u{1F6A8} URGENTE: "${s.name}" con stock cr\xEDtico \u2014 afecta pedidos: ${c}`,"err")}}),t.length&&manekiToastExport(`\u{1F534} ${t.length} producto(s) agotado(s)`,"warn"),o.length&&manekiToastExport(`\u26A0\uFE0F ${o.length} producto(s) con stock bajo`,"warn"),n.length?manekiToastExport(`\u{1F3ED} ${n.length} materia(s) prima(s) AGOTADAS \u2014 producci\xF3n bloqueada`,"err"):i.length&&manekiToastExport(`\u{1F3ED} ${i.length} materia(s) prima(s) con stock bajo`,"warn");const a=document.getElementById("sidebarBadgeMP");if(a){const s=i.length+n.length;s>0?(a.textContent=s,a.style.display="inline-block"):a.style.display="none"}(t.length>0||o.length>0)&&_notificarStockTelegram({agotados:t,bajos:o,mpAgotadas:n,mpBajas:i}),(n.length||i.length)&&_alertaStockWA(n,i)}window.checkStockAlerts=checkStockAlerts;async function _notificarStockTelegram({agotados:e,bajos:t,mpAgotadas:o,mpBajas:i}){const n=Date.now();if(n-_lastTelegramAlert<3600*1e3)return;window._lastTelegramStockAlert=n,_lastTelegramAlert=n;const r=window.storeConfig||{},a=r.telegramBotToken;if(!a){console.warn("Telegram: telegramBotToken no configurado, omitiendo notificaci\xF3n de stock.");return}const d=[r.telegramChatId1,r.telegramChatId2].filter(Boolean);if(!d.length)return;const s=[];e.length&&(s.push(`\u{1F534} *Agotados (${e.length}):*`),e.slice(0,10).forEach(c=>s.push(`  \u2022 ${c.name} \u2014 stock: 0`))),t.length&&(s.push(`\u26A0\uFE0F *Stock bajo (${t.length}):*`),t.slice(0,10).forEach(c=>s.push(`  \u2022 ${c.name} \u2014 stock: ${c.stock} (m\xEDn: ${c.stockMin||5})`))),o.length&&s.push(`\u{1F3ED} *MP AGOTADAS \u2014 producci\xF3n bloqueada:* ${o.map(c=>c.name).join(", ")}`);const p=`\u{1F4E6} *Alerta de inventario \u2014 Maneki Store*

${s.join(`
`)}`;for(const c of d)try{await fetch(`https://api.telegram.org/bot${a}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:c,text:p,parse_mode:"Markdown"})})}catch(l){console.warn("Telegram stock alert error:",l)}}window._notificarStockTelegram=_notificarStockTelegram;function _alertaStockWA(e,t){const o=document.getElementById("_mkStockWAAlert");o&&o.remove();const i=[];e.length&&i.push(`\u{1F534} Agotadas: ${e.map(a=>a.name).join(", ")}`),t.length&&i.push(`\u26A0\uFE0F Stock bajo: ${t.map(a=>a.name).join(", ")}`);const n=encodeURIComponent(`\u{1F3ED} *Maneki \u2014 Alerta de Inventario*
...
_Reabastece pronto para no detener producci\xF3n._`),r=document.createElement("div");r.id="_mkStockWAAlert",r.style.cssText="position:fixed;bottom:20px;right:20px;z-index:9999;background:#fff;border:2px solid #25D366;border-radius:14px;padding:14px 18px;box-shadow:0 4px 24px rgba(0,0,0,0.15);max-width:300px;font-size:13px;line-height:1.4;",r.innerHTML=`
        ...
        <div style="color:#6b7280;margin-bottom:10px;">${i.map(a=>_esc(a)).join("<br>")}</div>
        ...
        </button>`,document.body.appendChild(r)}window._alertaStockWA=_alertaStockWA;function exportarInventarioCSV(){const e=["SKU","Nombre","Categor\xEDa","Tipo","Costo","Precio","Stock","Stock M\xEDn","Margen%","Producibles","Proveedor","Proveedor URL","Estado","Tags","Variantes","\xDAltima actualizaci\xF3n"],t=(window.products||[]).map(a=>{const d=((window.categories||[]).find(u=>u.id===a.category)||{}).name||a.category,s=a.cost&&a.price?((a.price-a.cost)/a.price*100).toFixed(0)+"%":"",p=typeof getStockEfectivo=="function"?getStockEfectivo(a):a.stock||0,c=p===0?"Agotado":p<=(a.stockMin||5)?"Bajo Stock":"Disponible",l=typeof calcularProducibles=="function"?calcularProducibles(a)??"":"",f=a.updatedAt?new Date(a.updatedAt).toLocaleString("es-MX"):"";return[a.sku,a.name,d,a.tipo||"producto",a.cost||0,a.price||0,p,a.stockMin||5,s,l,a.proveedor||"",a.proveedorUrl||"",c,(a.tags||[]).join("; "),(a.variants||[]).map(u=>`${u.type}:${u.value}(${u.qty??0})`).join("; "),f].map(u=>`"${String(u).replace(/"/g,'""')}"`).join(",")}),o=[e.join(","),...t].join(`
`),i=new Blob(["\uFEFF"+o],{type:"text/csv;charset=utf-8;"}),n=URL.createObjectURL(i),r=document.createElement("a");r.href=n,r.download=`inventario_${typeof _fechaHoy=="function"?_fechaHoy():new Date().toISOString().slice(0,10)}.csv`,r.click(),URL.revokeObjectURL(n),manekiToastExport("\u{1F4E5} Inventario exportado como CSV","ok")}window.exportarInventarioCSV=exportarInventarioCSV;function editarStockInline(e){const t=(window.products||[]).find(n=>String(n.id)===String(e));if(!t)return;const o=document.getElementById(`stock-cell-${e}`);if(!o)return;o.innerHTML=`
        <div style="display:flex;align-items:center;gap:4px;">
            <input id="inline-stock-${e}" type="number" min="0" value="${typeof getStockEfectivo=="function"?getStockEfectivo(t):t.stock||0}"
                style="width:60px;padding:2px 6px;border:1px solid #6366f1;border-radius:6px;font-size:13px;text-align:center;"
                onkeydown="if(event.key==='Enter')confirmarStockInline('${e}');if(event.key==='Escape')renderInventoryTable();">
            <button onclick="confirmarStockInline('${e}')"
        ...
        </div>`;const i=document.getElementById(`inline-stock-${e}`);i&&i.focus()}window.editarStockInline=editarStockInline;function confirmarStockInline(e){const t=(window.products||[]).find(r=>String(r.id)===String(e));if(!t)return;const o=document.getElementById(`inline-stock-${e}`);if(!o)return;const i=parseInt(o.value);if(isNaN(i)||i<0){manekiToastExport("Stock inv\xE1lido","err");return}const n=typeof getStockEfectivo=="function"?getStockEfectivo(t):t.stock||0;if(t.stock=i,Array.isArray(t.variants)&&t.variants.length>0){const r=i-n;r!==0&&t.variants[0]&&(t.variants[0].qty=Math.max(0,(parseInt(t.variants[0].qty)||0)+r)),typeof syncStockFromVariants=="function"&&syncStockFromVariants(t)}registrarMovimiento({productoId:t.id,productoNombre:t.name,tipo:"ajuste",cantidad:i-n,motivo:"Edici\xF3n inline",stockAntes:n,stockDespues:i}),saveProducts(),renderInventoryTable(),typeof updateDashboard=="function"&&updateDashboard(),manekiToastExport(`\u2705 Stock de "${t.name}" \u2192 ${i}`,"ok")}window.confirmarStockInline=confirmarStockInline;function poblarFiltroProveedores(){const e=document.getElementById("inventoryProveedorFilter");if(!e)return;const t=e.value,o=[...new Set((window.products||[]).map(i=>(i.proveedor||"").trim()).filter(Boolean))].sort((i,n)=>i.localeCompare(n,"es"));e.innerHTML='<option value="">\u{1F3EA} Todos los proveedores</option>'+o.map(i=>`<option value="${_esc(i)}"${t===i?"selected":""}>${_esc(i)}</option>`).join("")}window.poblarFiltroProveedores=poblarFiltroProveedores;function invInlineEditStock(e,t){const o=(window.products||[]).find(a=>String(a.id)===String(e));if(!o)return;const i=parseFloat(o.stock)||0,n=document.createElement("input");n.type="number",n.min="0",n.step="0.01",n.value=i,n.style.cssText="width:60px;padding:2px 6px;border:1.5px solid #7c3aed;border-radius:6px;font-size:.85rem;text-align:center;";const r=async()=>{const a=parseFloat(n.value);if(!isNaN(a)&&a!==i){const d=i;o.stock=a,registrarMovimiento({productoId:o.id,productoNombre:o.name,tipo:"ajuste",cantidad:a-d,motivo:"Edici\xF3n inline",stockAntes:d,stockDespues:a}),saveProducts(),manekiToastExport(`Stock actualizado: ${o.name} \u2192 ${a}`,"ok")}renderInventoryTable()};n.addEventListener("blur",r),n.addEventListener("keydown",a=>{a.key==="Enter"&&n.blur(),a.key==="Escape"&&(n.value=i,n.blur())}),t.innerHTML="",t.appendChild(n),n.focus(),n.select()}window.invInlineEditStock=invInlineEditStock;function invInlineEditPrice(e,t){const o=(window.products||[]).find(a=>String(a.id)===String(e));if(!o)return;const i=parseFloat(o.price)||0,n=document.createElement("input");n.type="number",n.min="0",n.step="0.01",n.value=i.toFixed(2),n.style.cssText="width:80px;padding:2px 6px;border:1.5px solid #C5A572;border-radius:6px;font-size:.85rem;text-align:center;font-weight:700;";const r=()=>{const a=parseFloat(n.value);!isNaN(a)&&a>=0&&a!==i&&(o.historialPrecios||(o.historialPrecios=[]),o.historialPrecios.push({precio:i,fecha:typeof _fechaHoy=="function"?_fechaHoy():new Date().toISOString().split("T")[0]}),o.price=a,typeof saveProducts=="function"&&saveProducts(),typeof manekiToastExport=="function"&&manekiToastExport(`Precio actualizado: ${o.name} \u2192 $${a.toFixed(2)}`,"ok")),typeof renderInventoryTable=="function"&&renderInventoryTable()};n.addEventListener("blur",r),n.addEventListener("keydown",a=>{a.key==="Enter"&&n.blur(),a.key==="Escape"&&(n.value=i.toFixed(2),n.blur())}),t.innerHTML="",t.appendChild(n),n.focus(),n.select()}window.invInlineEditPrice=invInlineEditPrice;async function registrarMerma(e){const t=(window.products||[]).find(d=>String(d.id)===String(e));if(!t){manekiToastExport("Producto no encontrado","err");return}const o=await new Promise(d=>{const s=document.getElementById("mkMermaModal");s&&s.remove();const p=document.createElement("div");p.id="mkMermaModal",p.className="mk-modal-overlay",p.innerHTML=`<div class="mk-modal-box" style="max-width:380px">
            <h3 style="font-size:1rem;font-weight:700;margin-bottom:14px;">\u{1F4C9} Registrar Merma</h3>
            <label style="font-size:.8rem;color:#6b7280;">Cantidad (${t.unidad||"pza"})</label>
        ...
        </div>`,window._mkMermaResolve=c=>{p.remove(),d(c)},document.body.appendChild(p),setTimeout(()=>document.getElementById("mkMermaCant")?.focus(),50)});if(!o||!o.cantidad||parseFloat(o.cantidad)<=0)return;const i=parseInt(o.cantidad,10)||Math.round(parseFloat(o.cantidad));if(!i||i<=0){manekiToastExport("\u26A0\uFE0F Cantidad inv\xE1lida","warn");return}const n=o.motivo||"Sin especificar",r=getStockEfectivo(t),a=Math.max(0,r-i);if(t.stock=a,Array.isArray(t.variants)&&t.variants.length){let d=i;for(const s of t.variants){if(d<=0)break;const p=parseInt(s.qty)||0,c=Math.min(p,d);s.qty=p-c,d-=c}typeof syncStockFromVariants=="function"&&syncStockFromVariants(t)}registrarMovimiento({productoId:t.id,productoNombre:t.name,tipo:"merma",cantidad:-i,motivo:n||"Sin especificar",stockAntes:r,stockDespues:a}),saveProducts(),renderInventoryTable(),typeof updateDashboard=="function"&&updateDashboard(),manekiToastExport(`\u{1F4C9} Merma: -${i} ${t.unidad||"pza"} de "${t.name}"`,"warn")}window.registrarMerma=registrarMerma;function addVariant(){const e=document.getElementById("variantType"),t=document.getElementById("variantValue"),o=e?e.value.trim():"",i=t?t.value.trim():"";if(!o||!i){typeof manekiToastExport=="function"&&manekiToastExport("Por favor completa tipo y valor de la variante","warn");return}if((window.currentVariants||[]).some(r=>r.type===o&&r.value===i)){typeof manekiToastExport=="function"&&manekiToastExport(`\u26A0\uFE0F La variante ${o}: ${i} ya existe`,"warn");return}window.currentVariants.push({type:o,value:i,qty:0}),renderVariantsList(),e&&(e.value=""),t&&(t.value=""),e&&e.focus()}window.addVariant=addVariant;function updateVariantQty(e,t){const o=parseInt(t);!isNaN(o)&&o>=0&&(window.currentVariants[e].qty=o)}window.updateVariantQty=updateVariantQty;function renderVariantsList(){const e=document.getElementById("variantsList");if(e){if(!window.currentVariants||window.currentVariants.length===0){e.innerHTML='<span class="text-xs text-gray-400 italic">Sin variantes agregadas</span>';return}e.innerHTML=window.currentVariants.map((t,o)=>`
        <div style="display:flex;align-items:center;gap:8px;padding:8px 10px;background:#f8fafc;border:1px solid #e2e8f0;border-radius:10px;margin-bottom:6px;">
            <div style="flex:1;min-width:0;">
                <span style="font-size:12px;color:#374151;">${_esc(t.type)}: ${_mkColorDot(t.type,_esc(t.value))}</span>
            </div>
            <div style="display:flex;align-items:center;gap:6px;flex-shrink:0;">
                <label style="font-size:11px;color:#6b7280;font-weight:600;white-space:nowrap;">Piezas:</label>
                <div style="display:flex;align-items:center;gap:2px;">
                    <button type="button" onclick="(function(){var n=parseInt(document.getElementById('vqty-${o}').value)||0;if(n>0){document.getElementById('vqty-${o}').value=n-1;updateVariantQty(${o},n-1);}})()"
                    ...
                    <input id="vqty-${o}" type="number" min="0" value="${t.qty??0}"
                        oninput="updateVariantQty(${o}, this.value)"
                    ...
                    <button type="button" onclick="(function(){var n=parseInt(document.getElementById('vqty-${o}').value)||0;document.getElementById('vqty-${o}').value=n+1;updateVariantQty(${o},n+1);})()"
                        style="width:22px;height:22px;border:1px solid #d1d5db;border-radius:5px;background:#fff;cursor:pointer;font-size:13px;font-weight:bold;color:#6b7280;display:flex;align-items:center;justify-content:center;padding:0;">+</button>
                </div>
                <span style="font-size:11px;color:#9ca3af;">pzs</span>
            </div>
            <button type="button" onclick="removeVariant(${o})"
        ...
        </div>`).join("")}}window.renderVariantsList=renderVariantsList;function removeVariant(e){window.currentVariants.splice(e,1),renderVariantsList()}window.removeVariant=removeVariant;function descontarStockVariante(e,t,o,i){const n=(window.products||[]).find(a=>String(a.id)===String(e));if(!n||!n.variants)return;const r=n.variants.find(a=>a.type===t&&a.value===o);r&&(r.qty=Math.max(0,(r.qty||0)-i)),syncStockFromVariants(n),saveProducts()}window.descontarStockVariante=descontarStockVariante;function generateSKU(e){const o={tazas:"TAZ",llaveros:"LLV",libretas:"LIB",peluches:"PEL",otros:"OTR"}[e]||"PRD",i=(window.products||[]).filter(r=>r.category===e&&r.sku&&r.sku.startsWith(`MNK-${o}-`)).map(r=>parseInt((r.sku||"").split("-").pop())||0),n=(i.length?Math.max(...i):0)+1;return`MNK-${o}-${String(n).padStart(3,"0")}`}window.generateSKU=generateSKU;function skuEsUnico(e,t){const o=e.toLowerCase();return!(window.products||[]).some(i=>{if(!i.sku||i.sku.toLowerCase()!==o||t&&String(i.id)===String(t))return!1;if(t){const n=(window.products||[]).find(r=>String(r.id)===String(t));if(n&&n.sku&&n.sku.toLowerCase()===o)return!1}return!0})}window._ptGaleriaUrls=window._ptGaleriaUrls??[],window._ptGaleriaFiles=window._ptGaleriaFiles??[];function ptRenderGaleria(){const e=document.getElementById("ptGaleriaPreview"),t=document.getElementById("ptGaleriaVacia");if(!e)return;const o=window._ptGaleriaUrls||[],i=window._ptGaleriaFiles||[],n=o.length+i.length;t&&(t.style.display=n?"none":"block"),[...e.children].forEach(r=>{r.id!=="ptGaleriaVacia"&&r.remove()}),o.forEach((r,a)=>{const d=document.createElement("div");d.style="position:relative;width:120px;height:120px;",d.innerHTML=`<img src="${r}" style="width:120px;height:120px;object-fit:cover;border-radius:10px;border:2px solid #e5e7eb;">
            <button type="button" onclick="ptEliminarFotoGaleria('url',${a})"
                style="position:absolute;top:-6px;right:-6px;width:22px;height:22px;background:#ef4444;color:#fff;border:none;border-radius:50%;font-size:.75rem;cursor:pointer;line-height:1;display:flex;align-items:center;justify-content:center;">\u2715</button>`,e.appendChild(d)}),i.forEach((r,a)=>{const d=document.createElement("div");d.style="position:relative;width:120px;height:120px;",d.dataset.fileIdx=a;const s=document.createElement("img");s.style="width:120px;height:120px;object-fit:cover;border-radius:10px;border:2px solid #C5A572;opacity:.85;";const p=new FileReader;p.onload=l=>{s.src=l.target.result},p.readAsDataURL(r);const c=document.createElement("button");c.type="button",c.innerHTML="\u2715",c.style="position:absolute;top:-6px;right:-6px;width:20px;height:20px;background:#ef4444;color:#fff;border:none;border-radius:50%;font-size:.7rem;cursor:pointer;line-height:1;display:flex;align-items:center;justify-content:center;",c.onclick=()=>ptEliminarFotoGaleria("file",a),d.appendChild(s),d.appendChild(c),e.appendChild(d)})}window.ptRenderGaleria=ptRenderGaleria;function ptAgregarFotosGaleria(e){if(!e||!e.length)return;const t=20,o=(window._ptGaleriaUrls||[]).length+(window._ptGaleriaFiles||[]).length,i=t-o;if(i<=0){manekiToastExport(`Ya tienes ${t} fotos en la galer\xEDa`,"warn");return}const n=Array.from(e).slice(0,i);window._ptGaleriaFiles=[...window._ptGaleriaFiles||[],...n],ptRenderGaleria();const r=document.getElementById("ptGaleriaInput");r&&(r.value="")}window.ptAgregarFotosGaleria=ptAgregarFotosGaleria;function ptEliminarFotoGaleria(e,t){e==="url"?(window._ptGaleriaUrls||[]).splice(t,1):(window._ptGaleriaFiles||[]).splice(t,1),ptRenderGaleria()}window.ptEliminarFotoGaleria=ptEliminarFotoGaleria;function openAddProductModal(){injectPtModal(),window.modoEdicion=!1,window.edicionProductoId=null,window.currentVariants=[],window.currentProductImage=null,window.currentProductImageFile=null,window._ptMpComponentes=[],window._ptVariants=[],window._ptTagsActuales=[],window._tagsActuales=[],window._ptGaleriaUrls=[],window._ptGaleriaFiles=[];const e=document.getElementById("ptForm");e&&e.reset();const t=document.getElementById("ptImagePreview");t&&t.classList.add("hidden"),renderPtMpList(),renderVariantsListPt(),recalcularCostoPt(),ptRenderGaleria(),typeof updateCategorySelects=="function"&&updateCategorySelects();const o=document.querySelector("#ptModal h3");o&&(o.textContent="\u{1F4E6} Nuevo Producto Terminado");const i=document.getElementById("ptSubmitBtn");i&&(i.textContent="\u2705 Agregar Producto"),typeof openModal=="function"&&openModal("ptModal")}window.openAddProductModal=openAddProductModal;function closePtModal(){typeof closeModal=="function"&&closeModal("ptModal");const e=document.getElementById("ptForm");e&&e.reset(),window.modoEdicion=!1,window.edicionProductoId=null,window.currentVariants=[],window.currentProductImage=null,window.currentProductImageFile=null,window._ptMpComponentes=[],window._ptVariants=[],window._ptTagsActuales=[],window._tagsActuales=[],window._ptGaleriaUrls=[],window._ptGaleriaFiles=[]}window.closePtModal=closePtModal;function closeAddProductModal(){closePtModal()}window.closeAddProductModal=closeAddProductModal,window.openPtModal=openAddProductModal,window.openMpModal=function(){typeof window.injectMpModal=="function"&&window.injectMpModal(),typeof openModal=="function"&&openModal("mpModal")},window.openSvcModal=function(){typeof window.injectSvcModal=="function"&&window.injectSvcModal(),typeof openModal=="function"&&openModal("svcModal")};function parseCsvLine(e){const t=[];let o="",i=!1;for(let n=0;n<e.length;n++){const r=e[n];r==='"'?i&&e[n+1]==='"'?(o+='"',n++):i=!i:r===","&&!i?(t.push(o),o=""):o+=r}return t.push(o),t}window.parseCsvLine=parseCsvLine;async function importarInventarioCSV(e){const t=e.files[0];if(!t)return;const i=(await t.text()).split(`
`).map(s=>s.trim()).filter(Boolean);if(i.length<2){manekiToastExport("\u26A0\uFE0F CSV vac\xEDo o sin datos","warn");return}const n=i[0].replace(/^\uFEFF/,""),r=parseCsvLine(n).map(s=>s.toLowerCase().trim());let a=0,d=0;for(let s=1;s<i.length;s++){const p=parseCsvLine(i[s]),c={};if(r.forEach((y,b)=>{c[y]=(p[b]||"").trim()}),!c.nombre){d++;continue}const l=(c.tipo||"pt").toLowerCase(),f=parseFloat(c.costo)||0,u=parseFloat(c.precio)||0,w=parseFloat(c.stock)||0,v=parseInt(c.stock_min)||5;if((window.products||[]).find(y=>y.name.trim().toLowerCase()===c.nombre.toLowerCase())){d++;continue}const g=c.sku||"IMP-"+mkId().split("-")[0].toUpperCase(),m={id:mkId(),name:c.nombre,sku:g,cost:f,price:u,stock:w,stockMin:v,proveedor:c.proveedor||"",notas:c.notas||"",image:l==="mp"||l==="materia_prima"?"\u{1F3ED}":l==="svc"||l==="servicio"?"\u2699\uFE0F":"\u{1F4E6}",tags:[],historialPrecios:[],historialCostos:[],variants:[]};l==="mp"||l==="materia_prima"?m.tipo="materia_prima":l==="svc"||l==="servicio"?(m.tipo="servicio",m.stock=0):m.tipo=u>0?"producto":"producto_interno",window.products||(window.products=[]),window.products.push(m),a++}a>0?(saveProducts(),renderInventoryTable(),typeof updateDashboard=="function"&&updateDashboard(),manekiToastExport(`\u2705 Importados ${a} productos${d>0?` (${d} errores/duplicados omitidos)`:""}`,"ok")):manekiToastExport(`\u26A0\uFE0F No se import\xF3 ning\xFAn producto. ${d} errores/duplicados.`,"warn"),e.value=""}window.importarInventarioCSV=importarInventarioCSV;function descargarTemplateCSV(){const e="tipo,nombre,sku,categoria,costo,precio,stock,stock_min,proveedor,notas",t=["pt,Taza personalizada,,Tazas,45.00,150.00,10,3,Proveedor ABC,Taza blanca 11oz","mp,Vinil blanco mate,,Materiales,15.00,,50,10,Distribuidora XYZ,Hoja 60x30cm","svc,Impresi\xF3n directa,,Servicios,8.00,,0,0,,Por hoja impresa"].join(`
`),o=e+`
`+t,i=new Blob(["\uFEFF"+o],{type:"text/csv;charset=utf-8;"}),n=URL.createObjectURL(i),r=document.createElement("a");r.href=n,r.download="template_inventario_maneki.csv",r.click(),URL.revokeObjectURL(n)}window.descargarTemplateCSV=descargarTemplateCSV;async function guardarSnapshotInventario(){if(!window.products||window.products.length===0){manekiToastExport("No hay productos para guardar snapshot","warn");return}window.inventarioSnapshots||(window.inventarioSnapshots=[]);const e=_fechaHoy(),t=window.inventarioSnapshots.find(i=>i.fecha===e);if(t){if(!await showConfirm(`Ya hay un snapshot del ${e}. \xBFReemplazarlo?`))return;const i=window.inventarioSnapshots.indexOf(t);window.inventarioSnapshots.splice(i,1)}const o={fecha:e,hora:new Date().toLocaleTimeString("es-MX",{hour:"2-digit",minute:"2-digit"}),totalProductos:window.products.length,valorTotal:window.products.reduce((i,n)=>i+(parseFloat(n.cost)||0)*(parseFloat(n.stock)||0),0),items:window.products.map(i=>({id:i.id,name:i.name,tipo:i.tipo||"pt",stock:i.stock||0,cost:i.cost||0,price:i.price||0,sku:i.sku||""}))};if(window.inventarioSnapshots.unshift(o),window.inventarioSnapshots=window.inventarioSnapshots.slice(0,30),typeof sbSave=="function")sbSave("inventarioSnapshots",window.inventarioSnapshots);else try{localStorage.setItem("inventarioSnapshots",JSON.stringify(window.inventarioSnapshots))}catch{}manekiToastExport(`\u{1F4F8} Snapshot guardado: ${e} \u2014 ${o.totalProductos} productos, $${o.valorTotal.toFixed(2)} en inventario`,"ok")}window.guardarSnapshotInventario=guardarSnapshotInventario;function verSnapshotsInventario(){const e=window.inventarioSnapshots||[];if(!e.length){manekiToastExport("Sin snapshots guardados a\xFAn","warn");return}const t=e.map(i=>`
    <div style="padding:12px 16px;border-bottom:1px solid #f3f4f6;display:flex;justify-content:space-between;align-items:center;">
      <div>
        <div style="font-weight:700;color:#1a0533;">${i.fecha} <span style="color:#9ca3af;font-weight:400;font-size:.8rem;">${i.hora||""}</span></div>
        <div style="font-size:.8rem;color:#6b7280;">${i.totalProductos} productos \xB7 $${Number(i.valorTotal||0).toFixed(2)} en inventario</div>
      </div>
      <button onclick="exportarSnapshotCSV('${i.fecha}')" style="padding:4px 12px;border-radius:8px;border:1px solid #e5e7eb;background:#f9fafb;font-size:.75rem;cursor:pointer;">\u{1F4E5} CSV</button>
    </div>`).join("");let o=document.getElementById("_snapshotModal");o||(o=document.createElement("div"),o.id="_snapshotModal",o.className="modal",document.body.appendChild(o)),o.innerHTML=`
    <div style="background:#fff;border-radius:20px;max-width:500px;width:100%;margin:auto;max-height:80vh;overflow-y:auto;padding:24px;">
      ...
      ${t}
    </div>`,openModal("_snapshotModal")}window.verSnapshotsInventario=verSnapshotsInventario;function exportarSnapshotCSV(e){const t=(window.inventarioSnapshots||[]).find(s=>s.fecha===e);if(!t)return;const o="nombre,tipo,sku,stock,costo,precio",i=t.items.map(s=>[s.name,s.tipo,s.sku,s.stock,s.cost,s.price].map(p=>`"${String(p||"").replace(/"/g,'""')}"`).join(",")),n="\uFEFF"+o+`
`+i.join(`
`),r=new Blob([n],{type:"text/csv;charset=utf-8;"}),a=URL.createObjectURL(r),d=document.createElement("a");d.href=a,d.download=`snapshot_inventario_${e}.csv`,d.click(),URL.revokeObjectURL(a)}window.exportarSnapshotCSV=exportarSnapshotCSV;function abrirBulkEditPrecios(){const e=(window.products||[]).filter(n=>n.tipo!=="materia_prima"&&n.tipo!=="servicio"&&Number(n.price||0)>0);if(e.length===0){manekiToastExport("No hay productos con precio para editar","warn");return}let t=document.getElementById("_bulkEditModal");t||(t=document.createElement("div"),t.id="_bulkEditModal",t.style.cssText="position:fixed;inset:0;z-index:9998;background:rgba(0,0,0,0.5);display:flex;align-items:center;justify-content:center;",document.body.appendChild(t));const o=[...new Set(e.map(n=>n.category||n.categoria||"Sin categor\xEDa"))];t.innerHTML=`
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;">
                <div>
                    ...
                    <select id="_bulkCatFilter" style="width:100%;padding:8px;border:1.5px solid #E5E7EB;border-radius:10px;font-size:.82rem;">
                        ...
                        ${o.map(n=>`<option value="${_esc(n)}">${_esc(n)}</option>`).join("")}
                    </select>
                </div>
                <div>
        ...
        </div>`,t.style.display="flex";const i=()=>_renderBulkPreview();t.querySelector("#_bulkCatFilter")?.addEventListener("change",i),t.querySelector("#_bulkTipo")?.addEventListener("change",i),t.querySelector("#_bulkValor")?.addEventListener("input",i)}window.abrirBulkEditPrecios=abrirBulkEditPrecios;function _calcBulkPrecio(e,t,o){return t==="pct_up"?e*(1+o/100):t==="pct_dn"?e*(1-o/100):t==="fixed"?o:e}function _getBulkProductos(){const e=document.getElementById("_bulkCatFilter")?.value||"";return(window.products||[]).filter(t=>!(t.tipo==="materia_prima"||t.tipo==="servicio"||Number(t.price||0)<=0||e&&(t.category||t.categoria||"Sin categor\xEDa")!==e))}function _renderBulkPreview(){const e=document.getElementById("_bulkPreview");if(!e)return;const t=document.getElementById("_bulkTipo")?.value||"pct_up",o=parseFloat(document.getElementById("_bulkValor")?.value||"0"),i=_getBulkProductos();if(!o||o<=0){e.innerHTML='<div style="padding:12px;text-align:center;color:#9CA3AF;font-size:.8rem;">Ingresa un valor para ver la vista previa</div>';return}e.innerHTML=`
        <table style="width:100%;border-collapse:collapse;">
            ...
            <tbody>
                ${i.slice(0,30).map(n=>{const r=_calcBulkPrecio(Number(n.price),t,o),a=r-Number(n.price),d=a>0?"#16A34A":a<0?"#DC2626":"#6B7280";return`<tr style="border-bottom:1px solid #F3F4F6;">
                        ...
                        <td style="padding:6px 10px;font-size:.78rem;font-weight:700;color:${d};text-align:right;">$${r.toFixed(2)}</td>
                    </tr>`}).join("")}
                ${i.length>30?`<tr><td colspan="3" style="padding:6px 10px;font-size:.72rem;color:#9CA3AF;text-align:center;">... y ${i.length-30} m\xE1s</td></tr>`:""}
            </tbody>
        </table>`}window._renderBulkPreview=_renderBulkPreview;async function _aplicarBulkPrecios(){const e=document.getElementById("_bulkTipo")?.value||"pct_up",t=parseFloat(document.getElementById("_bulkValor")?.value||"0"),o=_getBulkProductos();if(!t||t<=0||o.length===0){manekiToastExport("Configura un valor v\xE1lido","warn");return}const i=e==="pct_up"?`+${t}%`:e==="pct_dn"?`-${t}%`:`precio fijo $${t}`;await(typeof showConfirm=="function"?showConfirm(`\xBFAplicar ${i} a ${o.length} producto(s)?`,"Confirmar cambio masivo"):Promise.resolve(confirm(`\xBFAplicar ${i} a ${o.length} producto(s)?`)))&&(o.forEach(r=>{const a=Math.max(.01,_calcBulkPrecio(Number(r.price),e,t));r.historialPrecios||(r.historialPrecios=[]),r.historialPrecios.push({precio:Number(r.price),fecha:typeof _fechaHoy=="function"?_fechaHoy():new Date().toISOString().split("T")[0],motivo:`Bulk: ${i}`}),r.price=parseFloat(a.toFixed(2))}),typeof saveProducts=="function"&&saveProducts(),typeof renderInventoryTable=="function"&&renderInventoryTable(),typeof window._rebuildProductMap=="function"&&window._rebuildProductMap(),document.getElementById("_bulkEditModal").style.display="none",manekiToastExport(`\u2705 ${i} aplicado a ${o.length} producto(s)`,"ok"))}window._aplicarBulkPrecios=_aplicarBulkPrecios;function imprimirEtiquetasBatch(e){const t=e?(window.products||[]).filter(n=>e.includes(String(n.id))):(window.products||[]).filter(n=>n.tipo!=="materia_prima"&&n.tipo!=="servicio"&&Number(n.price||0)>0);if(t.length===0){manekiToastExport("No hay productos para imprimir etiquetas","warn");return}const o=t.map(n=>`
        ...
        </div>`).join(""),i=window.open("","_blank");if(!i){manekiToastExport("Activa ventanas emergentes para imprimir","warn");return}i.document.write(`<!DOCTYPE html><html><head>
        ...
        <div class="header no-print">${t.length} etiquetas \xB7 Maneki Store \xB7 <button onclick="window.print()" style="padding:4px 12px;background:#C5A572;color:#fff;border:none;border-radius:6px;cursor:pointer;font-size:8pt;">\u{1F5A8}\uFE0F Imprimir</button></div>
        ${o}
    </body></html>`),i.document.close(),setTimeout(()=>i.print(),500)}window.imprimirEtiquetasBatch=imprimirEtiquetasBatch;let _qrStream=null,_qrDetectorInst=null,_qrScanInterval=null;window._abrirQRScanner=async function(){typeof window.openModal=="function"&&window.openModal("qrScannerModal");const e=document.getElementById("qrVideo"),t=document.getElementById("qrStatus"),o=document.getElementById("qrManualWrap");if(e&&(e.style.display=""),!(typeof window.BarcodeDetector<"u")){e&&(e.style.display="none"),t&&(t.textContent="Esc\xE1ner no disponible en este navegador."),o&&(o.style.display="");return}try{if(_qrStream=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment"}}),!e)return;e.srcObject=_qrStream,await e.play(),_qrDetectorInst=new window.BarcodeDetector({formats:["qr_code","ean_13","ean_8","upc_a","upc_e","code_128","code_39","data_matrix"]}),t&&(t.textContent="Buscando c\xF3digo..."),_qrScanInterval=setInterval(async()=>{if(e.videoWidth)try{const n=await _qrDetectorInst.detect(e);if(n&&n.length>0){const r=String(n[0].rawValue||"").trim();if(!r)return;window._cerrarQRScanner();const a=document.getElementById("inventorySearch");a&&(a.value=r,a.dispatchEvent(new Event("input"))),typeof window.manekiToastExport=="function"&&window.manekiToastExport(`\u{1F4F7} C\xF3digo: ${r}`,"ok")}}catch{}},350)}catch{t&&(t.textContent="No se pudo acceder a la c\xE1mara."),o&&(o.style.display="")}},window._cerrarQRScanner=function(){typeof window.closeModal=="function"&&window.closeModal("qrScannerModal"),_qrScanInterval&&(clearInterval(_qrScanInterval),_qrScanInterval=null),_qrStream&&(_qrStream.getTracks().forEach(t=>t.stop()),_qrStream=null);const e=document.getElementById("qrVideo");e&&(e.srcObject=null)},window._qrManualBuscar=function(){const e=document.getElementById("qrManualInput");if(!e||!e.value.trim())return;const t=e.value.trim();window._cerrarQRScanner();const o=document.getElementById("inventorySearch");o&&(o.value=t,o.dispatchEvent(new Event("input")))},window._ptMpComponentes=window._ptMpComponentes??[],window._ptVariants=window._ptVariants??[],window._ptTagsActuales=window._ptTagsActuales??[];const TAGS_PT=["Oferta","Nuevo","Destacado","Favorito","Agotado"];
