"use strict";function renderCategoriesGrid(){const t=document.getElementById("categoriesGrid");t.innerHTML=categories.map(e=>{const o=products.filter(n=>n.category===e.id).length,a=_esc(e.color||"#FFD166"),r=_esc(e.id);return`
