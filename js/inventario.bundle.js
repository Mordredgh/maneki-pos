...
"use strict";typeof window.showSection>"u"&&(window.showSection=function(t){document.querySelectorAll('section[id$="-section"], section[id$="Section"]').forEach(i=>{i.classList.add("hidden"),i.style.display=""});const e=document.getElementById(t+"-section")||document.getElementById(t+"Section");e&&e.classList.remove("hidden")}),(function(){const t={rojo:"#ef4444",roja:"#ef4444",red:"#ef4444",azul:"#3b82f6",azules:"#3b82f6",blue:"#3b82f6","azul marino":"#1e3a8a",marino:"#1e3a8a",verde:"#22c55e",green:"#22c55e",amarillo:"#eab308",amarilla:"#eab308",yellow:"#eab308",dorado:"#d97706",gold:"#d97706",negro:"#1f2937",negra:"#1f2937",black:"#1f2937",blanco:"#f9fafb",blanca:"#f9fafb",white:"#f9fafb",rosa:"#ec4899",pink:"#ec4899","rosa mexicano":"#e91e8c",morado:"#ab84d1",morada:"#ab84d1",violeta:"#8b5cf6",lila:"#c084fc",lavanda:"#c4b5fd",purple:"#ab84d1",naranja:"#f97316",orange:"#f97316",gris:"#9ca3af",grise:"#9ca3af",gray:"#9ca3af",grey:"#9ca3af",plateado:"#94a3b8",silver:"#94a3b8",caf\u00E9:"#92400e",cafe:"#92400e",marr\u00F3n:"#92400e",marron:"#92400e",brown:"#78350f",beige:"#e5c9a0",crema:"#fef3c7",turquesa:"#06b6d4",celeste:"#7dd3fc",cian:"#22d3ee",cyan:"#22d3ee",aqua:"#22d3ee",coral:"#f87171",salmon:"#fca5a5",salm\u00F3n:"#fca5a5",oliva:"#84cc16",olive:"#65a30d",magenta:"#e879f9",fucsia:"#e879f9",fuchsia:"#e879f9",vino:"#9f1239",burgundy:"#9f1239",guinda:"#9f1239",indigo:"#6366f1","azul cielo":"#7dd3fc","azul rey":"#2563eb","azul claro":"#93c5fd","verde militar":"#4d7c0f","verde lim\xF3n":"#a3e635","verde menta":"#6ee7b7","verde oliva":"#65a30d","rojo vino":"#9f1239"},e={rojo:"\u{1F534}",roja:"\u{1F534}",red:"\u{1F534}",azul:"\u{1F535}",blue:"\u{1F535}","azul marino":"\u{1F535}",marino:"\u{1F535}",verde:"\u{1F7E2}",green:"\u{1F7E2}",amarillo:"\u{1F7E1}",amarilla:"\u{1F7E1}",yellow:"\u{1F7E1}",dorado:"\u{1F7E1}",gold:"\u{1F7E1}",negro:"\u26AB",negra:"\u26AB",black:"\u26AB",blanco:"\u26AA",blanca:"\u26AA",white:"\u26AA",rosa:"\u{1FA77}",pink:"\u{1FA77}","rosa mexicano":"\u{1FA77}",morado:"\u{1F7E3}",morada:"\u{1F7E3}",violeta:"\u{1F7E3}",lila:"\u{1F7E3}",purple:"\u{1F7E3}",naranja:"\u{1F7E0}",orange:"\u{1F7E0}",caf\u00E9:"\u{1F7E4}",cafe:"\u{1F7E4}",marr\u00F3n:"\u{1F7E4}",marron:"\u{1F7E4}",brown:"\u{1F7E4}",beige:"\u{1F7E4}",crema:"\u{1F7E1}",gris:"\u{1FA76}",plateado:"\u{1FA76}",silver:"\u{1FA76}",gray:"\u{1FA76}",grey:"\u{1FA76}",turquesa:"\u{1F535}",celeste:"\u{1F535}",cian:"\u{1F535}",cyan:"\u{1F535}",coral:"\u{1F534}",salmon:"\u{1FA77}",salm\u00F3n:"\u{1FA77}",vino:"\u{1F534}",burgundy:"\u{1F534}",guinda:"\u{1F534}",magenta:"\u{1F7E3}",fucsia:"\u{1F7E3}",fuchsia:"\u{1F7E3}",indigo:"\u{1F7E3}"},i=o=>/color|colour|color\s*\/\s*tono/i.test(o||"");window._mkColorDot=function(o,n){const a=_esc;if(!i(o))return`<span style="font-weight:600;">${a(n)}</span>`;const r=(n||"").toLowerCase().trim(),c=t[r],l=r==="blanco"||r==="blanca"||r==="white"||r==="crema"?"#d1d5db":"transparent";return c?`<span style="display:inline-flex;align-items:center;gap:5px;font-weight:600;">
        ...
        <div style="display:flex;gap:0;border:1px solid #e5e7eb;border-radius:10px;overflow:hidden;margin-bottom:12px;font-size:.78rem;">
            ...
            <button onclick="_listaComprasModo='pipeline';mostrarListaCompras(true)" style="flex:1;padding:7px 0;border:none;cursor:pointer;font-weight:700;background:${_listaComprasModo==="pipeline"?"#FFD166":"#fff"};color:${_listaComprasModo==="pipeline"?"#fff":"#6b7280"};">\u{1F4CB} Pipeline completo</button>
                ...
                </div>`}),u+="</div></div>",p+=u}c.innerHTML=p}window._lcToggleComprado=function(d){window._listaComprasChecked||(window._listaComprasChecked={}),window._listaComprasChecked[d]=!0,mostrarListaCompras(!0)},window._lcWhatsApp=function(){const d=r.filter(m=>m.faltan>0);if(!d.length)return;const s=_fechaHoy(),p=d.reduce((m,g)=>m+g.costoTotal,0);let f=`\u{1F4E6} Lista de compras Bicho Capricho
Fecha: ${s}
...
;
"use strict";function _levenshtein(t,e){const r=t.length,s=e.length,a=Array.from({length:r+1},(i,n)=>Array.from({length:s+1},(d,l)=>l===0?n:0));for(let i=1;i<=s;i++)a[0][i]=i;for(let i=1;i<=r;i++)for(let n=1;n<=s;n++)a[i][n]=t[i-1]===e[n-1]?a[i-1][n-1]:1+Math.min(a[i-1][n],a[i][n-1],a[i-1][n-1]);return a[r][s]}window._levenshtein=_levenshtein;function _fuzzyMatch(t,e,r=2){return t=t.toLowerCase().trim(),e=e.toLowerCase(),!t||e.includes(t)?!0:e.split(/[\s,.-]+/).some(a=>{const i=a.substring(0,t.length+2);return i.length>=t.length-1&&_levenshtein(t,i)<=r})}window._fuzzyMatch=_fuzzyMatch;function calcularProducibles(t){if(!Array.isArray(t.mpComponentes)||t.mpComponentes.length===0)return null;let e=1/0;for(const r of t.mpComponentes){const s=(window.products||[]).find(n=>String(n.id)===String(r.id));if(!s)return 0;const a=typeof getStockEfectivo=="function"?getStockEfectivo(s):s.stock||0,i=parseFloat(r.qty)||1;e=Math.min(e,Math.floor(a/i))}return e===1/0?0:e}window.calcularProducibles=calcularProducibles;function abrirBulkPrecioModal(){let t=document.getElementById("bulkPrecioModal");t||(t=document.createElement("div"),t.id="bulkPrecioModal",t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;",t.addEventListener("click",s=>{s.target===t&&(t.style.display="none")}),document.body.appendChild(t));const r=[...new Set((window.products||[]).map(s=>s.category).filter(Boolean))].map(s=>{const a=(window.categories||[]).find(i=>String(i.id)===String(s));return`<option value="${_esc(s)}">${_esc(a?a.emoji?a.emoji+" "+a.name:a.name:s)}</option>`}).join("");t.innerHTML=`
    ...
    <div style="background:#fff;border-radius:20px;width:min(520px,95vw);max-height:88vh;overflow:hidden;display:flex;flex-direction:column;box-shadow:0 20px 60px rgba(0,0,0,0.25);">
    ...
    </div>`,t.style.display="flex",_bulkStockPreview()}window.abrirBulkStockModal=abrirBulkStockModal;function _bulkStockPreview(){const t=parseInt(document.getElementById("bulkStockCantidad")?.value||"0"),e=document.getElementById("bulkStockCat")?.value||"",r=(window.products||[]).filter(a=>a.tipo==="materia_prima"&&(!e||String(a.category)===e)),s=document.getElementById("bulkStockPreviewList");if(s){if(t===0){s.innerHTML='<p style="font-size:.78rem;color:#9ca3af;text-align:center;padding:16px;">Ingresa una cantidad distinta de 0</p>';return}s.innerHTML=`
        <div style="font-size:.72rem;font-weight:700;color:#6b7280;margin-bottom:6px;">${r.length} producto${r.length!==1?"s":""} afectados:</div>
        ${r.slice(0,20).map(a=>{const i=typeof getStockEfectivo=="function"?getStockEfectivo(a):parseInt(a.stock)||0,n=Math.max(0,i+t);return`<div style="display:flex;justify-content:space-between;padding:5px 8px;border-bottom:1px solid #f3f4f6;font-size:.76rem;">
                <span>${_esc(a.name)}</span>
                <span>${i} \u2192 <b style="color:${t>0?"#16a34a":"#dc2626"}">${n}</b></span>
            </div>`}).join("")}
        ${r.length>20?`<p style="font-size:.72rem;color:#9ca3af;text-align:center;padding:6px;">...y ${r.length-20} m\xE1s</p>`:""}`}}window._bulkStockPreview=_bulkStockPreview;async function _bulkStockAplicar(){const t=parseInt(document.getElementById("bulkStockCantidad")?.value||"0"),e=document.getElementById("bulkStockCat")?.value||"";if(t===0){manekiToastExport("Ingresa una cantidad distinta de 0","warn");return}const r=(window.products||[]).filter(a=>a.tipo==="materia_prima"&&(!e||String(a.category)===e));if(r.length===0){manekiToastExport("Sin productos para ajustar","warn");return}const s=typeof getStockEfectivo=="function"?getStockEfectivo:a=>parseInt(a.stock)||0;r.forEach(a=>{const i=s(a);a.stock=Math.max(0,i+t),typeof registrarMovimiento=="function"&&registrarMovimiento({productoId:a.id,productoNombre:a.name,tipo:t>0?"entrada":"merma",cantidad:Math.abs(t),motivo:`Ajuste masivo ${t>0?"+":""}${t}`,stockAntes:i,stockDespues:a.stock})}),typeof saveProducts=="function"&&saveProducts(),renderInventoryTable(),document.getElementById("bulkStockModal").style.display="none",manekiToastExport(`\u2705 Stock ajustado en ${r.length} producto(s)`,"ok")}window._bulkStockAplicar=_bulkStockAplicar;function _bulkPrecioGetAfectados(){const t=parseFloat(document.getElementById("bulkPrecioNum")?.value)||0,e=document.getElementById("bulkPrecioSoloPT")?.checked||!1,r=document.getElementById("bulkPrecioSoloMP")?.checked||!1,s=(document.getElementById("bulkPrecioCat")?.value||"").trim();return(window.products||[]).filter(a=>s&&String(a.category)!==s?!1:e&&r?!0:!(e&&!(!a.tipo||a.tipo==="producto"||a.tipo==="producto_interno"||a.tipo==="pack")||r&&a.tipo!=="materia_prima")).map(a=>{const i=r&&!e?"cost":"price",n=parseFloat(a[i])||0,d=Math.max(0,Math.round(n*(1+t/100)*100)/100);return{p:a,campoKey:i,precioActual:n,precioNuevo:d}}).filter(a=>a.precioActual>0)}function bulkPrecioPreview(){const t=document.getElementById("bulkPrecioPreviewList");if(!t)return;const e=_bulkPrecioGetAfectados();if(!e.length){t.innerHTML='<p style="font-size:.78rem;color:#9ca3af;text-align:center;padding:16px;">Sin productos que coincidan con los filtros</p>';return}t.innerHTML=e.slice(0,50).map(({p:r,campoKey:s,precioActual:a,precioNuevo:i})=>{const n=i-a,d=n>0?"#16a34a":n<0?"#dc2626":"#6b7280",l=s==="cost"?"Costo":"Precio";return`<div style="display:flex;justify-content:space-between;align-items:center;padding:6px 8px;border-bottom:1px solid #f3f4f6;font-size:.78rem;">
            ...
            <span style="color:#6b7280;white-space:nowrap;margin:0 8px;">${l}: $${a.toFixed(2)}</span>
            <span style="font-weight:700;color:${d};white-space:nowrap;">\u2192 $${i.toFixed(2)}</span>
        </div>`}).join("")+(e.length>50?`<p style="font-size:.72rem;color:#9ca3af;text-align:center;padding:8px;">...y ${e.length-50} m\xE1s</p>`:"")}window.bulkPrecioPreview=bulkPrecioPreview;async function bulkPrecioAplicar(){const t=_bulkPrecioGetAfectados();if(!t.length){manekiToastExport("Sin productos que actualizar","warn");return}bulkPrecioPreview();const e=parseFloat(document.getElementById("bulkPrecioNum")?.value)||0,r=document.getElementById("bulkPrecioSoloMP")?.checked&&!document.getElementById("bulkPrecioSoloPT")?.checked?"costo":"precio",s=e>0?"+":"",a=t.slice(0,5).map(({p:i,precioActual:n,precioNuevo:d})=>`<div style="display:flex;justify-content:space-between;font-size:.8rem;padding:3px 0;border-bottom:1px solid #f3f4f6;">
            ...
            <span style="font-weight:700;color:${d>n?"#16a34a":"#dc2626"};">\u2192 $${d.toFixed(2)}</span>
                ...
                ${a}
             </div>`,"\u2705 Confirmar cambio masivo").then(i=>{i&&(t.forEach(({p:n,campoKey:d,precioNuevo:l})=>{n[d]=l,n.updatedAt=new Date().toISOString()}),typeof saveProducts=="function"&&saveProducts(),renderInventoryTable(),document.getElementById("bulkPrecioModal").style.display="none",manekiToastExport(`\u2705 Precios actualizados en ${t.length} producto(s)`,"ok"))});else{if(!await showConfirm(`\xBFAplicar ${s}${e}% a ${t.length} producto(s)? Ver preview arriba.`))return;t.forEach(({p:i,campoKey:n,precioNuevo:d})=>{i[n]=d,i.updatedAt=new Date().toISOString()}),typeof saveProducts=="function"&&saveProducts(),renderInventoryTable(),document.getElementById("bulkPrecioModal").style.display="none",manekiToastExport(`\u2705 Precios actualizados en ${t.length} producto(s)`,"ok")}}window.bulkPrecioAplicar=bulkPrecioAplicar;function renderInventoryTable(){const t=document.getElementById("inventoryTable");if(!t)return;document.getElementById("inventoryPaginationBar")?.remove();const e=window.products||[],r=document.getElementById("inventoryTipoFilter")?.value||"",s=["pt","pv","mp","svc"].map(o=>`${o}:${window[`_invPage_${o}`]||1}`).join("|"),a=e.length+"_"+e.reduce((o,x)=>o+Number(x.stock||0),0).toFixed(0)+"_"+(document.getElementById("inventorySearch")?.value||"")+"_"+r+"_"+s+"_"+(window._invPageSize||10)+"_"+(window._invSortCol||"")+"_"+(window._invSortDir||""),i=document.getElementById("invDualContainer");if(i&&i._lastHash===a)return;i&&(i._lastHash=a);let n=document.getElementById("invDualContainer");if(!n){const o=t.closest('table, .overflow-x-auto, [class*="overflow"]')||t.parentElement;n=document.createElement("div"),n.id="invDualContainer",n.style.cssText="display:flex;flex-direction:column;gap:0;",o.parentNode.insertBefore(n,o),o.style.display="none"}const d=window.products||[],l=new Map(d.map(o=>[String(o.id),typeof getStockEfectivo=="function"?getStockEfectivo(o):parseInt(o.stock)||0]));if(window._invStockCache=l,typeof poblarFiltroProveedores=="function"&&poblarFiltroProveedores(),!document.getElementById("invExtraColStyles")){const o=document.createElement("style");o.id="invExtraColStyles",o.textContent=`
        ...
        </div>`;return}const c=(document.getElementById("inventorySearch")||{}).value?.trim().toLowerCase()||"",w=(document.getElementById("inventoryTagFilter")||{}).value||"",v=(document.getElementById("inventoryProveedorFilter")||{}).value?.trim().toLowerCase()||"";function z(o){const x=window._normSearch||(y=>String(y||"").toLowerCase()),g=x(c),k=x(v),$=y=>!w||y.tags&&y.tags.includes(w),E=y=>!v||x(y.proveedor||"").includes(k);if(!c)return o.filter(y=>$(y)&&E(y));const S=o.filter(y=>(x(y.name).includes(g)||x(y.sku||"").includes(g)||x(y.proveedor||"").includes(g)||x(y.notas||"").includes(g)||(y.tags||[]).some(G=>x(G).includes(g)))&&$(y)&&E(y));return S.length>0?S:o.filter(y=>(_fuzzyMatch(g,y.name||"")||_fuzzyMatch(g,y.sku||"")||_fuzzyMatch(g,y.proveedor||""))&&$(y)&&E(y))}const b=z(d.filter(o=>o.tipo==="materia_prima")),L=z(d.filter(o=>o.tipo==="servicio")),D=z(d.filter(o=>o.tipo==="producto_variable")),U=z(d.filter(o=>!o.tipo||o.tipo==="producto"||o.tipo==="producto_interno"||o.tipo==="pack")),_=new Set([...U,...D].map(o=>String(o.id))),T=window.productMap||new Map(d.map(o=>[String(o.id),o])),B=new Map;for(const o of d)o.mpComponentes&&o.mpComponentes.length>0&&_.has(String(o.id))&&B.set(String(o.id),calcularDisponibilidadDesdeMP(o,T,l));function f(o){if(!window._invSortCol)return o;const x=window._invSortCol,g=window._invSortDir;return[...o].sort((k,$)=>{let E,S;return x==="name"?(E=(k.name||"").toLowerCase(),S=($.name||"").toLowerCase()):x==="sku"?(E=(k.sku||"").toLowerCase(),S=($.sku||"").toLowerCase()):x==="category"?(E=(k.category||"").toLowerCase(),S=($.category||"").toLowerCase()):x==="price"?(E=Number(k.price)||0,S=Number($.price)||0):x==="stock"?(E=Number(k.stock)||0,S=Number($.stock)||0):x==="margin"&&(E=k.cost&&k.price?(k.price-k.cost)/k.price:-1,S=$.cost&&$.price?($.price-$.cost)/$.price:-1),E<S?g==="asc"?-1:1:E>S?g==="asc"?1:-1:0})}function h(o,x){const g=String(o.id),k=l.get(g)??(typeof getStockEfectivo=="function"?getStockEfectivo(o):parseInt(o.stock)||0),$=o.imageUrl?`<img src="${o.imageUrl}" alt="${_esc(o.name||"")}" style="width:40px;height:40px;object-fit:cover;border-radius:8px;border:1px solid rgba(0,0,0,0.08);background:#f9fafb;" loading="lazy">`:`<span style="font-size:1.6rem;">${o.image||"\u{1F3ED}"}</span>`;let E;k===0?E='<span class="badge-danger"><i class="fas fa-circle-xmark"></i> Agotado</span>':k<=(o.stockMin||5)?E='<span class="badge-warning"><i class="fas fa-triangle-exclamation"></i> Bajo Stock</span>':E='<span class="badge-success"><i class="fas fa-circle-check"></i> Disponible</span>';const S=(window.categories||[]).find(F=>F.id===o.category),y=S?S.name:o.category||"";return`
        ...
        </tr>`}function P(o,x){const g=String(o.id),k=`<span style="font-size:1.6rem;">${o.image||"\u2699\uFE0F"}</span>`;return`
        <tr style="animation:mkSectionIn 0.3s ease both;animation-delay:${x*.03}s" class="hover:bg-indigo-50">
            ...
            <td class="px-2 py-3">
        ...
        </tr>`}function K(o,x){const g=String(o.id),k=o.imageUrl?`<img src="${o.imageUrl}" alt="${_esc(o.name||"")}" style="width:40px;height:40px;object-fit:cover;border-radius:8px;border:1px solid rgba(0,0,0,0.08);background:#f9fafb;" loading="lazy">`:`<span style="font-size:1.6rem;">${o.image||"\u{1F4E6}"}</span>`,$=(window.categories||[]).find(m=>m.id===o.category),E=$?$.name:o.category||"",S=B.get(g)??null;let y,F;if(S!==null){const m=S.piezas,I=m===0?"#ef4444":m<=3?"#f59e0b":"#10b981",j=m===0?"#fee2e2":m<=3?"#fef3c7":"#d1fae5",M=S.detalle.map(R=>`${R.nombre}: ${R.stock}\xF7${R.qty}=${R.posibles}pzs`).join(" | ");y=`
                <div style="display:flex;flex-direction:column;align-items:flex-start;gap:2px;">
                    <span title="${_esc(M)}"
               ...
               </div>`:'<span class="text-xs text-gray-400">Sin variantes</span>',J=Number(o.cost)||0,q=Number(o.price)||0,X=J&&q?(()=>{const m=(q-J)/q*100,I=m>=40?"#10b981":m>=20?"#f59e0b":"#ef4444";return`<div style="min-width:56px;">
        ...
        </tr>`}function O(o,x){const g=String(o.id),k=o.imageUrl?`<img src="${o.imageUrl}" alt="${_esc(o.name||"")}" style="width:40px;height:40px;object-fit:cover;border-radius:8px;border:1px solid rgba(0,0,0,0.08);background:#f9fafb;" loading="lazy">`:`<span style="font-size:1.6rem;">${o.image||"\u{1F3AF}"}</span>`,$=(o.tablaPreciosVariable||[]).slice().sort((C,W)=>C.cantidadMin-W.cantidadMin),E=$.length?$.map(C=>`<span style="font-size:10px;background:#e0f2fe;color:#0369a1;padding:1px 7px;border-radius:99px;white-space:nowrap;">${C.cantidadMin} pzas = $${Number(C.precio).toFixed(2)}</span>`).join(" "):'<span style="font-size:10px;color:#9ca3af;">Sin rangos</span>',S=(o.mpComponentes||[]).length,y=(window.categories||[]).find(C=>String(C.id)===String(o.category)),F=y?`${y.emoji||""} ${y.name}`:"\u2014",G=$,H=G.length?G[0].precio/(G[0].cantidadMin||1):0,at=H>0?`<div><span class="font-semibold text-gray-800" style="font-size:.95rem;">$${H.toFixed(2)}</span><div style="font-size:10px;color:#9ca3af;">por pieza</div></div>`:'<span style="color:#9ca3af;font-size:.8rem;">\u2014</span>',Q=B.get(String(o.id))??null;let J,q;if(Q!==null){const C=Q.piezas,W=C===0?"#ef4444":C<=3?"#f59e0b":"#10b981",ct=C===0?"#fee2e2":C<=3?"#fef3c7":"#d1fae5",rt=Q.detalle.map(et=>`${et.nombre}: ${et.stock}\xF7${et.qty}=${et.posibles}pzs`).join(" | ");J=`<div style="display:flex;flex-direction:column;align-items:flex-start;gap:2px;">
        ...
        </tr>`}function Y({id:o,title:x,titleColor:g,titleBg:k,btnLabel:$,btnOnclick:E,btnColor:S,extraBtnHTML:y,products:F,renderFila:G,headers:H,emptyMsg:at}){const Q=document.getElementById("inventoryTipoFilter")?.value||"";if(Q==="materia"&&o!=="mp"||Q==="producto"&&o==="mp")return"";const J=(document.getElementById("inventorySearch")?.value?.trim()||"").length>0;if(F.length===0&&J)return"";const q=f(F),X=`_invPage_${o}`,m=window._invPageSize||10;window[X]=window[X]||1;const I=q.length,j=Math.max(1,Math.ceil(I/m));window[X]>j&&(window[X]=1);const M=window[X],R=(M-1)*m,C=q.slice(R,R+m),W=C.length===0?`<tr><td colspan="${H.length}" style="padding:32px;text-align:center;color:#9ca3af;font-size:.85rem;">${at}</td></tr>`:C.map((V,nt)=>G(V,nt)).join(""),ct=H.map(V=>{const nt=V.colId==="sku"?" inv-col-hidden-sku":V.colId==="proveedor"?" inv-col-hidden-prov":"",it=V.align==="right"?" text-right":" text-left";return V.sortKey?`<th class="px-4 py-3${it} text-xs font-semibold text-gray-500 uppercase tracking-wide sortable-th cursor-pointer select-none${nt}" data-action="sortInventory" data-arg="${V.sortKey}" style="white-space:nowrap;">${V.label} \u2195</th>`:`<th class="px-4 py-3${it} text-xs font-semibold text-gray-500 uppercase tracking-wide${nt}" style="white-space:nowrap;">${V.label}</th>`}).join("");let rt="";if(j>1||I>m){const V=Math.min(R+m,I);rt=`
        ...
        <div style="margin-bottom:32px;border-radius:16px;overflow:hidden;border:1.5px solid ${g}33;box-shadow:0 2px 12px ${g}11;">
            ...
            <div style="display:flex;align-items:center;justify-content:space-between;padding:14px 20px;background:${k};border-bottom:${pt?"none":"1.5px solid "+g+"33"};cursor:pointer;" data-action="_mkInvToggleCollapse" data-arg="${o}">
                <div style="display:flex;align-items:center;gap:10px;">
            ...
            ${rt}`}
        </div>`}const A=d.filter(o=>!o.deletedAt),Z=A.length,tt=A.reduce((o,x)=>{const g=l.get(String(x.id))??(typeof getStockEfectivo=="function"?getStockEfectivo(x):parseInt(x.stock)||0);return o+(Number(x.cost)||0)*Math.max(0,g)},0),st=A.filter(o=>(l.get(String(o.id))??(typeof getStockEfectivo=="function"?getStockEfectivo(o):parseInt(o.stock)||0))<=(o.stockMin||5)).length,dt=A.filter(o=>(!o.tipo||o.tipo==="producto"||o.tipo==="producto_interno"||o.tipo==="pack")&&Number(o.price)>0),lt=dt.length?dt.reduce((o,x)=>{const g=Number(x.price)||0,k=Number(x.cost)||0;return o+(g>0?(g-k)/g*100:0)},0)/dt.length:0;let ot=document.getElementById("invKpiBar");ot||(ot=document.createElement("div"),ot.id="invKpiBar",n.parentNode.insertBefore(ot,n)),ot.innerHTML=`
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:20px;">
        ...
        <div style="padding:64px 24px;text-align:center;">
            ...
            <button onclick="(function(){var el=document.getElementById('inventorySearch');if(el){el.value='';el.dispatchEvent(new Event('input'));}var tEl=document.getElementById('inventoryTagFilter');if(tEl)tEl.value='';var pEl=document.getElementById('inventoryProveedorFilter');if(pEl)pEl.value='';renderInventoryTable();})()"
        ...
        </div>`)}function invSectionPage(t,e){const r=`_invPage_${t}`,s=window.products||[],a=t==="mp"?s.filter(c=>c.tipo==="materia_prima"):t==="svc"?s.filter(c=>c.tipo==="servicio"):t==="pv"?s.filter(c=>c.tipo==="producto_variable"):s.filter(c=>!c.tipo||c.tipo==="producto"||c.tipo==="producto_interno"||c.tipo==="pack"),i=(document.getElementById("inventorySearch")||{}).value?.trim().toLowerCase()||"",n=(document.getElementById("inventoryTagFilter")||{}).value||"",d=(document.getElementById("inventoryProveedorFilter")||{}).value?.trim().toLowerCase()||"",l=a.filter(c=>{const w=!i||c.name.toLowerCase().includes(i)||(c.sku||"").toLowerCase().includes(i)||(c.proveedor||"").toLowerCase().includes(i)||(c.notas||"").toLowerCase().includes(i)||(c.tags||[]).some(b=>b.toLowerCase().includes(i)),v=!n||c.tags&&c.tags.includes(n),z=!d||(c.proveedor||"").toLowerCase().includes(d);return w&&v&&z}),u=Math.max(1,Math.ceil(l.length/(window._invPageSize||10)));window[r]=Math.max(1,Math.min(e,u)),renderInventoryTable()}window.invSectionPage=invSectionPage;function _renderInventoryPagination(t,e,r,s,a){let i=document.getElementById("inventoryPaginationBar");if(!i){const u=document.getElementById("inventoryTable")?.closest('table, .overflow-x-auto, [class*="overflow"]');if(!u)return;i=document.createElement("div"),i.id="inventoryPaginationBar",u.insertAdjacentElement("afterend",i)}if(e<=1&&r<=a){i.innerHTML="";return}const n=Math.min(s+a,r),d=`Mostrando <b>${s+1}\u2013${n}</b> de <b>${r}</b> productos`;function l(){const u=[],c=(w,v)=>{for(let z=w;z<=v;z++)u.push(z)};return e<=7?c(1,e):(u.push(1),t>4&&u.push("..."),c(Math.max(2,t-2),Math.min(e-1,t+2)),t<e-3&&u.push("..."),u.push(e)),u.map(w=>{if(w==="...")return'<span style="padding:0 4px;color:#9ca3af;">\u2026</span>';const v=w===t;return`<button data-action="invGoToPage" data-arg="${w}"
                ...
                ${v?"disabled":""}>${w}</button>`}).join("")}i.innerHTML=`
        <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;
            ...
            <div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap;">
                ...
                <select data-change="invChangePageSize" data-pass-el="1"
                    ...
                    ${[10,25,50,100].map(u=>`<option value="${u}" ${u===a?"selected":""}>${u} por p\xE1gina</option>`).join("")}
                </select>
            </div>
...
`;b.forEach(B=>{const f=[new Date(B.fecha).toLocaleString("es-MX"),B.productoNombre||"",B.tipo||"",B.cantidad,B.motivo||"",B.stockAntes??"",B.stockDespues??""];D+=f.map(h=>`"${String(h).replace(/"/g,'""')}"`).join(",")+`
`});const U=new Blob([D],{type:"text/csv;charset=utf-8;"}),_=URL.createObjectURL(U),T=document.createElement("a");T.href=_,T.download=`movimientos-${i}.csv`,T.click(),URL.revokeObjectURL(_)},e.parentNode.insertBefore(v,e)),!a.length){e.innerHTML='<p class="text-gray-400 text-sm text-center py-4">Sin movimientos registrados</p>';return}const z={entrada:"\u{1F7E2}",salida:"\u{1F534}",ajuste:"\u{1F7E1}",creacion:"\u{1F535}",venta:"\u{1F7E0}",merma:"\u{1F7E4}"};e.innerHTML=a.slice(0,200).map(b=>{const L=new Date(b.fecha).toLocaleString("es-MX",{dateStyle:"short",timeStyle:"short"}),D=b.cantidad>=0?`+${b.cantidad}`:`${b.cantidad}`;return`<div style="display:flex;align-items:center;gap:10px;padding:8px 12px;border-bottom:1px solid #f3f4f6;font-size:13px;">
  ...
  `}window.invUpdateBulkBar=invUpdateBulkBar;function invBulkDesseleccionar(){document.querySelectorAll(".inv-bulk-cb, .inv-bulk-all").forEach(t=>t.checked=!1),invUpdateBulkBar()}window.invBulkDesseleccionar=invBulkDesseleccionar;async function invBulkEliminar(){const t=invGetSelectedIds();if(!t.length)return;const e=(window.pedidos||[]).filter(a=>!["cancelado","finalizado"].includes(a.status||"")&&(a.productosInventario||[]).some(i=>t.includes(String(i.id))));if(e.length>0){const a=e.map(n=>n.folio||n.id).slice(0,5).join(", ");if(!(typeof showConfirm=="function"?await showConfirm(`\u26A0\uFE0F ${e.length} pedido(s) activo(s) usan estos productos (${a}). \xBFEliminar de todas formas?`,"Productos en pedidos activos"):confirm(`\u26A0\uFE0F ${e.length} pedido(s) activo(s) usan estos productos (${a}). \xBFEliminar de todas formas?`)))return}if(!(typeof showConfirm=="function"?await showConfirm(`\xBFEliminar ${t.length} producto(s)? Esta acci\xF3n no se puede deshacer.`,"\u{1F5D1} Confirmar eliminaci\xF3n"):confirm(`\xBFEliminar ${t.length} producto(s)? Esta acci\xF3n no se puede deshacer.`)))return;const s=[...t];if(window.products=(window.products||[]).filter(a=>!s.includes(String(a.id))),saveProducts(),renderInventoryTable(),invUpdateBulkBar(),typeof db<"u"&&db)try{await db.from("products").delete().in("id",s)}catch(a){console.warn("[BulkEliminar] Error al eliminar de Supabase relacional:",a)}manekiToastExport(`\u{1F5D1} ${s.length} producto(s) eliminados`,"ok")}window.invBulkEliminar=invBulkEliminar;function invBulkExportar(){const t=invGetSelectedIds(),e=(window.products||[]).filter(l=>t.includes(String(l.id))),r="tipo,nombre,sku,costo,precio,stock,stock_min,proveedor,notas",s=e.map(l=>[l.tipo||"pt",l.name,l.sku||"",l.cost||0,l.price||0,l.stock||0,l.stockMin||5,l.proveedor||"",l.notas||""].map(u=>`"${String(u).replace(/"/g,'""')}"`).join(",")),a="\uFEFF"+r+`
`+s.join(`
`),i=new Blob([a],{type:"text/csv;charset=utf-8;"}),n=URL.createObjectURL(i),d=document.createElement("a");d.href=n,d.download="inventario_seleccion.csv",d.click(),URL.revokeObjectURL(n),manekiToastExport(`\u{1F4E5} ${e.length} productos exportados`,"ok")}window.invBulkExportar=invBulkExportar;async function invBulkCambiarCategoria(){const t=invGetSelectedIds();if(!t.length)return;const e=await new Promise(s=>{const a=document.getElementById("mkBatchCatModal");a&&a.remove();const n=(window.categories||[]).map(l=>`<option value="${l.id}">${l.emoji||""} ${l.name}</option>`).join(""),d=document.createElement("div");d.id="mkBatchCatModal",d.className="mk-modal-overlay",d.innerHTML=`<div class="mk-modal-box" style="max-width:360px">
    ...
    `;const s=document.getElementById("mkInvFilterInfo");s?s.parentElement.insertBefore(r,s):e.parentElement.insertBefore(r,e.nextSibling)}}}function _mkInvCounterChips(){const t=document.getElementById("mkInvFilterInfo");if(!t)return;const e=document.getElementById("invDualContainer"),r=e?e.querySelectorAll(".inv-bulk-cb").length:0,s=(window.products||[]).length,a=document.getElementById("inventorySearch"),i=document.getElementById("inventoryTagFilter"),n=document.getElementById("inventoryProveedorFilter"),d=document.getElementById("inventoryTipoFilter"),l=[];a&&a.value.trim()&&l.push(`<span class="mk-filter-chip">Buscar: ${_esc(a.value.trim())}<button data-tip="Quitar" onclick="_mkInvClearOne('inventorySearch')">\u2715</button></span>`),d&&d.value&&l.push(`<span class="mk-filter-chip">Tipo: ${_esc(_MK_TIPO_LABELS[d.value]||d.value)}<button data-tip="Quitar" onclick="_mkInvSetTipo('')">\u2715</button></span>`),i&&i.value&&l.push(`<span class="mk-filter-chip">Tag: ${_esc(i.value)}<button data-tip="Quitar" onclick="_mkInvClearOne('inventoryTagFilter')">\u2715</button></span>`),n&&n.value&&l.push(`<span class="mk-filter-chip">Proveedor: ${_esc(n.options[n.selectedIndex]?.text||n.value)}<button data-tip="Quitar" onclick="_mkInvClearOne('inventoryProveedorFilter')">\u2715</button></span>`);let u=`<span class="mk-result-count">Mostrando <b>${r}</b> de ${s} producto${s!==1?"s":""}</span>`;l.length&&(u+=`<div class="mk-filter-chips">${l.join("")}<button class="mk-filter-clear" onclick="_mkInvClearFilters()">Limpiar todo</button></div>`),t.innerHTML=u,_mkInvSyncSeg()}function _mkInvSummaryRow(){const t=document.getElementById("invDualContainer");if(!t||!t.parentElement)return;const e=new Set([...t.querySelectorAll(".inv-bulk-cb")].map(d=>String(d.dataset.id))),r=window._invStockCache;let s=0,a=0,i=0;(window.products||[]).forEach(d=>{if(!e.has(String(d.id)))return;i++;const l=r?.get(String(d.id))??(Number(d.stock)||0);s+=(Number(d.cost)||0)*Math.max(0,l),l<=(Number(d.stockMin)||5)&&a++});let n=document.getElementById("mkInvSummary");if(i===0){n&&n.remove();return}n||(n=document.createElement("div"),n.id="mkInvSummary",n.className="mk-table-summary",n.style.cssText="display:flex;gap:18px;align-items:center;flex-wrap:wrap;padding:10px 18px;border-radius:0 0 14px 14px;margin-top:-2px;",t.parentElement.insertBefore(n,t.nextSibling)),n.innerHTML=`<span>Valor en costo: <b>$${s.toLocaleString("es-MX",{maximumFractionDigits:0})}</b></span><span style="color:var(--tx-muted);">${i} producto${i!==1?"s":""}</span>`+(a>0?`<span style="color:#dc2626;font-weight:800;">\u26A0 ${a} bajo stock</span>`:'<span style="color:#059669;font-weight:700;">\u2713 stock saludable</span>')}(function(){const e=window.renderInventoryTable;if(typeof e!="function"||e._mkWrapped)return;const r=function(...s){const a=e.apply(this,s);try{_mkInvToolbarOnce(),_mkInvCounterChips(),_mkInvSummaryRow()}catch{}return a};r._mkWrapped=!0,window.renderInventoryTable=r})();function _mkInvModal(t,e,r,s="700px"){let a=document.getElementById(t+"_ov");a||(a=document.createElement("div"),a.id=t+"_ov",a.style.cssText="position:fixed;inset:0;z-index:9100;background:rgba(0,0,0,.45);display:flex;align-items:center;justify-content:center;padding:16px;",document.body.appendChild(a)),a.innerHTML=`
    ...
    </div>`,a.onclick=i=>{i.target===a&&a.remove()},a.style.display="flex"}function abrirConteoFisico(){const t=(window.products||[]).filter(a=>a.tipo!=="servicio"&&a.activo!==!1);if(!t.length){typeof manekiToastExport=="function"&&manekiToastExport("Sin productos para contar","warn");return}const e=_esc,s=`
    ...
    <table style="width:100%;border-collapse:collapse;">
      ...
      <td style="padding:7px 10px;font-weight:600;font-size:.85rem;">${e(a.name)}</td>
      <td style="padding:7px 10px;text-align:center;color:#6b7280;font-size:.82rem;">${e(a.category||"\u2014")}</td>
      <td style="padding:7px 10px;text-align:center;font-weight:700;">${n}</td>
      <td style="padding:7px 10px;text-align:center;">
        <input type="number" min="0" value="${n}" data-pid="${e(a.id)}" data-sistema="${n}"
    ...
    </div>`;_mkInvModal("mkConteo","\u{1F4CB} Conteo F\xEDsico de Inventario",s,"780px")}window.abrirConteoFisico=abrirConteoFisico,window._mkAplicarConteoFisico=function(){const t=document.querySelectorAll("#mkConteo_ov .conteo-input");let e=0;if(t.forEach(r=>{const s=r.dataset.pid,a=Number(r.dataset.sistema),i=Number(r.value);if(isNaN(i)||i===a)return;const n=(window.products||[]).find(l=>String(l.id)===String(s));if(!n)return;const d=i-a;n.stock=i,typeof registrarMovimiento=="function"&&registrarMovimiento({productoId:n.id,productoNombre:n.name,tipo:d>0?"entrada_manual":"salida_manual",cantidad:Math.abs(d),motivo:"Conteo f\xEDsico",stockAntes:a,stockDespues:i}),e++}),e===0){typeof manekiToastExport=="function"&&manekiToastExport("Sin diferencias que ajustar","warn");return}typeof saveProducts=="function"&&saveProducts(),typeof renderInventoryTable=="function"&&renderInventoryTable(),document.getElementById("mkConteo_ov")?.remove(),typeof manekiToastExport=="function"&&manekiToastExport(`\u2705 ${e} ajuste${e!==1?"s":""} aplicados`,"ok")};function abrirReabastecimiento(){const t=(window.products||[]).filter(a=>a.tipo==="servicio"||a.activo===!1?!1:(typeof getStockEfectivo=="function"?getStockEfectivo(a):Number(a.stock)||0)<=(Number(a.stockMin)||5));if(!t.length){typeof manekiToastExport=="function"&&manekiToastExport("\u2705 Sin productos bajo stock m\xEDnimo","ok");return}const e=_esc,r={};t.forEach(a=>{const i=a.proveedor||"Sin proveedor";r[i]||(r[i]=[]),r[i].push(a)});const s=Object.entries(r).map(([a,i])=>{const n=e(a),d=i.map(c=>{const w=typeof getStockEfectivo=="function"?getStockEfectivo(c):Number(c.stock)||0,v=Number(c.stockMin)||5,z=Math.max(1,v*2-w);return`<tr><td style="padding:6px 10px;font-size:.83rem;font-weight:600;">${e(c.name)}</td>
...
${i.map(c=>{const w=Number(c.stock)||0,v=Number(c.stockMin)||5;return`\u2022 ${c.name}: ${Math.max(1,v*2-w)} ${c.unidad||"pza"}`}).join(`
...
`),s=document.createElement("a");s.href=URL.createObjectURL(new Blob([r],{type:"text/csv;charset=utf-8;"}));const a=new Date,i=`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`;s.download=`reabastecimiento_${i}.csv`,s.click()};function mostrarDonutCategoria(){const t=_esc,e={};(window.products||[]).forEach(d=>{if(d.tipo==="servicio"||d.activo===!1)return;const l=typeof getStockEfectivo=="function"?getStockEfectivo(d):Number(d.stock)||0,u=(Number(d.price)||0)*l,c=d.category||"Sin categor\xEDa";e[c]=(e[c]||0)+u});const r=Object.entries(e).sort((d,l)=>l[1]-d[1]),s=r.reduce((d,[,l])=>d+l,0),a=["#FFD166","#9669c4","#10b981","#3b82f6","#f59e0b","#ef4444","#06b6d4","#9669c4","#f97316","#14b8a6"],i=r.map(([d,l],u)=>{const c=s>0?(l/s*100).toFixed(1):"0";return`<tr>
    ...
    </div>`;_mkInvModal("mkDonut","\u{1F4CA} Valor de Inventario por Categor\xEDa",n,"700px"),setTimeout(()=>{const d=document.getElementById("mkDonutCat");if(d)try{const l=window.Chart;if(typeof l>"u"){d.style.display="none";return}new l(d,{type:"doughnut",data:{labels:r.map(([u])=>u),datasets:[{data:r.map(([,u])=>Math.round(u)),backgroundColor:r.map((u,c)=>a[c%a.length]),borderWidth:2}]},options:{plugins:{legend:{display:!1}},cutout:"65%",responsive:!1}})}catch{d&&(d.style.display="none")}},100)}window.mostrarDonutCategoria=mostrarDonutCategoria;function sugerirStockMinimo(){const t=_esc,e=new Date;e.setDate(e.getDate()-60);const r={};(window.pedidosFinalizados||[]).forEach(n=>{const d=n.fechaFinalizado||n.entrega||"";d&&new Date(d)<e||(n.productosInventario||[]).forEach(l=>{!l.id||l.id==="libre"||(r[String(l.id)]=(r[String(l.id)]||0)+(Number(l.quantity||l.cantidad)||1))})});const s=(window.products||[]).filter(n=>n.tipo!=="servicio"&&n.activo!==!1&&r[String(n.id)]);if(!s.length){typeof manekiToastExport=="function"&&manekiToastExport("Sin datos de consumo en los \xFAltimos 60 d\xEDas","warn");return}const i=`
    ...
    <div style="margin-top:18px;display:flex;gap:10px;justify-content:flex-end;">
    ...
    </div>`;_mkInvModal("mkStockMin","\u{1F916} Stock M\xEDnimo Sugerido",i,"780px")}window.sugerirStockMinimo=sugerirStockMinimo,window._mkAplicarStockMinSugerido=function(){const t=document.querySelectorAll("#mkStockMin_ov .mkStockMinCb:checked");let e=0;t.forEach(r=>{const s=r.dataset.pid,a=Number(r.dataset.nuevo),i=(window.products||[]).find(n=>String(n.id)===String(s));!i||isNaN(a)||(i.stockMin=a,e++)}),e&&(typeof saveProducts=="function"&&saveProducts(),typeof renderInventoryTable=="function"&&renderInventoryTable(),document.getElementById("mkStockMin_ov")?.remove(),typeof manekiToastExport=="function"&&manekiToastExport(`\u2705 Stock m\xEDnimo actualizado en ${e} producto${e!==1?"s":""}`,"ok"))};function archivarProducto(t){const e=(window.products||[]).find(i=>String(i.id)===String(t));if(!e)return;const r=e.activo!==!1,s=r?"archivar":"desarchivar",a=r?`\xBFArchivar "${e.name}"? Dejar\xE1 de aparecer en inventario y b\xFAsquedas, pero se conserva el historial.`:`\xBFDesarchivar "${e.name}"? Volver\xE1 a aparecer en inventario.`;typeof showConfirm=="function"&&showConfirm(a,r?"\u{1F4C1} Archivar":"\u{1F513} Desarchivar").then(i=>{i&&(e.activo=!r,e.updatedAt=new Date().toISOString(),typeof saveProducts=="function"&&saveProducts(),typeof renderInventoryTable=="function"&&renderInventoryTable(),typeof manekiToastExport=="function"&&manekiToastExport(r?`\u{1F4C1} "${e.name}" archivado`:`\u{1F513} "${e.name}" desarchivado`,"ok"))})}window.archivarProducto=archivarProducto;function abrirMovimientoProducto(t){const e=_esc,r=(window.products||[]).find(f=>String(f.id)===String(t));if(!r){typeof manekiToastExport=="function"&&manekiToastExport("Producto no encontrado","warn");return}const s=Date.now()-90*864e5,a=new Set,i=[],n=f=>{if(!f)return;const h=f.fecha?new Date(f.fecha+(f.hora?"T"+f.hora:"")).getTime():f.timestamp?new Date(f.timestamp).getTime():0;if(h&&h<s)return;const P=f.id||String(f.productoId||t)+"_"+h+"_"+(f.cantidad||0);a.has(P)||(a.add(P),i.push({...f,_ts:h||Date.now()}))};(r.movimientos||[]).forEach(n),(window.stockMovimientos||[]).filter(f=>String(f.productoId)===String(t)).forEach(n),i.sort((f,h)=>h._ts-f._ts);const d=[];for(let f=12;f>=0;f--){const h=new Date(Date.now()-f*7*864e5),P=new Date(h.getTime()-7*864e5),K=`${P.getDate()}/${P.getMonth()+1}`;let O=0,Y=0;i.forEach(A=>{if(A._ts>=P.getTime()&&A._ts<h.getTime()){const Z=A.stockDespues!=null&&A.stockAntes!=null?Number(A.stockDespues)-Number(A.stockAntes):0,tt=(A.tipo||"").toLowerCase();Z>0||tt.includes("entrada")||tt.includes("compra")||tt.includes("ajuste_positivo")?O+=Math.abs(Number(A.cantidad)||Math.abs(Z)||1):Y+=Math.abs(Number(A.cantidad)||Math.abs(Z)||1)}}),d.push({label:K,entradas:O,salidas:Y})}const l=Math.max(1,...d.map(f=>Math.max(f.entradas,f.salidas))),u=480,c=100,w=Math.floor((u-20)/d.length/2)-1,v=d.map((f,h)=>{const P=10+h*(w*2+4),K=Math.round(f.entradas/l*(c-20)),O=Math.round(f.salidas/l*(c-20));return`
      ...
      <text x="${P+w}" y="${c-1}" text-anchor="middle" font-size="8" fill="#9ca3af">${f.label}</text>`}).join(""),z=i.length===0?'<p style="text-align:center;color:#9ca3af;padding:20px 0;font-size:.85rem;">Sin movimientos en los \xFAltimos 90 d\xEDas</p>':`
    ...
    </tr>`}).join(""),D=typeof getStockEfectivo=="function"?getStockEfectivo(r):Number(r.stock)||0,U=i.reduce((f,h)=>{const P=h.stockDespues!=null&&h.stockAntes!=null?Number(h.stockDespues)-Number(h.stockAntes):0;return f+(P>0||(h.tipo||"").includes("entrada")||(h.tipo||"").includes("compra")?Math.abs(Number(h.cantidad)||Math.abs(P)||0):0)},0),_=i.reduce((f,h)=>{const P=h.stockDespues!=null&&h.stockAntes!=null?Number(h.stockDespues)-Number(h.stockAntes):0,K=P>0||(h.tipo||"").includes("entrada")||(h.tipo||"").includes("compra");return f+(K?0:Math.abs(Number(h.cantidad)||Math.abs(P)||0))},0),T=`
  ...
  `,B=`
    ...
    ${T}`;_mkInvModal("mkMovProd",`\u{1F4C8} Movimientos \u2014 ${e(r.name||"Producto")} (90d)`,B,"780px")}window.abrirMovimientoProducto=abrirMovimientoProducto;function abrirTendenciaInventario(){const t=window.inventarioSnapshots||[];if(t.length===0){typeof manekiToastExport=="function"&&manekiToastExport("Sin datos hist\xF3ricos a\xFAn. Los snapshots se generan autom\xE1ticamente.","warn");return}const e=[...t].sort((_,T)=>(_.fecha||"").localeCompare(T.fecha||"")),r=e.map(_=>_.fecha||""),s=e.map(_=>Number(_.valorTotal||_.valor||0)),a=540,i=140,n=Math.max(1,...s),d=Math.min(...s),l=n-d||1,c=`<polyline points="${s.map((_,T)=>{const B=20+T/Math.max(1,s.length-1)*(a-40),f=i-20-(_-d)/l*(i-40);return`${B},${f}`}).join(" ")}" fill="none" stroke="#6366f1" stroke-width="2.5" stroke-linejoin="round"/>`,w=s.map((_,T)=>{const B=20+T/Math.max(1,s.length-1)*(a-40),f=i-20-(_-d)/l*(i-40);return`<circle cx="${B}" cy="${f}" r="3.5" fill="#6366f1" opacity=".9"><title>${r[T]}: $${_.toLocaleString("es-MX")}</title></circle>`}).join(""),v=r.filter((_,T)=>T===0||T===r.length-1||T%Math.ceil(r.length/6)===0).map((_,T,B)=>`<text x="${20+r.indexOf(_)/Math.max(1,r.length-1)*(a-40)}" y="${i-2}" text-anchor="middle" font-size="9" fill="#9ca3af">${_.slice(5)}</text>`).join(""),z=s[s.length-1]||0,b=s[0]||0,L=b>0?((z-b)/b*100).toFixed(1):"\u2014",D=Number(L)>=0?"#10b981":"#ef4444",U=`
    <div style="display:flex;gap:12px;margin-bottom:14px;flex-wrap:wrap;">
      <div style="flex:1;min-width:100px;background:#eff6ff;border-radius:10px;padding:10px 14px;text-align:center;">
      ...
      <div style="flex:1;min-width:100px;background:#f0fdf4;border-radius:10px;padding:10px 14px;text-align:center;">
        <div style="font-size:1.2rem;font-weight:800;color:${D};">${Number(L)>=0?"+":""}${L}%</div>
    ...
    </div>`;_mkInvModal("mkMovRecientes","\u{1F4CB} Movimientos Recientes \u2014 Inventario",a,"820px")}window.abrirMovimientosRecientes=abrirMovimientosRecientes;
