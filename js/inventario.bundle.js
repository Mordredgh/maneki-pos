...
;
"use strict";typeof window.showSection>"u"&&(window.showSection=function(t){document.querySelectorAll('section[id$="-section"], section[id$="Section"]').forEach(i=>{i.classList.add("hidden"),i.style.display=""});const e=document.getElementById(t+"-section")||document.getElementById(t+"Section");e&&e.classList.remove("hidden")}),(function(){const t={rojo:"#ef4444",roja:"#ef4444",red:"#ef4444",azul:"#3b82f6",azules:"#3b82f6",blue:"#3b82f6","azul marino":"#1e3a8a",marino:"#1e3a8a",verde:"#22c55e",green:"#22c55e",amarillo:"#eab308",amarilla:"#eab308",yellow:"#eab308",dorado:"#d97706",gold:"#d97706",negro:"#1f2937",negra:"#1f2937",black:"#1f2937",blanco:"#f9fafb",blanca:"#f9fafb",white:"#f9fafb",rosa:"#ec4899",pink:"#ec4899","rosa mexicano":"#e91e8c",morado:"#a855f7",morada:"#a855f7",violeta:"#8b5cf6",lila:"#c084fc",lavanda:"#c4b5fd",purple:"#a855f7",naranja:"#f97316",orange:"#f97316",gris:"#9ca3af",grise:"#9ca3af",gray:"#9ca3af",grey:"#9ca3af",plateado:"#94a3b8",silver:"#94a3b8",caf\u00E9:"#92400e",cafe:"#92400e",marr\u00F3n:"#92400e",marron:"#92400e",brown:"#78350f",beige:"#e5c9a0",crema:"#fef3c7",turquesa:"#06b6d4",celeste:"#7dd3fc",cian:"#22d3ee",cyan:"#22d3ee",aqua:"#22d3ee",coral:"#f87171",salmon:"#fca5a5",salm\u00F3n:"#fca5a5",oliva:"#84cc16",olive:"#65a30d",magenta:"#e879f9",fucsia:"#e879f9",fuchsia:"#e879f9",vino:"#9f1239",burgundy:"#9f1239",guinda:"#9f1239",indigo:"#6366f1","azul cielo":"#7dd3fc","azul rey":"#2563eb","azul claro":"#93c5fd","verde militar":"#4d7c0f","verde lim\xF3n":"#a3e635","verde menta":"#6ee7b7","verde oliva":"#65a30d","rojo vino":"#9f1239"},e={rojo:"\u{1F534}",roja:"\u{1F534}",red:"\u{1F534}",azul:"\u{1F535}",blue:"\u{1F535}","azul marino":"\u{1F535}",marino:"\u{1F535}",verde:"\u{1F7E2}",green:"\u{1F7E2}",amarillo:"\u{1F7E1}",amarilla:"\u{1F7E1}",yellow:"\u{1F7E1}",dorado:"\u{1F7E1}",gold:"\u{1F7E1}",negro:"\u26AB",negra:"\u26AB",black:"\u26AB",blanco:"\u26AA",blanca:"\u26AA",white:"\u26AA",rosa:"\u{1FA77}",pink:"\u{1FA77}","rosa mexicano":"\u{1FA77}",morado:"\u{1F7E3}",morada:"\u{1F7E3}",violeta:"\u{1F7E3}",lila:"\u{1F7E3}",purple:"\u{1F7E3}",naranja:"\u{1F7E0}",orange:"\u{1F7E0}",caf\u00E9:"\u{1F7E4}",cafe:"\u{1F7E4}",marr\u00F3n:"\u{1F7E4}",marron:"\u{1F7E4}",brown:"\u{1F7E4}",beige:"\u{1F7E4}",crema:"\u{1F7E1}",gris:"\u{1FA76}",plateado:"\u{1FA76}",silver:"\u{1FA76}",gray:"\u{1FA76}",grey:"\u{1FA76}",turquesa:"\u{1F535}",celeste:"\u{1F535}",cian:"\u{1F535}",cyan:"\u{1F535}",coral:"\u{1F534}",salmon:"\u{1FA77}",salm\u00F3n:"\u{1FA77}",vino:"\u{1F534}",burgundy:"\u{1F534}",guinda:"\u{1F534}",magenta:"\u{1F7E3}",fucsia:"\u{1F7E3}",fuchsia:"\u{1F7E3}",indigo:"\u{1F7E3}"},i=o=>/color|colour|color\s*\/\s*tono/i.test(o||"");window._mkColorDot=function(o,n){const r=typeof _esc=="function"?_esc:(p=>String(p||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"));if(!i(o))return`<span style="font-weight:600;">${r(n)}</span>`;const a=(n||"").toLowerCase().trim(),s=t[a],d=a==="blanco"||a==="blanca"||a==="white"||a==="crema"?"#d1d5db":"transparent";return s?`<span style="display:inline-flex;align-items:center;gap:5px;font-weight:600;">
            <span style="display:inline-block;width:14px;height:14px;border-radius:50%;background:${s};border:1.5px solid ${d};flex-shrink:0;"></span>${r(n)}</span>`:`<span style="display:inline-flex;align-items:center;gap:5px;font-weight:600;">
            <span style="display:inline-block;width:14px;height:14px;border-radius:50%;background:${n.startsWith("#")||/^(rgb|hsl)/.test(n)?n:"#d1d5db"};border:1.5px solid #e5e7eb;flex-shrink:0;"></span>${r(n)}</span>`},window._mkColorEmoji=function(o,n){if(!i(o))return n;const r=(n||"").toLowerCase().trim(),a=e[r];return a?`${a} ${n}`:n}})(),window._normSearch=function(e){return String(e||"").toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"")},window._money=function(t){return Math.round((parseFloat(t)||0)*100)/100},window._sumLineas=function(t,e,i){return e=e||"price",i=i||"quantity",t.reduce((o,n)=>{const r=Math.round((parseFloat(n[e])||0)*100)*(parseInt(n[i])||1);return o+r},0)/100},window._ajustarStockId=window._ajustarStockId??null,window.currentVariants=window.currentVariants??[],window.currentProductImage=window.currentProductImage??null,window.currentProductImageFile=window.currentProductImageFile??null,window.modoEdicion=window.modoEdicion??!1,window.edicionProductoId=window.edicionProductoId??null,window._invSortCol=window._invSortCol??null,window._invSortDir=window._invSortDir??"asc",window._invCurrentPage=window._invCurrentPage??1,window._invPageSize=window._invPageSize??10,window.stockMovements=window.stockMovements??window.stockMovimientos??[],window._kitComponentes=window._kitComponentes??[];function saveStockMovements(){window.stockMovimientos=window.stockMovements,sbSave("stockMovimientos",window.stockMovements)}function registrarMovimiento({productoId:t,productoNombre:e,tipo:i,cantidad:o,motivo:n,stockAntes:r,stockDespues:a}){const s=mkId(),d=new Date().toISOString();window.stockMovements.unshift({id:s,fecha:(typeof _fechaHoy=="function"?_fechaHoy():new Date().toISOString().split("T")[0])+"T"+new Date().toLocaleTimeString("es-MX"),productoId:t,productoNombre:e,tipo:i,cantidad:o,motivo:n||"",stockAntes:r,stockDespues:a}),window.stockMovements.length>500&&(window.stockMovements.splice(500),window.stockMovimientos=window.stockMovements),saveStockMovements(),typeof db<"u"&&db&&db.from("stock_movements").insert({id:s,producto_id:String(t),producto_nombre:e||null,tipo:i,cantidad:o,motivo:n||null,stock_antes:r!=null?Number(r):null,stock_despues:a!=null?Number(a):null,fecha:d}).then(({error:p})=>{p&&console.warn("[Stock] Fallo insert stock_movements:",p.message)})}window.registrarMovimiento=registrarMovimiento,typeof _esc>"u"&&(window._esc=function(t){return t==null?"":String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")});function _genId(){return"p"+mkId().replace(/-/g,"")}function getStockEfectivo(t){const e=t.variants&&t.variants.length>0,i=t.mpComponentes&&t.mpComponentes.length>0;function o(){if(t.mpComponentes.every(a=>{const s=(window.products||[]).find(d=>String(d.id)===String(a.id));return s&&s.tipo==="servicio"}))return 0;let r=1/0;return t.mpComponentes.forEach(a=>{const s=(window.products||[]).find(d=>String(d.id)===String(a.id));if(s&&s.tipo!=="servicio"){const d=parseFloat(s.stock)||0,p=parseFloat(a.qty)||1,c=parseFloat(a.rendimientoPorHoja)||1,l=Math.floor(d/p*c);l<r&&(r=l)}}),r===1/0?0:r}if(e){const n=t.variants.reduce((r,a)=>r+(parseInt(a.qty)||0),0);return i?n+o():n}if(i){if(t.mpComponentes.every(s=>{const d=(window.products||[]).find(p=>String(p.id)===String(s.id));return d&&d.tipo==="servicio"}))return parseInt(t.stock)||0;const r=parseInt(t.stock)||0,a=o();return r+a}return parseInt(t.stock)||0}window.getStockEfectivo=getStockEfectivo;function _normVariante(t){return(t||"").replace(/\s*:\s*/g,":").trim().toLowerCase()}window._normVariante=_normVariante;function mostrarListaCompras(t){t||(window._listaComprasChecked={});const e=["confirmado","pago","produccion","envio","salida","retirar"],i=(window.pedidos||[]).filter(a=>e.includes(a.status)&&!a.inventarioDescontado),o={};i.forEach(a=>{(a.productosInventario||[]).forEach(s=>{const d=(s.id||s.name)+"|"+(s.variante||s.variant||"");(s.id||s.name)&&(o[d]||(o[d]={id:s.id,nombre:s.name||s.nombre,variante:s.variante||s.variant||"",necesario:0,pedidosRef:[]}),o[d].necesario+=s.quantity||s.cantidad||1,o[d].pedidosRef.push(a.folio||a.id))})});const n=Object.values(o).map(a=>{const s=(window.products||[]).find(c=>String(c.id)===String(a.id));let d=0;if(s)if(a.variante){const c=(s.variants||[]).find(l=>_normVariante(l.value)===_normVariante(a.variante)||_normVariante(`${l.type}:${l.value}`)===_normVariante(a.variante));d=c?c.qty||0:getStockEfectivo(s)}else d=typeof getStockEfectivo=="function"?getStockEfectivo(s):s.stock||0;const p=Math.max(0,a.necesario-d);return{...a,disponible:d,faltan:p}}).sort((a,s)=>s.faltan-a.faltan);n.forEach(a=>{const s=(window.products||[]).find(d=>String(d.id)===String(a.id));a.costoUnit=s&&parseFloat(s.cost)||0,a.costoTotal=a.faltan*a.costoUnit});const r=document.getElementById("listaComprasContent");if(r){if(n.length===0)r.innerHTML='<p style="color:#9ca3af;text-align:center;padding:32px 0;font-size:.875rem;">No hay pedidos activos con materiales asignados.</p>';else{const a=n.filter(c=>c.faltan>0),s=n.filter(c=>c.faltan===0);let d="";if(a.length>0){const c=a.reduce((l,m)=>l+m.costoTotal,0);d+=`<p style="font-size:.7rem;font-weight:800;color:#b45309;text-transform:uppercase;letter-spacing:.08em;margin-bottom:8px;">\u26A0\uFE0F Necesitas comprar (${a.length})</p>`,d+=`<table style="width:100%;border-collapse:collapse;font-size:.78rem;margin-bottom:4px;">
                ...
                </tr></thead><tbody>`,a.forEach(l=>{const m=(l.id||l.nombre)+"|"+(l.variante||""),u=!!window._listaComprasChecked[m],g=u?"background:#f0fdf4;text-decoration:line-through;color:#6b7280;":"background:#fef3c7;",x=m.replace(/\\/g,"\\\\").replace(/'/g,"\\'"),w=(window.products||[]).find(b=>String(b.id)===String(l.id)),f=w&&w.proveedorUrl?w.proveedorUrl.trim():"",y=f?`<a href="${_esc(f)}" target="_blank" rel="noopener noreferrer" style="display:inline-block;margin-top:3px;font-size:.65rem;padding:2px 6px;border-radius:999px;background:#dbeafe;color:#1d4ed8;text-decoration:none;font-weight:700;">\u{1F6D2} Comprar</a>`:"";d+=`<tr style="${g}border-bottom:1px solid #fde68a;">
                ...
                </tr>`}),d+=`</tbody><tfoot><tr style="background:#fef9c3;font-weight:800;color:#b45309;">
                <td colspan="5" style="padding:8px 8px;text-align:right;font-size:.78rem;">\u{1F4B0} Total estimado:</td>
                <td style="padding:8px 6px;text-align:right;font-size:.85rem;">$${c.toFixed(2)}</td>
                <td></td>
            </tr></tfoot></table>`}s.length>0&&(d+=`<p style="font-size:.7rem;font-weight:800;color:#16a34a;text-transform:uppercase;letter-spacing:.08em;margin:16px 0 8px;">\u2705 Stock suficiente (${s.length})</p>`,d+=s.map(c=>`
                <div style="display:flex;justify-content:space-between;align-items:center;padding:8px 14px;border-radius:10px;background:#f0fdf4;border:1px solid #bbf7d0;margin-bottom:4px;">
                    <p style="font-size:.8rem;font-weight:600;color:#374151;">${_esc(c.nombre)}${c.variante?` <span style="font-weight:400;color:#6b7280;">(${_esc(c.variante)})</span>`:""}</p>
                    <p style="font-size:.78rem;color:#16a34a;font-weight:700;">Stock: ${c.disponible} / Necesitas: ${c.necesario}</p>
                </div>`).join("")),a.length===0&&(d='<p style="color:#16a34a;text-align:center;padding:12px 0;font-size:.9rem;font-weight:700;">\u2705 Tienes stock suficiente para todos los pedidos activos.</p>'+d),a.length>0&&(d+=`<div style="display:flex;gap:8px;margin-top:14px;flex-wrap:wrap;">
            ...
            </div>`);const p=(window.products||[]).filter(c=>(!c.tipo||c.tipo==="producto"||c.tipo==="producto_interno"||c.tipo==="pack")&&Array.isArray(c.mpComponentes)&&c.mpComponentes.length>0).map(c=>({prod:c,producibles:typeof calcularProducibles=="function"?calcularProducibles(c)??0:0})).sort((c,l)=>l.producibles-c.producibles).slice(0,5);if(p.length>0){let c=`<div style="margin-top:20px;padding:14px 16px;background:#f0fdf4;border:1.5px solid #bbf7d0;border-radius:12px;">
                ...
                <div style="display:flex;flex-direction:column;gap:6px;">`;p.forEach(({prod:l,producibles:m})=>{const u=m>=5?"#16a34a":m>=1?"#d97706":"#dc2626",g=m>=5?"#d1fae5":m>=1?"#fef3c7":"#fee2e2";c+=`<div style="display:flex;justify-content:space-between;align-items:center;padding:6px 10px;background:#fff;border-radius:8px;border:1px solid #e5e7eb;">
                ...
                </div>`}),c+="</div></div>",d+=c}r.innerHTML=d}window._lcToggleComprado=function(a){window._listaComprasChecked||(window._listaComprasChecked={}),window._listaComprasChecked[a]=!0,mostrarListaCompras(!0)},window._lcWhatsApp=function(){const a=n.filter(l=>l.faltan>0);if(!a.length)return;const s=_fechaHoy(),d=a.reduce((l,m)=>l+m.costoTotal,0);let p=`\u{1F4E6} Lista de compras Maneki Store
Fecha: ${s}
...
`:p+=`\u2022 ${m}: ${l.faltan} uds
`}),d>0&&(p+=`
\u{1F4B0} Total estimado: $${d.toFixed(2)}`);const c="https://api.whatsapp.com/send?text="+encodeURIComponent(p);window.open(c,"_blank")},window._lcExportCSV=function(){const a=n.filter(u=>u.faltan>0),s=["Producto","Variante","Cantidad requerida","Stock actual","Faltante","Costo unitario","Costo total"],d=a.map(u=>[u.nombre,u.variante||"",u.necesario,u.disponible,u.faltan,u.costoUnit.toFixed(2),u.costoTotal.toFixed(2)]);let p=s.join(",")+`
`;d.forEach(u=>{p+=u.map(g=>`"${String(g).replace(/"/g,'""')}"`).join(",")+`
`});const c=new Blob([p],{type:"text/csv;charset=utf-8;"}),l=URL.createObjectURL(c),m=document.createElement("a");m.href=l,m.download=`lista-compras-${_fechaHoy()}.csv`,m.click(),URL.revokeObjectURL(l)},openModal("listaComprasModal")}}window.mostrarListaCompras=mostrarListaCompras;function syncStockFromVariants(t){t.variants&&t.variants.length>0&&(t.stock=t.variants.reduce((e,i)=>e+(parseInt(i.qty)||0),0))}function setupImageUpload(){["productImage","mpProductImage"].forEach(t=>{const e=document.getElementById(t);!e||e._mkBound||(e._mkBound=!0,e.addEventListener("change",function(i){const o=i.target.files[0];if(!o)return;window.currentProductImageFile=o;const n=new FileReader,r=t==="mpProductImage";n.onload=a=>{const s=document.getElementById(r?"mpPreviewImg":"previewImg"),d=document.getElementById(r?"mpImagePreview":"imagePreview");s&&(s.src=a.target.result),d&&d.classList.remove("hidden")},n.readAsDataURL(o)}))})}window.setupImageUpload=setupImageUpload;function sortInventory(t){window._invSortDir=window._invSortCol===t&&window._invSortDir==="asc"?"desc":"asc",window._invSortCol=t,window._invCurrentPage=1,document.querySelectorAll(".sortable-th").forEach(e=>{e.classList.remove("asc","desc"),e.getAttribute("onclick")===`sortInventory('${t}')`&&e.classList.add(window._invSortDir)}),renderInventoryTable()}window.sortInventory=sortInventory;let _lastTelegramAlert=window._lastTelegramStockAlert||0;function _pedidosQueUsanMP(t){const e=["confirmado","pago","produccion","envio","salida","retirar","pendiente"];return(window.pedidos||[]).filter(i=>e.includes(i.status||"")?(i.productosInventario||[]).some(o=>{const n=(window.products||[]).find(r=>String(r.id)===String(o.id));return n?(n.mpComponentes||[]).some(r=>String(r.id)===String(t)):!1}):!1)}window._pedidosQueUsanMP=_pedidosQueUsanMP;function checkStockAlerts(){const t=window.products||[],e=t.filter(d=>getStockEfectivo(d)===0),i=t.filter(d=>{const p=getStockEfectivo(d);return p>0&&p<=(d.puntoReorden??d.stockMin??5)}),o=i.filter(d=>d.tipo==="materia_prima"),n=e.filter(d=>d.tipo==="materia_prima");[...n,...o].forEach(d=>{const p=_pedidosQueUsanMP(d.id);if(p.length>0){const c=p.map(l=>l.folio||l.id).slice(0,5).join(", ");manekiToastExport(`\u{1F6A8} URGENTE: "${d.name}" con stock cr\xEDtico \u2014 afecta pedidos: ${c}`,"err")}}),e.length&&manekiToastExport(`\u{1F534} ${e.length} producto(s) agotado(s)`,"warn"),i.length&&manekiToastExport(`\u26A0\uFE0F ${i.length} producto(s) con stock bajo`,"warn"),n.length?manekiToastExport(`\u{1F3ED} ${n.length} materia(s) prima(s) AGOTADAS \u2014 producci\xF3n bloqueada`,"err"):o.length&&manekiToastExport(`\u{1F3ED} ${o.length} materia(s) prima(s) con stock bajo`,"warn");const a=document.getElementById("sidebarBadgeMP");if(a){const d=o.length+n.length;d>0?(a.textContent=d,a.style.display="inline-block"):a.style.display="none"}(e.length>0||i.length>0)&&_notificarStockTelegram({agotados:e,bajos:i,mpAgotadas:n,mpBajas:o}),(n.length||o.length)&&_alertaStockWA(n,o)}window.checkStockAlerts=checkStockAlerts;async function _notificarStockTelegram({agotados:t,bajos:e,mpAgotadas:i,mpBajas:o}){const n=Date.now();if(n-_lastTelegramAlert<3600*1e3)return;window._lastTelegramStockAlert=n,_lastTelegramAlert=n;const r=window.storeConfig||{},a=r.telegramBotToken;if(!a){console.warn("Telegram: telegramBotToken no configurado, omitiendo notificaci\xF3n de stock.");return}const s=[r.telegramChatId1,r.telegramChatId2].filter(Boolean);if(!s.length)return;const d=[];t.length&&(d.push(`\u{1F534} *Agotados (${t.length}):*`),t.slice(0,10).forEach(c=>d.push(`  \u2022 ${c.name} \u2014 stock: 0`))),e.length&&(d.push(`\u26A0\uFE0F *Stock bajo (${e.length}):*`),e.slice(0,10).forEach(c=>d.push(`  \u2022 ${c.name} \u2014 stock: ${c.stock} (m\xEDn: ${c.stockMin||5})`))),i.length&&d.push(`\u{1F3ED} *MP AGOTADAS \u2014 producci\xF3n bloqueada:* ${i.map(c=>c.name).join(", ")}`);const p=`\u{1F4E6} *Alerta de inventario \u2014 Maneki Store*

${d.join(`
`)}`;for(const c of s)try{await fetch(`https://api.telegram.org/bot${a}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:c,text:p,parse_mode:"Markdown"})})}catch(l){console.warn("Telegram stock alert error:",l)}}window._notificarStockTelegram=_notificarStockTelegram;function _alertaStockWA(t,e){const i=document.getElementById("_mkStockWAAlert");i&&i.remove();const o=[];t.length&&o.push(`\u{1F534} Agotadas: ${t.map(a=>a.name).join(", ")}`),e.length&&o.push(`\u26A0\uFE0F Stock bajo: ${e.map(a=>a.name).join(", ")}`);const n=encodeURIComponent(`\u{1F3ED} *Maneki \u2014 Alerta de Inventario*
...
_Reabastece pronto para no detener producci\xF3n._`),r=document.createElement("div");r.id="_mkStockWAAlert",r.style.cssText="position:fixed;bottom:20px;right:20px;z-index:9999;background:#fff;border:2px solid #25D366;border-radius:14px;padding:14px 18px;box-shadow:0 4px 24px rgba(0,0,0,0.15);max-width:300px;font-size:13px;line-height:1.4;",r.innerHTML=`
        ...
        </button>`,document.body.appendChild(r)}window._alertaStockWA=_alertaStockWA;function exportarInventarioCSV(){const t=["SKU","Nombre","Categor\xEDa","Tipo","Costo","Precio","Stock","Stock M\xEDn","Margen%","Producibles","Proveedor","Proveedor URL","Estado","Tags","Variantes","\xDAltima actualizaci\xF3n"],e=(window.products||[]).map(a=>{const s=((window.categories||[]).find(u=>u.id===a.category)||{}).name||a.category,d=a.cost&&a.price?((a.price-a.cost)/a.price*100).toFixed(0)+"%":"",p=typeof getStockEfectivo=="function"?getStockEfectivo(a):a.stock||0,c=p===0?"Agotado":p<=(a.stockMin||5)?"Bajo Stock":"Disponible",l=typeof calcularProducibles=="function"?calcularProducibles(a)??"":"",m=a.updatedAt?new Date(a.updatedAt).toLocaleString("es-MX"):"";return[a.sku,a.name,s,a.tipo||"producto",a.cost||0,a.price||0,p,a.stockMin||5,d,l,a.proveedor||"",a.proveedorUrl||"",c,(a.tags||[]).join("; "),(a.variants||[]).map(u=>`${u.type}:${u.value}(${u.qty??0})`).join("; "),m].map(u=>`"${String(u).replace(/"/g,'""')}"`).join(",")}),i=[t.join(","),...e].join(`
...
`+e,o=new Blob(["\uFEFF"+i],{type:"text/csv;charset=utf-8;"}),n=URL.createObjectURL(o),r=document.createElement("a");r.href=n,r.download="template_inventario_maneki.csv",r.click(),URL.revokeObjectURL(n)}window.descargarTemplateCSV=descargarTemplateCSV;async function guardarSnapshotInventario(){if(!window.products||window.products.length===0){manekiToastExport("No hay productos para guardar snapshot","warn");return}window.inventarioSnapshots||(window.inventarioSnapshots=[]);const t=_fechaHoy(),e=window.inventarioSnapshots.find(o=>o.fecha===t);if(e){if(!await showConfirm(`Ya hay un snapshot del ${t}. \xBFReemplazarlo?`))return;const o=window.inventarioSnapshots.indexOf(e);window.inventarioSnapshots.splice(o,1)}const i={fecha:t,hora:new Date().toLocaleTimeString("es-MX",{hour:"2-digit",minute:"2-digit"}),totalProductos:window.products.length,valorTotal:window.products.reduce((o,n)=>o+(parseFloat(n.cost)||0)*(parseFloat(n.stock)||0),0),items:window.products.map(o=>({id:o.id,name:o.name,tipo:o.tipo||"pt",stock:o.stock||0,cost:o.cost||0,price:o.price||0,sku:o.sku||""}))};if(window.inventarioSnapshots.unshift(i),window.inventarioSnapshots=window.inventarioSnapshots.slice(0,30),typeof sbSave=="function")sbSave("inventarioSnapshots",window.inventarioSnapshots);else try{localStorage.setItem("inventarioSnapshots",JSON.stringify(window.inventarioSnapshots))}catch{}manekiToastExport(`\u{1F4F8} Snapshot guardado: ${t} \u2014 ${i.totalProductos} productos, $${i.valorTotal.toFixed(2)} en inventario`,"ok")}window.guardarSnapshotInventario=guardarSnapshotInventario;function verSnapshotsInventario(){const t=window.inventarioSnapshots||[];if(!t.length){manekiToastExport("Sin snapshots guardados a\xFAn","warn");return}const e=t.map(o=>`
    ...
    <div style="background:#fff;border-radius:20px;max-width:500px;width:100%;margin:auto;max-height:80vh;overflow-y:auto;padding:24px;">
      ...
      ${e}
    </div>`,openModal("_snapshotModal")}window.verSnapshotsInventario=verSnapshotsInventario;function exportarSnapshotCSV(t){const e=(window.inventarioSnapshots||[]).find(d=>d.fecha===t);if(!e)return;const i="nombre,tipo,sku,stock,costo,precio",o=e.items.map(d=>[d.name,d.tipo,d.sku,d.stock,d.cost,d.price].map(p=>`"${String(p||"").replace(/"/g,'""')}"`).join(",")),n="\uFEFF"+i+`
`+o.join(`
...
;
"use strict";async function guardarMateriaPrima(){const i=m=>{const E=document.getElementById(m);return E?E.value:""},e=i("mpNombre").trim(),o=parseInt(i("mpStock"))||0,n=parseInt(i("mpStockMin"))||5,r=i("mpSku").trim(),s=i("mpProveedor").trim(),t=i("mpProveedorUrl").trim(),a=i("mpUnidad")||"pza",u=i("mpNotas").trim(),d=document.getElementById("mpUsaPaquete")?.checked||!1,c=parseFloat(i("mpPaqueteCantidad"))||0,l=parseFloat(i("mpPaquetePrecio"))||0;let p=0;if(d){if(c<=0||l<=0){manekiToastExport("\u26A0\uFE0F Ingresa la cantidad y precio del paquete","warn");return}p=l/c}else p=parseFloat(i("mpCosto"))||0;if(!e){manekiToastExport("\u26A0\uFE0F El nombre es requerido","warn");return}if(p<=0){manekiToastExport("\u26A0\uFE0F El costo debe ser mayor a 0","warn");return}const w=window.modoEdicion?window.edicionProductoId:null,M=(window.products||[]).find(m=>m.name.trim().toLowerCase()===e.toLowerCase()&&String(m.id)!==String(w));if(M){manekiToastExport(`\u26A0\uFE0F Ya existe un producto llamado "${M.name}". Usa un nombre diferente o edita el existente.`,"warn");return}if(r&&!skuEsUnico(r,w)){manekiToastExport(`\u26A0\uFE0F El SKU "${r}" ya est\xE1 en uso`,"warn");return}if(window.currentProductImageFile){manekiToastExport("\u23F3 Subiendo imagen...","ok");const m=await subirImagenStorage(window.currentProductImageFile).catch(()=>null);m?window.currentProductImage=m:manekiToastExport("\u26A0\uFE0F No se pudo subir la imagen. Intenta de nuevo.","warn"),window.currentProductImageFile=null}const b=document.getElementById("mpEsEmpaque")?.checked||!1,f=[...window._mpTagsActuales||[]],v=mkId().split("-")[0].toUpperCase(),k=r||"MP-"+v,S=document.getElementById("mpUsaVariantes")?.checked||!1,y=S?[...window._mpVariantes||[]]:[],g=S?y.reduce((m,E)=>m+(parseInt(E.qty)||0),0):o;if(window.modoEdicion&&window.edicionProductoId!==null){const m=(window.products||[]).findIndex(I=>String(I.id)===String(window.edicionProductoId));if(m===-1){manekiToastExport("Error: producto no encontrado","err");return}const E=window.products[m].stock,h=window.products[m].cost||0,x=[...window.products[m].historialCostos||[]];p!==h&&x.push({fecha:new Date().toISOString(),costoAntes:h,costoNuevo:p}),window.products[m]=Object.assign({},window.products[m],{name:e,tipo:"materia_prima",cost:p,price:0,stock:g,stockMin:n,sku:k,tags:f,proveedor:s,proveedorUrl:t,unidad:a,notas:u,imageUrl:window.currentProductImage||window.products[m].imageUrl,compraPaquete:d?{cantidad:c,precio:l}:null,variants:y,usaVariantes:S,historialCostos:x,esEmpaque:b}),g!==E&&registrarMovimiento({productoId:window.edicionProductoId,productoNombre:e,tipo:"ajuste",cantidad:g-E,motivo:"Edici\xF3n",stockAntes:E,stockDespues:g}),p!==h&&_cascadeCostMP(window.edicionProductoId,p),S&&y.length>0&&_cascadeVariantesMP(window.edicionProductoId,y),saveProducts(),renderInventoryTable(),typeof updateDashboard=="function"&&updateDashboard(),closeMateriaPrimaModal(),window.MKS&&MKS.notify(),manekiToastExport("\u2705 Materia prima actualizada","ok")}else{const m={id:_genId(),name:e,tipo:"materia_prima",category:"materiales",cost:p,price:0,stock:g,stockMin:n,sku:k,tags:f,proveedor:s,proveedorUrl:t,unidad:a,notas:u,image:"\u{1F3ED}",imageUrl:window.currentProductImage||null,variants:y,usaVariantes:S,compraPaquete:d?{cantidad:c,precio:l}:null,esEmpaque:b};window.products.unshift(m),window._invCurrentPage=1,g>0&&registrarMovimiento({productoId:m.id,productoNombre:m.name,tipo:"creacion",cantidad:g,motivo:"Alta de materia prima",stockAntes:0,stockDespues:g}),saveProducts(),renderInventoryTable(),typeof updateDashboard=="function"&&updateDashboard(),closeMateriaPrimaModal(),window.MKS&&MKS.notify(),manekiToastExport("\u2705 Materia prima agregada","ok")}}window.guardarMateriaPrima=guardarMateriaPrima;function _cascadeCostMP(i,e){const o=[];(window.products||[]).forEach(t=>{if(t.tipo==="materia_prima"||t.tipo==="servicio"||!Array.isArray(t.mpComponentes)||!t.mpComponentes.length)return;const a=t.mpComponentes.find(c=>String(c.id)===String(i));if(!a)return;const u=t.cost||0;a.costUnit=e;const d=t.mpComponentes.reduce((c,l)=>c+(l.costUnit||0)*(l.qty||1),0);t.cost=Math.round(d*100)/100,t.historialPrecios||(t.historialPrecios=[]),t.historialPrecios.push({fecha:new Date().toISOString(),costoAntes:u,costoNuevo:t.cost,precioAntes:t.price,precioNuevo:t.price}),o.push(t.name)}),o.length&&manekiToastExport(`\u{1F4B0} Costo recalculado en: ${o.join(", ")}`,"ok");const n=(window.products||[]).filter(t=>(t.mpComponentes||[]).some(a=>String(a.id)===String(i))),r=new Set(n.map(t=>String(t.id))),s=(window.pedidos||[]).filter(t=>!["cancelado","finalizado"].includes(t.status||"")&&(t.productosInventario||[]).some(a=>r.has(String(a.id))));if(s.length>0){const t=s.map(a=>a.folio||a.id).join(", ");manekiToastExport(`\u{1F4A1} ${s.length} pedido(s) activo(s) usan productos afectados por este cambio de costo (${t}). Revisa sus precios.`,"warn")}}window._cascadeCostMP=_cascadeCostMP;function _cascadeVariantesMP(i,e){if(!Array.isArray(e)||!e.length)return;const o=[];(window.products||[]).forEach(n=>{n.tipo==="materia_prima"||n.tipo==="servicio"||!Array.isArray(n.mpComponentes)||!n.mpComponentes.length||n.mpComponentes.some(r=>String(r.id)===String(i))&&(n.variants=e.map(r=>{const s=(n.variants||[]).find(t=>(t.type||t.tipo)===(r.type||r.tipo)&&(t.value||t.valor)===(r.value||r.valor));return s?{...r,qty:s.qty??r.qty}:{...r}}),n.usaVariantes=!0,o.push(n.name))}),o.length&&manekiToastExport(`\u{1F3A8} Variantes sincronizadas en: ${o.join(", ")}`,"ok")}window._cascadeVariantesMP=_cascadeVariantesMP;function editProduct(i){const e=(window.products||[]).find(o=>String(o.id)===String(i));if(!e){console.warn("editProduct: no encontrado",i);return}e.tipo==="materia_prima"?(injectMpModal(),window.modoEdicion=!0,window.edicionProductoId=i,window.currentProductImage=e.imageUrl||null,window.currentProductImageFile=null,window._mpTagsActuales=[...e.tags||[]],setTimeout(()=>{const o=document.getElementById("mpForm");o&&o.reset();const n=(c,l)=>{const p=document.getElementById(c);p&&(p.value=l??"")};n("mpNombre",e.name),n("mpSku",e.sku||""),n("mpStock",e.stock||0),n("mpStockMin",e.stockMin||5),n("mpProveedor",e.proveedor||""),n("mpProveedorUrl",e.proveedorUrl||""),n("mpNotas",e.notas||""),setTimeout(()=>{const c=document.getElementById("mpUnidad");c&&(c.value=e.unidad||"pza")},10);const r=document.getElementById("mpUsaPaquete");if(e.compraPaquete&&e.compraPaquete.cantidad>0?(r&&(r.checked=!0,mpTogglePaquete()),n("mpPaqueteCantidad",e.compraPaquete.cantidad),n("mpPaquetePrecio",e.compraPaquete.precio),mpCalcCostoUnidad()):(r&&(r.checked=!1,mpTogglePaquete()),n("mpCosto",e.cost||0)),e.usaVariantes&&Array.isArray(e.variants)&&e.variants.length>0){window._mpVariantes=[...e.variants];const c=document.getElementById("mpUsaVariantes");c&&(c.checked=!0,mpToggleVariantes()),renderVariantesMp()}else _resetMpVariantesUI(),n("mpStock",e.stock||0);const s=document.getElementById("mpPreviewImg"),t=document.getElementById("mpImagePreview");e.imageUrl&&s?(s.src=e.imageUrl,t&&t.classList.remove("hidden")):t&&t.classList.add("hidden");const a=document.getElementById("mpEsEmpaque");a&&(a.checked=!!e.esEmpaque),renderMpTags();const u=document.querySelector("#mpModal h3");u&&(u.textContent="\u{1F3ED} Editar Materia Prima");const d=document.getElementById("mpSubmitBtn");d&&(d.textContent="\u{1F4BE} Guardar Cambios"),typeof openModal=="function"&&openModal("mpModal")},150)):e.tipo==="producto_variable"?(typeof injectVariableProductModal=="function"&&injectVariableProductModal(),typeof openVariableProductModal=="function"&&openVariableProductModal(i)):(injectPtModal(),window.modoEdicion=!0,window.edicionProductoId=i,window._ptVariants=Array.isArray(e.variants)?[...e.variants]:[],window._ptMpComponentes=Array.isArray(e.mpComponentes)?[...e.mpComponentes]:[],window._ptTagsActuales=[...e.tags||[]],window.currentVariants=[...window._ptVariants],window.currentProductImage=e.imageUrl||null,window.currentProductImageFile=null,window._ptGaleriaUrls=Array.isArray(e.imageUrls)?[...e.imageUrls]:[],window._ptGaleriaFiles=[],setTimeout(()=>{const o=(u,d)=>{const c=document.getElementById(u);c&&(c.value=d??"")};if(o("ptNombre",e.name),o("ptSku",e.sku||""),o("ptCosto",e.cost||0),o("ptPrecio",e.price||0),o("ptStockMin",e.stockMin??5),o("ptRendimientoPorHoja",e.rendimientoPorHoja||""),setTimeout(()=>{o("ptProveedorNombre",e.proveedorNombre||""),o("ptProveedorNotas",e.proveedorNotas||"")},200),poblarCategoriasPt(),setTimeout(()=>{const u=document.getElementById("ptCategory");u&&(u.value=e.category)},80),e.imageUrl){const u=document.getElementById("ptPreviewImg"),d=document.getElementById("ptImagePreview");u&&(u.src=e.imageUrl),d&&d.classList.remove("hidden")}ptRenderGaleria(),renderTagsPt(),renderVariantsListPt(),renderPtMpList(),recalcularCostoPt(),ptMostrarMargenInfo();const n=document.getElementById("ptPublicarTienda"),r=document.getElementById("ptToggleTrack"),s=document.getElementById("ptToggleThumb");n&&(n.checked=e.publicarTienda===!0||e.tipo==="producto",r&&(r.style.background=n.checked?"#10b981":"#d1d5db"),s&&(s.style.transform=n.checked?"translateX(22px)":"translateX(0)"));const t=document.querySelector("#ptModal h3");t&&(t.textContent="\u270F\uFE0F Editar Producto Terminado");const a=document.getElementById("ptSubmitBtn");a&&(a.textContent="\u{1F4BE} Guardar Cambios")},120),typeof openModal=="function"&&openModal("ptModal"))}window.editProduct=editProduct,document.addEventListener("DOMContentLoaded",function(){setTimeout(()=>{try{const n=localStorage.getItem("mkStockMovements");if(n){const r=JSON.parse(n);Array.isArray(r)&&r.length>0&&((!window.stockMovements||window.stockMovements.length===0)&&(window.stockMovements=r,window.stockMovimientos=r,saveStockMovements(),console.log("[Migraci\xF3n] stockMovements: "+r.length+" movimientos migrados a SQLite/Supabase.")),localStorage.removeItem("mkStockMovements"))}}catch(n){console.warn("[Migraci\xF3n] Error migrando stockMovements:",n)}},3e3),injectMpModal(),injectPtModal(),setupImageUpload(),["inventorySearch","inventoryTagFilter","inventoryTipoFilter","inventoryProveedorFilter"].forEach(n=>{function r(){const s=document.getElementById(n);s&&!s._invPagListenerAdded&&(s.addEventListener("input",()=>{window._invCurrentPage=1,renderInventoryTable()}),s.addEventListener("change",()=>{window._invCurrentPage=1,renderInventoryTable()}),s._invPagListenerAdded=!0)}r(),setTimeout(r,800),setTimeout(r,2e3)}),setTimeout(patchInventoryButtons,400);const e=document.getElementById("inventorySection")||document.querySelector('section[id*="inventor"]')||document.querySelector('[data-section="inventory"]');e&&new MutationObserver(r=>{for(const s of r)if(s.attributeName==="class"||s.attributeName==="style"){const t=s.target;!t.classList.contains("hidden")&&t.style.display!=="none"&&t.offsetParent!==null&&setTimeout(patchInventoryButtons,80)}}).observe(e,{attributes:!0});const o=document.getElementById("addProductForm");o&&!o._mkSubmitBound&&(o._mkSubmitBound=!0,o.addEventListener("submit",function(n){n.preventDefault(),openAddProductModal()}))});function patchInventoryButtons(){const i=document.querySelector('[onclick="openAddProductModal()"]');if(!i)return;const e=i.parentElement;if(i.innerHTML="\u{1F4E6} Producto Terminado",i.title="Agregar producto terminado",[{selector:'[onclick="toggleMovimientos()"]',html:"\u{1F550} Movimientos"},{selector:'[onclick="imprimirInventario()"]',html:"\u{1F5A8}\uFE0F Imprimir"},{selector:`[onclick="manekiExportar('inventario')"]`,html:"\u{1F4CA} Exportar Excel"}].forEach(({selector:n,html:r})=>{const s=document.querySelector(n);s&&(s.innerHTML=r)}),!e.querySelector("[data-mp-btn]")){const n=document.createElement("button");n.setAttribute("data-mp-btn","1"),n.onclick=()=>{injectMpModal(),openAddMateriaPrimaModal()},n.className="px-5 py-2.5 rounded-xl text-white text-sm font-semibold flex items-center gap-2",n.style.cssText="background:linear-gradient(135deg,#7c3aed,#a855f7);",n.innerHTML="\u{1F9EA} Materia Prima",n.title="Agregar materia prima",e.insertBefore(n,i)}}window.patchInventoryButtons=patchInventoryButtons;function ajustarStock(i){const e=(window.products||[]).find(l=>String(l.id)===String(i));if(!e)return;window._ajustarStockId=String(i),window.__ajustarStockIdBackup=String(i);const o=document.getElementById("ajustarStockNombre"),n=document.getElementById("ajustarStockActual"),r=document.getElementById("ajustarStockCantidad"),s=document.getElementById("ajustarStockMotivo");o&&(o.textContent=e.name),n&&(n.textContent=getStockEfectivo(e)),r&&(r.value="",setTimeout(()=>r.focus&&r.focus(),250)),s&&(s.value="");const t=document.getElementById("ajusteStockPuntoReorden");t&&(t.value=e.puntoReorden!=null?e.puntoReorden:"");const a=document.getElementById("_ajusteCostoPonderadoWrap"),u=document.getElementById("ajusteStockCostoNuevo");a&&(a.style.display="none"),u&&(u.value="");const d=document.getElementById("ajustarStockModal");d&&(d.dataset.productId=String(i)),_inyectarCamposAjusteStock(d),_renderUltimosMovimientosProducto(i,d),_renderSugerenciaReorden(e,d);const c=document.getElementById("ajustarStockCantidad");c&&!c._costoPondListener&&(c._costoPondListener=!0,c.addEventListener("input",function(){const l=document.getElementById("_ajusteCostoPonderadoWrap"),p=document.getElementById("ajusteStockCostoNuevo");l&&(l.style.display=parseInt(this.value)>0?"":"none"),p&&parseInt(this.value)<=0&&(p.value="")})),typeof openModal=="function"&&openModal("ajustarStockModal")}window.ajustarStock=ajustarStock;function _inyectarCamposAjusteStock(i){if(!i||i.querySelector("#ajusteStockMotivoSelect"))return;const e=i.querySelector(".space-y-3");if(!e)return;const o=e.querySelector("#ajusteStockPuntoReorden")?.parentElement,n=document.createElement("div");n.id="_ajusteStockExtraFields",n.innerHTML=`
        ...
        <div style="margin-top:8px;">
            ...
            <input type="text" id="ajusteStockNotasExtra" placeholder="Ej: Lote da\xF1ado por humedad"
                style="width:100%;padding:8px 12px;border:1.5px solid #e5e7eb;border-radius:10px;font-size:.85rem;outline:none;">
        </div>`,o?e.insertBefore(n,o):e.appendChild(n)}window._inyectarCamposAjusteStock=_inyectarCamposAjusteStock;function _renderUltimosMovimientosProducto(i,e){if(!e)return;if(!e.querySelector("#_ajusteUltMovimientos")){const t=e.querySelector(".bg-white");if(!t)return;const a=document.createElement("div");a.id="_ajusteUltMovimientos",a.style.cssText="margin-top:14px;border-top:1px solid #f3f4f6;padding-top:10px;",t.appendChild(a)}const n=e.querySelector("#_ajusteUltMovimientos");if(!n)return;const r=(window.stockMovements||[]).filter(t=>String(t.productoId)===String(i)).slice(0,5);if(!r.length){n.innerHTML='<p style="font-size:.72rem;color:#9ca3af;text-align:center;padding:8px 0;">Sin movimientos registrados</p>';return}const s={entrada:"\u{1F7E2}",salida:"\u{1F534}",ajuste:"\u{1F7E1}",creacion:"\u{1F535}",venta:"\u{1F7E0}",merma:"\u{1F7E4}"};n.innerHTML=`
        ...
        ${r.map(t=>{const a=new Date(t.fecha).toLocaleString("es-MX",{dateStyle:"short",timeStyle:"short"}),u=t.cantidad>=0?`+${t.cantidad}`:`${t.cantidad}`;return`<div style="display:flex;align-items:center;gap:8px;padding:5px 0;border-bottom:1px solid #f9fafb;font-size:.75rem;">
                <span style="font-size:13px;">${s[t.tipo]||"\u26AA"}</span>
                <div style="flex:1;min-width:0;">
                ...
                <span style="font-weight:700;color:${t.cantidad>=0?"#10b981":"#ef4444"};white-space:nowrap;">${u} uds</span>
            </div>`}).join("")}`}window._renderUltimosMovimientosProducto=_renderUltimosMovimientosProducto;function confirmarAjusteStock(){const i=document.getElementById("ajustarStockModal"),e=i&&i.dataset.productId||window._ajustarStockId||window.__ajustarStockIdBackup;if(!e){manekiToastExport("\u274C Error: no se encontr\xF3 el producto","err");return}const o=(window.products||[]).find(f=>String(f.id)===String(e));if(!o){manekiToastExport("\u274C Error: producto no encontrado","err");return}const n=document.getElementById("ajustarStockCantidad"),r=document.getElementById("ajustarStockMotivo"),s=document.getElementById("ajusteStockMotivoSelect"),t=document.getElementById("ajusteStockNotasExtra");if(!n){manekiToastExport("\u274C Error: formulario no disponible","err");return}const a=parseInt(n.value),u=s?s.value.trim():"",d=r?r.value.trim():"",c=u||d||"",l=t?t.value.trim():"";if(isNaN(a)||n.value.trim()===""){manekiToastExport("\u26A0\uFE0F Ingresa una cantidad v\xE1lida (+para agregar / -para restar)","warn"),n.focus&&n.focus();return}const p=getStockEfectivo(o),w=parseInt(o.stock)||0;if(o.stock=Math.max(0,w+a),a>0){const f=document.getElementById("ajusteStockCostoNuevo");if(f&&f.value.trim()!==""){const v=parseFloat(f.value);if(!isNaN(v)&&v>0){const k=Number(o.cost||o.costo||0),S=w+a;o.cost=S>0?(w*k+a*v)/S:v,o.cost=Math.round(o.cost*100)/100;const y=(window.products||[]).findIndex(g=>String(g.id)===String(o.id));if(y>=0){const g=[...window.products[y].historialCostos||[]];g.push({fecha:new Date().toISOString(),costoAntes:k,costoNuevo:o.cost,motivo:"Promedio ponderado"}),window.products[y].historialCostos=g,o.historialCostos=g}}}}if(o.variants&&o.variants.length>0&&a!==0){if(a>0)o.variants[0].qty=(o.variants[0].qty||0)+a;else{let f=Math.abs(a);for(const v of o.variants){const k=Math.min(v.qty||0,f);if(v.qty=(v.qty||0)-k,f-=k,f<=0)break}}syncStockFromVariants(o)}const M=getStockEfectivo(o);registrarMovimiento({productoId:o.id,productoNombre:o.name,tipo:a>=0?"entrada":"salida",cantidad:a,motivo:c,stockAntes:p,stockDespues:M});const b=document.getElementById("ajusteStockPuntoReorden");if(b&&b.value.trim()!==""){const f=parseInt(b.value);!isNaN(f)&&f>=0&&(o.puntoReorden=f)}saveProducts(),renderInventoryTable(),typeof updateDashboard=="function"&&updateDashboard(),typeof closeModal=="function"&&closeModal("ajustarStockModal"),window._ajustarStockId=null,window.__ajustarStockIdBackup=null,i&&delete i.dataset.productId,window.MKS&&MKS.tick(),manekiToastExport(`\u2705 Stock de "${o.name}": ${p} \u2192 ${M}`,"ok")}window.confirmarAjusteStock=confirmarAjusteStock;function closeAjustarStockModal(){if(typeof closeModal=="function")closeModal("ajustarStockModal");else{const e=document.getElementById("ajustarStockModal");e&&(e.style.display="none")}window._ajustarStockId=null,window.__ajustarStockIdBackup=null;const i=document.getElementById("ajustarStockModal");i&&delete i.dataset.productId}window.closeAjustarStockModal=closeAjustarStockModal;function _renderSugerenciaReorden(i,e){if(!e)return;let o=e.querySelector("#_sugerenciaReorden");if(!o){const c=e.querySelector(".bg-white")||e.querySelector(".space-y-3")?.parentElement;if(!c)return;o=document.createElement("div"),o.id="_sugerenciaReorden",o.style.cssText="margin-top:12px;padding:10px 12px;background:#FFFBEB;border:1px solid #FDE68A;border-radius:12px;",c.appendChild(o)}const n=(window.salesHistory||[]).filter(c=>{if(!c.date||c.method==="Cancelado")return!1;const l=new Date;l.setDate(l.getDate()-30);const p=`${l.getFullYear()}-${String(l.getMonth()+1).padStart(2,"0")}-${String(l.getDate()).padStart(2,"0")}`;return c.date>=p});let r=0;n.forEach(c=>{(c.products||[]).forEach(l=>{(String(l.id)===String(i.id)||(l.name||"").toLowerCase()===(i.name||"").toLowerCase())&&(r+=Number(l.quantity||1))})});const s=r/30,t=i.leadTime||7,a=Math.ceil(s*3),u=Math.ceil(s*t)+a,d=Math.max(0,Math.ceil(s*30)-(getStockEfectivo(i)||0));if(r===0){o.innerHTML='<p style="font-size:.75rem;color:#92400E;margin:0;">\u{1F4CA} Sin ventas en los \xFAltimos 30 d\xEDas \u2014 no hay datos para sugerir reorden.</p>';return}o.innerHTML=`
        ...
        </div>`}function aplicarMargen(i){if(!i||isNaN(i)||i<=0){manekiToastExport("Margen inv\xE1lido","err");return}const e=parseFloat(document.getElementById("productCost").value);if(!e||e<=0){manekiToastExport("Primero ingresa el costo","warn");return}const o=e/(1-i/100);document.getElementById("productPrice").value=o.toFixed(2);const n=document.getElementById("precioSugeridoLabel");n&&(n.textContent=`\u{1F4A1} Con ${i}% de margen: costo $${e.toFixed(2)} \u2192 precio $${o.toFixed(2)} (ganancia $${(o-e).toFixed(2)})`)}window.aplicarMargen=aplicarMargen;async function cambiarTipoProducto(i){const e=(window.products||[]).find(s=>String(s.id)===String(i));if(!e)return;const o=(e.tipo||"producto")==="materia_prima",n=o?"producto":"materia_prima",r=o?"Producto Terminado \u{1F4E6}":"Materia Prima \u{1F3ED}";if(!o){const s=(window.pedidos||[]).filter(t=>!["cancelado","finalizado"].includes(t.status||"")&&(t.productosInventario||[]).some(a=>String(a.id)===String(i)));if(s.length>0){const t=s.map(u=>u.folio||u.id).join(", ");if(!await showConfirm(`\u26A0\uFE0F "${e.name}" est\xE1 en ${s.length} pedido(s) activo(s):
${t}
...
${o?"Se habilitar\xE1 precio de venta y variantes.":"Se ocultar\xE1 precio de venta. Solo se usar\xE1 el costo."}`,`Convertir a ${r}`).then(s=>{s&&(e.tipo=n,n==="materia_prima"?(e.price=0,e.variants=[]):(!e.price||e.price<=0)&&(e.price=(e.cost||0)*2),saveProducts(),renderInventoryTable(),manekiToastExport(`\u2705 "${e.name}" ahora es ${r}`,"ok"))})}window.cambiarTipoProducto=cambiarTipoProducto;async function deleteProduct(i){const e=(window.products||[]).find(t=>String(t.id)===String(i));if(!e)return;const o=(window.pedidos||[]).filter(t=>!["cancelado","finalizado"].includes(t.status||"")&&(t.productosInventario||[]).some(a=>String(a.id)===String(i)));if(o.length>0){const t=o.map(u=>u.folio||u.id).join(", ");if(!await showConfirm(`\u26A0\uFE0F Este producto est\xE1 en ${o.length} pedido(s) activo(s):
${t}

Eliminar puede romper esos pedidos. \xBFContinuar de todas formas?`))return}const n=(window.products||[]).filter(t=>t.isKit&&t.kitComponentes&&t.kitComponentes.some(a=>String(a.id)===String(i))),r=o;let s=`\xBFEliminar "${e.name}"?`;e.stock>0&&(s+=`

Tiene ${e.stock} unidades en stock.`),n.length&&(s+=`

\u26A0\uFE0F Es componente de ${n.length} kit(s): ${n.map(t=>t.name).join(", ")}.`),r.length&&(s+=`

\u{1F6A8} Est\xE1 en ${r.length} pedido(s) activo(s): ${r.map(t=>t.folio||t.id).join(", ")}. Eliminar el producto puede afectar esos pedidos.`),s+=`

Esta acci\xF3n no se puede deshacer.`,showConfirm(s,"\u{1F5D1}\uFE0F Eliminar producto permanentemente").then(async t=>{if(!t)return;window.MKS&&MKS.del();const a=JSON.parse(JSON.stringify(e)),u=window.products.findIndex(d=>String(d.id)===String(i));typeof window.mkPushUndo=="function"&&(window.mkPushUndo(`Eliminar "${e.name}"`,()=>{window.products.some(d=>String(d.id)===String(a.id))||(window.products.splice(u,0,a),typeof saveProducts=="function"&&saveProducts(),typeof renderInventoryTable=="function"&&renderInventoryTable(),typeof window._rebuildProductMap=="function"&&window._rebuildProductMap())}),typeof window.mkMostrarUndoHint=="function"&&window.mkMostrarUndoHint(`Eliminar "${e.name}"`)),window.products=window.products.filter(d=>String(d.id)!==String(i));try{products=window.products}catch{}saveProducts(),renderInventoryTable(),typeof updateDashboard=="function"&&updateDashboard();try{await db.from("products").delete().eq("id",String(i))}catch(d){console.warn("deleteProduct: no se pudo borrar de products:",d)}manekiToastExport(`\u{1F5D1}\uFE0F "${e.name}" eliminado`,"ok")})}window.deleteProduct=deleteProduct;function calcularDisponibilidadDesdeMP(i,e,o){if(!i.mpComponentes||i.mpComponentes.length===0)return null;const n=e||window.productMap,r=n?d=>n.get(String(d)):d=>(window.products||[]).find(c=>String(c.id)===String(d)),s=o?d=>o.get(String(d.id))??(typeof getStockEfectivo=="function"?getStockEfectivo(d):parseInt(d.stock)||0):d=>typeof getStockEfectivo=="function"?getStockEfectivo(d):parseInt(d.stock)||0;if(!i.mpComponentes.some(d=>{const c=r(d.id);return!c||c.tipo!=="servicio"}))return null;let a=1/0;const u=[];for(const d of i.mpComponentes){const c=r(d.id);if(c&&c.tipo==="servicio")continue;if(!c){i._tieneComponentesHuerfanos=!0;continue}const l=s(c),p=d.qty||1,w=Math.floor(l/p);u.push({nombre:d.nombre||(c?c.name:"?"),stock:l,qty:p,posibles:w}),w<a&&(a=w)}return{piezas:a===1/0?0:a,detalle:u}}window.calcularDisponibilidadDesdeMP=calcularDisponibilidadDesdeMP;async function _mkEditLeadTime(i,e){const o=document.getElementById("_mkLeadTimeModal");o&&o.remove();const n=document.createElement("div");n.id="_mkLeadTimeModal",n.innerHTML=`
...
;
"use strict";function _levenshtein(t,o){const r=t.length,s=o.length,a=Array.from({length:r+1},(i,n)=>Array.from({length:s+1},(l,d)=>d===0?n:0));for(let i=1;i<=s;i++)a[0][i]=i;for(let i=1;i<=r;i++)for(let n=1;n<=s;n++)a[i][n]=t[i-1]===o[n-1]?a[i-1][n-1]:1+Math.min(a[i-1][n],a[i][n-1],a[i-1][n-1]);return a[r][s]}window._levenshtein=_levenshtein;function _fuzzyMatch(t,o,r=2){return t=t.toLowerCase().trim(),o=o.toLowerCase(),!t||o.includes(t)?!0:o.split(/[\s,.-]+/).some(a=>{const i=a.substring(0,t.length+2);return i.length>=t.length-1&&_levenshtein(t,i)<=r})}window._fuzzyMatch=_fuzzyMatch;function calcularProducibles(t){if(!Array.isArray(t.mpComponentes)||t.mpComponentes.length===0)return null;let o=1/0;for(const r of t.mpComponentes){const s=(window.products||[]).find(n=>String(n.id)===String(r.id));if(!s)return 0;const a=typeof getStockEfectivo=="function"?getStockEfectivo(s):s.stock||0,i=parseFloat(r.qty)||1;o=Math.min(o,Math.floor(a/i))}return o===1/0?0:o}window.calcularProducibles=calcularProducibles;function abrirBulkPrecioModal(){let t=document.getElementById("bulkPrecioModal");t||(t=document.createElement("div"),t.id="bulkPrecioModal",t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;",t.addEventListener("click",s=>{s.target===t&&(t.style.display="none")}),document.body.appendChild(t));const r=[...new Set((window.products||[]).map(s=>s.category).filter(Boolean))].map(s=>{const a=(window.categories||[]).find(i=>String(i.id)===String(s));return`<option value="${_esc(s)}">${_esc(a?a.emoji?a.emoji+" "+a.name:a.name:s)}</option>`}).join("");t.innerHTML=`
    <div style="background:#fff;border-radius:20px;width:min(540px,95vw);max-height:88vh;overflow:hidden;display:flex;flex-direction:column;box-shadow:0 20px 60px rgba(0,0,0,0.25);">
        ...
        <div style="padding:16px 24px;border-top:1px solid #f3f4f6;display:flex;gap:8px;justify-content:flex-end;">
    ...
    </div>`,t.style.display="flex",bulkPrecioPreview()}window.abrirBulkPrecioModal=abrirBulkPrecioModal;function _bulkPrecioGetAfectados(){const t=parseFloat(document.getElementById("bulkPrecioNum")?.value)||0,o=document.getElementById("bulkPrecioSoloPT")?.checked||!1,r=document.getElementById("bulkPrecioSoloMP")?.checked||!1,s=(document.getElementById("bulkPrecioCat")?.value||"").trim();return(window.products||[]).filter(a=>s&&String(a.category)!==s?!1:o&&r?!0:!(o&&!(!a.tipo||a.tipo==="producto"||a.tipo==="producto_interno"||a.tipo==="pack")||r&&a.tipo!=="materia_prima")).map(a=>{const i=r&&!o?"cost":"price",n=parseFloat(a[i])||0,l=Math.max(0,Math.round(n*(1+t/100)*100)/100);return{p:a,campoKey:i,precioActual:n,precioNuevo:l}}).filter(a=>a.precioActual>0)}function bulkPrecioPreview(){const t=document.getElementById("bulkPrecioPreviewList");if(!t)return;const o=_bulkPrecioGetAfectados();if(!o.length){t.innerHTML='<p style="font-size:.78rem;color:#9ca3af;text-align:center;padding:16px;">Sin productos que coincidan con los filtros</p>';return}t.innerHTML=o.slice(0,50).map(({p:r,campoKey:s,precioActual:a,precioNuevo:i})=>{const n=i-a,l=n>0?"#16a34a":n<0?"#dc2626":"#6b7280",d=s==="cost"?"Costo":"Precio";return`<div style="display:flex;justify-content:space-between;align-items:center;padding:6px 8px;border-bottom:1px solid #f3f4f6;font-size:.78rem;">
            ...
            <span style="color:#6b7280;white-space:nowrap;margin:0 8px;">${d}: $${a.toFixed(2)}</span>
            <span style="font-weight:700;color:${l};white-space:nowrap;">\u2192 $${i.toFixed(2)}</span>
        </div>`}).join("")+(o.length>50?`<p style="font-size:.72rem;color:#9ca3af;text-align:center;padding:8px;">...y ${o.length-50} m\xE1s</p>`:"")}window.bulkPrecioPreview=bulkPrecioPreview;async function bulkPrecioAplicar(){const t=_bulkPrecioGetAfectados();if(!t.length){manekiToastExport("Sin productos que actualizar","warn");return}bulkPrecioPreview();const o=parseFloat(document.getElementById("bulkPrecioNum")?.value)||0,r=document.getElementById("bulkPrecioSoloMP")?.checked&&!document.getElementById("bulkPrecioSoloPT")?.checked?"costo":"precio",s=o>0?"+":"",a=t.slice(0,5).map(({p:i,precioActual:n,precioNuevo:l})=>`<div style="display:flex;justify-content:space-between;font-size:.8rem;padding:3px 0;border-bottom:1px solid #f3f4f6;">
            ...
            <span style="font-weight:700;color:${l>n?"#16a34a":"#dc2626"};">\u2192 $${l.toFixed(2)}</span>
                ...
                ${a}
             </div>`,"\u2705 Confirmar cambio masivo").then(i=>{i&&(t.forEach(({p:n,campoKey:l,precioNuevo:d})=>{n[l]=d,n.updatedAt=new Date().toISOString()}),typeof saveProducts=="function"&&saveProducts(),renderInventoryTable(),document.getElementById("bulkPrecioModal").style.display="none",manekiToastExport(`\u2705 Precios actualizados en ${t.length} producto(s)`,"ok"))});else{if(!await showConfirm(`\xBFAplicar ${s}${o}% a ${t.length} producto(s)? Ver preview arriba.`))return;t.forEach(({p:i,campoKey:n,precioNuevo:l})=>{i[n]=l,i.updatedAt=new Date().toISOString()}),typeof saveProducts=="function"&&saveProducts(),renderInventoryTable(),document.getElementById("bulkPrecioModal").style.display="none",manekiToastExport(`\u2705 Precios actualizados en ${t.length} producto(s)`,"ok")}}window.bulkPrecioAplicar=bulkPrecioAplicar;function renderInventoryTable(){const t=document.getElementById("inventoryTable");if(!t)return;const o=window.products||[],r=document.getElementById("inventoryTipoFilter")?.value||"",s=o.length+"_"+o.reduce((e,x)=>e+Number(x.stock||0),0).toFixed(0)+"_"+(document.getElementById("inventorySearch")?.value||"")+"_"+r,a=document.getElementById("invDualContainer");if(a&&a._lastHash===s)return;a&&(a._lastHash=s);let i=document.getElementById("invDualContainer");if(!i){const e=t.closest('table, .overflow-x-auto, [class*="overflow"]')||t.parentElement;i=document.createElement("div"),i.id="invDualContainer",i.style.cssText="display:flex;flex-direction:column;gap:0;",e.parentNode.insertBefore(i,e),e.style.display="none"}const n=window.products||[],l=new Map(n.map(e=>[String(e.id),typeof getStockEfectivo=="function"?getStockEfectivo(e):parseInt(e.stock)||0]));window._invStockCache=l;const d=window.productMap||new Map(n.map(e=>[String(e.id),e])),g=new Map;for(const e of n)e.mpComponentes&&e.mpComponentes.length>0&&g.set(String(e.id),calcularDisponibilidadDesdeMP(e,d,l));if(typeof poblarFiltroProveedores=="function"&&poblarFiltroProveedores(),!document.getElementById("invExtraColStyles")){const e=document.createElement("style");e.id="invExtraColStyles",e.textContent=`
        ...
        </div>`;return}const h=(document.getElementById("inventorySearch")||{}).value?.trim().toLowerCase()||"",w=(document.getElementById("inventoryTagFilter")||{}).value||"",I=(document.getElementById("inventoryProveedorFilter")||{}).value?.trim().toLowerCase()||"";function b(e){const x=window._normSearch||(y=>String(y||"").toLowerCase()),f=x(h),k=x(I),$=y=>!w||y.tags&&y.tags.includes(w),S=y=>!I||x(y.proveedor||"").includes(k);if(!h)return e.filter(y=>$(y)&&S(y));const E=e.filter(y=>(x(y.name).includes(f)||x(y.sku||"").includes(f)||x(y.proveedor||"").includes(f)||x(y.notas||"").includes(f)||(y.tags||[]).some(W=>x(W).includes(f)))&&$(y)&&S(y));return E.length>0?E:e.filter(y=>(_fuzzyMatch(f,y.name||"")||_fuzzyMatch(f,y.sku||"")||_fuzzyMatch(f,y.proveedor||""))&&$(y)&&S(y))}const L=b(n.filter(e=>e.tipo==="materia_prima")),O=b(n.filter(e=>e.tipo==="servicio")),G=b(n.filter(e=>e.tipo==="producto_variable")),M=b(n.filter(e=>!e.tipo||e.tipo==="producto"||e.tipo==="producto_interno"||e.tipo==="pack"));function C(e){if(!window._invSortCol)return e;const x=window._invSortCol,f=window._invSortDir;return[...e].sort((k,$)=>{let S,E;return x==="name"?(S=(k.name||"").toLowerCase(),E=($.name||"").toLowerCase()):x==="sku"?(S=(k.sku||"").toLowerCase(),E=($.sku||"").toLowerCase()):x==="category"?(S=(k.category||"").toLowerCase(),E=($.category||"").toLowerCase()):x==="price"?(S=Number(k.price)||0,E=Number($.price)||0):x==="stock"?(S=Number(k.stock)||0,E=Number($.stock)||0):x==="margin"&&(S=k.cost&&k.price?(k.price-k.cost)/k.price:-1,E=$.cost&&$.price?($.price-$.cost)/$.price:-1),S<E?f==="asc"?-1:1:S>E?f==="asc"?1:-1:0})}function B(e,x){const f=String(e.id),k=l.get(f)??(typeof getStockEfectivo=="function"?getStockEfectivo(e):parseInt(e.stock)||0),$=e.imageUrl?`<img src="${e.imageUrl}" alt="${_esc(e.name||"")}" style="width:40px;height:40px;object-fit:cover;border-radius:8px;" loading="lazy">`:`<span style="font-size:1.6rem;">${e.image||"\u{1F3ED}"}</span>`;let S;k===0?S='<span class="badge-danger">Agotado</span>':k<=(e.stockMin||5)?S='<span class="badge-warning">Bajo Stock</span>':S='<span class="badge-success">Disponible</span>';const E=(window.categories||[]).find(F=>F.id===e.category),y=E?E.name:e.category||"";return`
        ...
        </tr>`}function u(e,x){const f=String(e.id),k=`<span style="font-size:1.6rem;">${e.image||"\u2699\uFE0F"}</span>`;return`
        <tr style="animation:mkSectionIn 0.3s ease both;animation-delay:${x*.03}s" class="hover:bg-indigo-50">
            ...
            <td class="px-2 py-3">
        ...
        </tr>`}function v(e,x){const f=String(e.id),k=e.imageUrl?`<img src="${e.imageUrl}" alt="${_esc(e.name||"")}" style="width:40px;height:40px;object-fit:cover;border-radius:8px;" loading="lazy">`:`<span style="font-size:1.6rem;">${e.image||"\u{1F4E6}"}</span>`,$=(window.categories||[]).find(m=>m.id===e.category),S=$?$.name:e.category||"",E=g.get(f)??null;let y,F;if(E!==null){const m=E.piezas,T=m===0?"#ef4444":m<=3?"#f59e0b":"#10b981",A=m===0?"#fee2e2":m<=3?"#fef3c7":"#d1fae5",H=E.detalle.map(V=>`${V.nombre}: ${V.stock}\xF7${V.qty}=${V.posibles}pzs`).join(" | ");y=`
                <div style="display:flex;flex-direction:column;align-items:flex-start;gap:2px;">
                    <span title="${_esc(H)}"
                        style="padding:3px 12px;border-radius:8px;background:${A};color:${T};
                               font-weight:700;font-size:.95rem;border:1px solid ${T}33;cursor:help;">
                        ${m}
                    </span>
                    <span style="font-size:10px;color:#6b7280;">desde MP</span>
                </div>`,F=m===0?'<span class="badge-danger">Sin stock MP</span>':m<=3?'<span class="badge-warning">MP bajo</span>':'<span class="badge-success">Disponible</span>'}else{const m=l.get(String(e.id))??(typeof getStockEfectivo=="function"?getStockEfectivo(e):e.stock||0),T=e.stockMin||5,A=m===0?"#ef4444":m<=T?"#f59e0b":"#10b981";y=`<span style="padding:3px 12px;border-radius:8px;background:${m===0?"#fee2e2":m<=T?"#fef3c7":"#d1fae5"};color:${A};font-weight:700;font-size:.95rem;">${m}</span>`,F=m===0?'<span style="background:#fee2e2;color:#ef4444;padding:2px 10px;border-radius:8px;font-size:.75rem;font-weight:700;">Agotado</span>':m<=T?'<span style="background:#fef3c7;color:#f59e0b;padding:2px 10px;border-radius:8px;font-size:.75rem;font-weight:700;">Bajo Stock</span>':'<span style="background:#d1fae5;color:#10b981;padding:2px 10px;border-radius:8px;font-size:.75rem;font-weight:700;">Disponible</span>'}const W=e.variants&&e.variants.length>0?e.variants.map(m=>`
                <span style="display:inline-flex;align-items:center;gap:3px;padding:2px 7px;background:#f3f4f6;border-radius:8px;font-size:11px;margin:1px;">
                    <b>${_esc(m.type)}:</b>${_mkColorDot(m.type,_esc(m.value))}
                    <span style="background:#e0f2fe;color:#0369a1;padding:0 4px;border-radius:99px;font-weight:600;">${m.qty??0}</span>
                </span>`).join(""):'<span class="text-xs text-gray-400">Sin variantes</span>',U=Number(e.cost)||0,ee=Number(e.price)||0,Y=U&&ee?(()=>{const m=(ee-U)/ee*100,T=m>=40?"#10b981":m>=20?"#f59e0b":"#ef4444";return`<div style="min-width:56px;">
                    <div style="font-weight:600;font-size:13px;color:${T};">${m.toFixed(0)}%</div>
                    <div style="height:4px;background:#e5e7eb;border-radius:99px;overflow:hidden;margin-top:2px;">
                        <div style="height:100%;width:${Math.min(100,m).toFixed(0)}%;background:${T};border-radius:99px;"></div>
        ...
        <tr style="animation:mkSectionIn 0.3s ease both;animation-delay:${x*.03}s" class="hover:bg-amber-50">
            ...
            <td class="px-4 py-3">
                <div>
                    ...
                    ${e.tipo==="pack"&&e.packComponentes&&e.packComponentes.length?`<div style="font-size:.72rem;color:#9ca3af;margin-top:2px;">${e.packComponentes.map(m=>`${m.qty>1?m.qty+"\xD7 ":""}${_esc(m.nombre)}`).join(" + ")}</div>`:""}
                    ...
                    ${e.tags&&e.tags.length?`<div style="display:flex;flex-wrap:wrap;gap:2px;margin-top:2px;">${e.tags.map(m=>`<span style="padding:1px 6px;border-radius:99px;font-size:10px;background:#fef3c7;color:#92400e;border:1px solid #fde68a;">${_esc(m)}</span>`).join("")}</div>`:""}
                    ${(()=>{const m=calcularProducibles(e);if(m===null)return"";const T=m>=5?"#16a34a":m>=1?"#d97706":"#dc2626",A=m>=5?"#d1fae5":m>=1?"#fef3c7":"#fee2e2",H=m===0?"Sin stock MP":`Producibles: ${m}`;return`<div style="margin-top:3px;"><span style="font-size:9px;font-weight:700;padding:1px 7px;border-radius:99px;background:${A};color:${T};border:1px solid ${T}33;">\u{1F3ED} ${H}</span></div>`})()}
                </div>
            </td>
            <td class="px-4 py-3 text-gray-500 text-xs inv-col-hidden-sku">${_esc(e.sku||"\u2014")}</td>
            ...
            <td class="px-2 py-3">
        ...
        </tr>`}function z(e,x){const f=String(e.id),k=e.imageUrl?`<img src="${e.imageUrl}" alt="${_esc(e.name||"")}" style="width:40px;height:40px;object-fit:cover;border-radius:8px;" loading="lazy">`:`<span style="font-size:1.6rem;">${e.image||"\u{1F3AF}"}</span>`,$=(e.tablaPreciosVariable||[]).slice().sort((_,Q)=>_.cantidadMin-Q.cantidadMin),S=$.length?$.map(_=>`<span style="font-size:10px;background:#e0f2fe;color:#0369a1;padding:1px 7px;border-radius:99px;white-space:nowrap;">${_.cantidadMin} pzas = $${Number(_.precio).toFixed(2)}</span>`).join(" "):'<span style="font-size:10px;color:#9ca3af;">Sin rangos</span>',E=(e.mpComponentes||[]).length,y=(window.categories||[]).find(_=>String(_.id)===String(e.category)),F=y?`${y.emoji||""} ${y.name}`:"\u2014",W=$,U=W.length?W[0].precio/(W[0].cantidadMin||1):0,ee=U>0?`<div><span class="font-semibold text-gray-800" style="font-size:.95rem;">$${U.toFixed(2)}</span><div style="font-size:10px;color:#9ca3af;">por pieza</div></div>`:'<span style="color:#9ca3af;font-size:.8rem;">\u2014</span>',Y=g.get(String(e.id))??null;let m,T;if(Y!==null){const _=Y.piezas,Q=_===0?"#ef4444":_<=3?"#f59e0b":"#10b981",se=_===0?"#fee2e2":_<=3?"#fef3c7":"#d1fae5",re=Y.detalle.map(j=>`${j.nombre}: ${j.stock}\xF7${j.qty}=${j.posibles}pzs`).join(" | ");m=`<div style="display:flex;flex-direction:column;align-items:flex-start;gap:2px;">
                ...
                <span style="font-size:10px;color:#6b7280;">desde MP</span>
            </div>`,T=_===0?'<span class="badge-danger">Sin stock MP</span>':_<=3?'<span class="badge-warning">MP bajo</span>':'<span class="badge-success">Disponible</span>'}else m='<span style="font-size:.8rem;color:#9ca3af;font-style:italic;">Sin MP config.</span>',T='<span style="font-size:11px;background:#f3f4f6;color:#9ca3af;padding:2px 8px;border-radius:99px;">Sin MP config.</span>';const A=(e.mpComponentes||[]).reduce((_,Q)=>_+(parseFloat(Q.costUnit)||0)*(parseFloat(Q.qty)||1),0),H=e.rendimientoPorHoja||1,V=H>0?A/H:A,K=U>0?Math.round((U-V)/U*100):0,P=K>=40?"#10b981":K>=20?"#f59e0b":"#ef4444",te=U>0?`<div style="min-width:48px;">
        ...
        <tr style="animation:mkSectionIn 0.3s ease both;animation-delay:${x*.03}s" class="hover:bg-sky-50">
            ...
            <td class="px-4 py-3">
                <div>
                    ...
                    ${e.rendimientoPorHoja?`<div style="font-size:10px;color:#6b7280;margin-top:2px;">\u{1F5D2}\uFE0F ${e.rendimientoPorHoja} uds/hoja \xB7 ${E} MP${E!==1?"s":""}</div>`:E>0?`<div style="font-size:10px;color:#6b7280;margin-top:2px;">${E} MP${E!==1?"s":""}</div>`:""}
                    ${e.notas?`<div class="text-xs text-gray-400 truncate" style="max-width:160px;" title="${_esc(e.notas)}">${_esc(e.notas)}</div>`:""}
        ...
        <div style="margin-bottom:32px;border-radius:16px;overflow:hidden;border:1.5px solid ${f}33;box-shadow:0 2px 12px ${f}11;">
            ...
            ${re}
        </div>`}const N=n.filter(e=>!e.deletedAt),Z=N.length,D=N.reduce((e,x)=>{const f=l.get(String(x.id))??(typeof getStockEfectivo=="function"?getStockEfectivo(x):parseInt(x.stock)||0);return e+(Number(x.cost)||0)*Math.max(0,f)},0),J=N.filter(e=>(l.get(String(e.id))??(typeof getStockEfectivo=="function"?getStockEfectivo(e):parseInt(e.stock)||0))<=(e.stockMin||5)).length,X=N.filter(e=>(!e.tipo||e.tipo==="producto"||e.tipo==="producto_interno"||e.tipo==="pack")&&Number(e.price)>0),ae=X.length?X.reduce((e,x)=>{const f=Number(x.price)||0,k=Number(x.cost)||0;return e+(f>0?(f-k)/f*100:0)},0)/X.length:0;let oe=document.getElementById("invKpiBar");oe||(oe=document.createElement("div"),oe.id="invKpiBar",i.parentNode.insertBefore(oe,i)),oe.innerHTML=`
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:20px;">
        ...
        <div style="background:#fff;border:1.5px solid #e5e7eb;border-radius:14px;padding:14px 18px;box-shadow:0 1px 6px #0000000a;">
            <div style="font-size:1.4rem;font-weight:800;color:#7c3aed;">$${D.toLocaleString("es-MX",{minimumFractionDigits:0,maximumFractionDigits:0})}</div>
        ...
        </div>`)}function invSectionPage(t,o){const r=`_invPage_${t}`,s=window.products||[],a=t==="mp"?s.filter(c=>c.tipo==="materia_prima"):t==="svc"?s.filter(c=>c.tipo==="servicio"):t==="pv"?s.filter(c=>c.tipo==="producto_variable"):s.filter(c=>!c.tipo||c.tipo==="producto"||c.tipo==="producto_interno"||c.tipo==="pack"),i=(document.getElementById("inventorySearch")||{}).value?.trim().toLowerCase()||"",n=(document.getElementById("inventoryTagFilter")||{}).value||"",l=(document.getElementById("inventoryProveedorFilter")||{}).value?.trim().toLowerCase()||"",d=a.filter(c=>{const h=!i||c.name.toLowerCase().includes(i)||(c.sku||"").toLowerCase().includes(i)||(c.proveedor||"").toLowerCase().includes(i)||(c.notas||"").toLowerCase().includes(i)||(c.tags||[]).some(b=>b.toLowerCase().includes(i)),w=!n||c.tags&&c.tags.includes(n),I=!l||(c.proveedor||"").toLowerCase().includes(l);return h&&w&&I}),g=Math.max(1,Math.ceil(d.length/(window._invPageSize||10)));window[r]=Math.max(1,Math.min(o,g)),renderInventoryTable()}window.invSectionPage=invSectionPage;function _renderInventoryPagination(t,o,r,s,a){let i=document.getElementById("inventoryPaginationBar");if(!i){const g=document.getElementById("inventoryTable")?.closest('table, .overflow-x-auto, [class*="overflow"]');if(!g)return;i=document.createElement("div"),i.id="inventoryPaginationBar",g.insertAdjacentElement("afterend",i)}if(o<=1&&r<=a){i.innerHTML="";return}const n=Math.min(s+a,r),l=`Mostrando <b>${s+1}\u2013${n}</b> de <b>${r}</b> productos`;function d(){const g=[],c=(h,w)=>{for(let I=h;I<=w;I++)g.push(I)};return o<=7?c(1,o):(g.push(1),t>4&&g.push("..."),c(Math.max(2,t-2),Math.min(o-1,t+2)),t<o-3&&g.push("..."),g.push(o)),g.map(h=>{if(h==="...")return'<span style="padding:0 4px;color:#9ca3af;">\u2026</span>';const w=h===t;return`<button onclick="invGoToPage(${h})"
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;
            ...
            <div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap;">
                ...
                <select onchange="invChangePageSize(this.value)"
                    ...
                    ${[10,25,50,100].map(g=>`<option value="${g}" ${g===a?"selected":""}>${g} por p\xE1gina</option>`).join("")}
                </select>
            </div>
...
`});const G=new Blob([O],{type:"text/csv;charset=utf-8;"}),M=URL.createObjectURL(G),C=document.createElement("a");C.href=M,C.download=`movimientos-${i}.csv`,C.click(),URL.revokeObjectURL(M)},o.parentNode.insertBefore(w,o)),!a.length){o.innerHTML='<p class="text-gray-400 text-sm text-center py-4">Sin movimientos registrados</p>';return}const I={entrada:"\u{1F7E2}",salida:"\u{1F534}",ajuste:"\u{1F7E1}",creacion:"\u{1F535}",venta:"\u{1F7E0}",merma:"\u{1F7E4}"};o.innerHTML=a.slice(0,200).map(b=>{const L=new Date(b.fecha).toLocaleString("es-MX",{dateStyle:"short",timeStyle:"short"}),O=b.cantidad>=0?`+${b.cantidad}`:`${b.cantidad}`;return`<div style="display:flex;align-items:center;gap:10px;padding:8px 12px;border-bottom:1px solid #f3f4f6;font-size:13px;">
            ...
            <div style="flex:1;min-width:0;">
                ...
                <div style="color:#6b7280;font-size:11px;">${a} \xB7 ${s.tipo} \xB7 ${_esc(s.motivo||"Sin motivo")}</div>
            </div>
            <div style="text-align:right;white-space:nowrap;">
        ...
        </div>`}).join("")}window.renderStockMovements=renderStockMovements;function duplicarProducto(t){const o=(window.products||[]).find(s=>String(s.id)===String(t));if(!o){manekiToastExport("Producto no encontrado","err");return}const r=JSON.parse(JSON.stringify(o));r.id=_genId(),r.name="Copia de "+o.name,r.sku=(o.sku||"")+"-C",r.stock=0,r.historialPrecios=[],r.historialCostos=[],window.products.unshift(r),saveProducts(),renderInventoryTable(),manekiToastExport(`\u{1F4CB} "${r.name}" creado \u2014 ed\xEDtalo para ajustar stock y SKU`,"ok")}window.duplicarProducto=duplicarProducto;function abrirReporteRentabilidad(){const t=(window.products||[]).filter(n=>!n.tipo||n.tipo==="producto"||n.tipo==="producto_interno"),o=t.map(n=>{const l=n.price>0&&n.cost>0?(n.price-n.cost)/n.price*100:null;return{...n,_margen:l}}).sort((n,l)=>(l._margen??-1/0)-(n._margen??-1/0)),r=o.map((n,l)=>{const d=n._margen!==null?n._margen.toFixed(1)+"%":"\u2014",g=n.price>0&&n.cost>0?"$"+(n.price-n.cost).toFixed(2):"\u2014",c=n._margen===null?"#9ca3af":n._margen>=50?"#16a34a":n._margen>=30?"#d97706":"#dc2626";return`<tr style="border-bottom:1px solid #f3f4f6;">
  ...
  `}window.invUpdateBulkBar=invUpdateBulkBar;function invBulkDesseleccionar(){document.querySelectorAll(".inv-bulk-cb, .inv-bulk-all").forEach(t=>t.checked=!1),invUpdateBulkBar()}window.invBulkDesseleccionar=invBulkDesseleccionar;async function invBulkEliminar(){const t=invGetSelectedIds();if(!t.length)return;const o=(window.pedidos||[]).filter(a=>!["cancelado","finalizado"].includes(a.status||"")&&(a.productosInventario||[]).some(i=>t.includes(String(i.id))));if(o.length>0){const a=o.map(n=>n.folio||n.id).slice(0,5).join(", ");if(!(typeof showConfirm=="function"?await showConfirm(`\u26A0\uFE0F ${o.length} pedido(s) activo(s) usan estos productos (${a}). \xBFEliminar de todas formas?`,"Productos en pedidos activos"):confirm(`\u26A0\uFE0F ${o.length} pedido(s) activo(s) usan estos productos (${a}). \xBFEliminar de todas formas?`)))return}if(!(typeof showConfirm=="function"?await showConfirm(`\xBFEliminar ${t.length} producto(s)? Esta acci\xF3n no se puede deshacer.`,"\u{1F5D1} Confirmar eliminaci\xF3n"):confirm(`\xBFEliminar ${t.length} producto(s)? Esta acci\xF3n no se puede deshacer.`)))return;const s=[...t];if(window.products=(window.products||[]).filter(a=>!s.includes(String(a.id))),saveProducts(),renderInventoryTable(),invUpdateBulkBar(),typeof db<"u"&&db)try{await db.from("products").delete().in("id",s)}catch(a){console.warn("[BulkEliminar] Error al eliminar de Supabase relacional:",a)}manekiToastExport(`\u{1F5D1} ${s.length} producto(s) eliminados`,"ok")}window.invBulkEliminar=invBulkEliminar;function invBulkExportar(){const t=invGetSelectedIds(),o=(window.products||[]).filter(d=>t.includes(String(d.id))),r="tipo,nombre,sku,costo,precio,stock,stock_min,proveedor,notas",s=o.map(d=>[d.tipo||"pt",d.name,d.sku||"",d.cost||0,d.price||0,d.stock||0,d.stockMin||5,d.proveedor||"",d.notas||""].map(g=>`"${String(g).replace(/"/g,'""')}"`).join(",")),a="\uFEFF"+r+`
`+s.join(`
`),i=new Blob([a],{type:"text/csv;charset=utf-8;"}),n=URL.createObjectURL(i),l=document.createElement("a");l.href=n,l.download="inventario_seleccion.csv",l.click(),URL.revokeObjectURL(n),manekiToastExport(`\u{1F4E5} ${o.length} productos exportados`,"ok")}window.invBulkExportar=invBulkExportar;async function invBulkCambiarCategoria(){const t=invGetSelectedIds();if(!t.length)return;const o=await new Promise(s=>{const a=document.getElementById("mkBatchCatModal");a&&a.remove();const n=(window.categories||[]).map(d=>`<option value="${d.id}">${d.emoji||""} ${d.name}</option>`).join(""),l=document.createElement("div");l.id="mkBatchCatModal",l.className="mk-modal-overlay",l.innerHTML=`<div class="mk-modal-box" style="max-width:360px">
    ...
    `;const s=document.getElementById("mkInvFilterInfo");s?s.parentElement.insertBefore(r,s):o.parentElement.insertBefore(r,o.nextSibling)}}}function _mkInvCounterChips(){const t=document.getElementById("mkInvFilterInfo");if(!t)return;const o=document.getElementById("invDualContainer"),r=o?o.querySelectorAll(".inv-bulk-cb").length:0,s=(window.products||[]).length,a=document.getElementById("inventorySearch"),i=document.getElementById("inventoryTagFilter"),n=document.getElementById("inventoryProveedorFilter"),l=document.getElementById("inventoryTipoFilter"),d=[];a&&a.value.trim()&&d.push(`<span class="mk-filter-chip">Buscar: ${_esc(a.value.trim())}<button data-tip="Quitar" onclick="_mkInvClearOne('inventorySearch')">\u2715</button></span>`),l&&l.value&&d.push(`<span class="mk-filter-chip">Tipo: ${_esc(_MK_TIPO_LABELS[l.value]||l.value)}<button data-tip="Quitar" onclick="_mkInvSetTipo('')">\u2715</button></span>`),i&&i.value&&d.push(`<span class="mk-filter-chip">Tag: ${_esc(i.value)}<button data-tip="Quitar" onclick="_mkInvClearOne('inventoryTagFilter')">\u2715</button></span>`),n&&n.value&&d.push(`<span class="mk-filter-chip">Proveedor: ${_esc(n.options[n.selectedIndex]?.text||n.value)}<button data-tip="Quitar" onclick="_mkInvClearOne('inventoryProveedorFilter')">\u2715</button></span>`);let g=`<span class="mk-result-count">Mostrando <b>${r}</b> de ${s} producto${s!==1?"s":""}</span>`;d.length&&(g+=`<div class="mk-filter-chips">${d.join("")}<button class="mk-filter-clear" onclick="_mkInvClearFilters()">Limpiar todo</button></div>`),t.innerHTML=g,_mkInvSyncSeg()}function _mkInvSummaryRow(){const t=document.getElementById("invDualContainer");if(!t||!t.parentElement)return;const o=new Set([...t.querySelectorAll(".inv-bulk-cb")].map(l=>String(l.dataset.id))),r=window._invStockCache;let s=0,a=0,i=0;(window.products||[]).forEach(l=>{if(!o.has(String(l.id)))return;i++;const d=r?.get(String(l.id))??(Number(l.stock)||0);s+=(Number(l.cost)||0)*Math.max(0,d),d<=(Number(l.stockMin)||5)&&a++});let n=document.getElementById("mkInvSummary");if(i===0){n&&n.remove();return}n||(n=document.createElement("div"),n.id="mkInvSummary",n.className="mk-table-summary",n.style.cssText="display:flex;gap:18px;align-items:center;flex-wrap:wrap;padding:10px 18px;border-radius:0 0 14px 14px;margin-top:-2px;",t.parentElement.insertBefore(n,t.nextSibling)),n.innerHTML=`<span>Valor en costo: <b>$${s.toLocaleString("es-MX",{maximumFractionDigits:0})}</b></span><span style="color:var(--tx-muted);">${i} producto${i!==1?"s":""}</span>`+(a>0?`<span style="color:#dc2626;font-weight:800;">\u26A0 ${a} bajo stock</span>`:'<span style="color:#059669;font-weight:700;">\u2713 stock saludable</span>')}(function(){const o=window.renderInventoryTable;if(typeof o!="function"||o._mkWrapped)return;const r=function(...s){const a=o.apply(this,s);try{_mkInvToolbarOnce(),_mkInvCounterChips(),_mkInvSummaryRow()}catch{}return a};r._mkWrapped=!0,window.renderInventoryTable=r})();function _mkInvModal(t,o,r,s="700px"){let a=document.getElementById(t+"_ov");a||(a=document.createElement("div"),a.id=t+"_ov",a.style.cssText="position:fixed;inset:0;z-index:9100;background:rgba(0,0,0,.45);display:flex;align-items:center;justify-content:center;padding:16px;",document.body.appendChild(a)),a.innerHTML=`
    ...
    </div>`,a.onclick=i=>{i.target===a&&a.remove()},a.style.display="flex"}function abrirConteoFisico(){const t=(window.products||[]).filter(a=>a.tipo!=="servicio"&&a.activo!==!1);if(!t.length){typeof manekiToastExport=="function"&&manekiToastExport("Sin productos para contar","warn");return}const o=typeof window._esc=="function"?window._esc:a=>String(a||""),s=`
    ...
    <table style="width:100%;border-collapse:collapse;">
      ...
      <tbody>${t.map((a,i)=>{const n=typeof getStockEfectivo=="function"?getStockEfectivo(a):Number(a.stock)||0;return`<tr style="${i%2?"background:#f9fafb":""}">
      <td style="padding:7px 10px;font-weight:600;font-size:.85rem;">${o(a.name)}</td>
      <td style="padding:7px 10px;text-align:center;color:#6b7280;font-size:.82rem;">${o(a.category||"\u2014")}</td>
      <td style="padding:7px 10px;text-align:center;font-weight:700;">${n}</td>
      <td style="padding:7px 10px;text-align:center;">
        <input type="number" min="0" value="${n}" data-pid="${o(a.id)}" data-sistema="${n}"
    ...
    <div style="margin-top:18px;display:flex;gap:10px;justify-content:flex-end;">
      ...
      <button onclick="_mkAplicarConteoFisico()" style="padding:9px 24px;border-radius:10px;background:linear-gradient(135deg,#C5973B,#a8864f);color:white;border:none;cursor:pointer;font-weight:700;">\u2705 Aplicar ajustes</button>
    </div>`;_mkInvModal("mkConteo","\u{1F4CB} Conteo F\xEDsico de Inventario",s,"780px")}window.abrirConteoFisico=abrirConteoFisico,window._mkAplicarConteoFisico=function(){const t=document.querySelectorAll("#mkConteo_ov .conteo-input");let o=0;if(t.forEach(r=>{const s=r.dataset.pid,a=Number(r.dataset.sistema),i=Number(r.value);if(isNaN(i)||i===a)return;const n=(window.products||[]).find(d=>String(d.id)===String(s));if(!n)return;const l=i-a;n.stock=i,typeof registrarMovimiento=="function"&&registrarMovimiento({productoId:n.id,productoNombre:n.name,tipo:l>0?"entrada_manual":"salida_manual",cantidad:Math.abs(l),motivo:"Conteo f\xEDsico",stockAntes:a,stockDespues:i}),o++}),o===0){typeof manekiToastExport=="function"&&manekiToastExport("Sin diferencias que ajustar","warn");return}typeof saveProducts=="function"&&saveProducts(),typeof renderInventoryTable=="function"&&renderInventoryTable(),document.getElementById("mkConteo_ov")?.remove(),typeof manekiToastExport=="function"&&manekiToastExport(`\u2705 ${o} ajuste${o!==1?"s":""} aplicados`,"ok")};function abrirReabastecimiento(){const t=(window.products||[]).filter(a=>a.tipo==="servicio"||a.activo===!1?!1:(typeof getStockEfectivo=="function"?getStockEfectivo(a):Number(a.stock)||0)<=(Number(a.stockMin)||5));if(!t.length){typeof manekiToastExport=="function"&&manekiToastExport("\u2705 Sin productos bajo stock m\xEDnimo","ok");return}const o=typeof window._esc=="function"?window._esc:a=>String(a||""),r={};t.forEach(a=>{const i=a.proveedor||"Sin proveedor";r[i]||(r[i]=[]),r[i].push(a)});const s=Object.entries(r).map(([a,i])=>{const n=o(a),l=i.map(c=>{const h=typeof getStockEfectivo=="function"?getStockEfectivo(c):Number(c.stock)||0,w=Number(c.stockMin)||5,I=Math.max(1,w*2-h);return`<tr><td style="padding:6px 10px;font-size:.83rem;font-weight:600;">${o(c.name)}</td>
        ...
        <td style="padding:6px 10px;text-align:center;font-size:.82rem;font-weight:700;color:#C5973B;">${I}</td>
...
${i.map(c=>{const h=Number(c.stock)||0,w=Number(c.stockMin)||5;return`\u2022 ${c.name}: ${Math.max(1,w*2-h)} ${c.unidad||"pza"}`}).join(`
`)}`),g=p?.proveedorUrl?.startsWith("http")?p.proveedorUrl:`https://wa.me/?text=${d}`;return`<div style="margin-bottom:18px;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;">
      <div style="background:#f9fafb;padding:10px 14px;display:flex;align-items:center;justify-content:space-between;">
        <b style="font-size:.88rem;">${n} (${i.length})</b>
        <div style="display:flex;gap:6px;">
          <a href="https://wa.me/?text=${encodeURIComponent(`Hola, necesito reabastecer:
${i.map(c=>`\u2022 ${c.name}: ${Math.max(1,(Number(c.stockMin)||5)*2-(typeof getStockEfectivo=="function"?getStockEfectivo(c):Number(c.stock)||0))} ${c.unidad||"pza"}`).join(`
`)}`)}" target="_blank"
...
`),s=document.createElement("a");s.href=URL.createObjectURL(new Blob([r],{type:"text/csv;charset=utf-8;"}));const a=new Date,i=`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`;s.download=`reabastecimiento_${i}.csv`,s.click()};function mostrarDonutCategoria(){const t=typeof window._esc=="function"?window._esc:l=>String(l||""),o={};(window.products||[]).forEach(l=>{if(l.tipo==="servicio"||l.activo===!1)return;const d=typeof getStockEfectivo=="function"?getStockEfectivo(l):Number(l.stock)||0,g=(Number(l.price)||0)*d,c=l.category||"Sin categor\xEDa";o[c]=(o[c]||0)+g});const r=Object.entries(o).sort((l,d)=>d[1]-l[1]),s=r.reduce((l,[,d])=>l+d,0),a=["#C5973B","#7c3aed","#10b981","#3b82f6","#f59e0b","#ef4444","#06b6d4","#8b5cf6","#f97316","#14b8a6"],i=r.map(([l,d],g)=>{const c=s>0?(d/s*100).toFixed(1):"0";return`<tr>
      <td style="padding:6px 12px;">
        <span style="display:inline-block;width:10px;height:10px;border-radius:50%;background:${a[g%a.length]};margin-right:6px;"></span>
        ${t(l)}
      </td>
    ...
    </div>`;_mkInvModal("mkDonut","\u{1F4CA} Valor de Inventario por Categor\xEDa",n,"700px"),setTimeout(()=>{const l=document.getElementById("mkDonutCat");if(l)try{const d=window.Chart;if(typeof d>"u"){l.style.display="none";return}new d(l,{type:"doughnut",data:{labels:r.map(([g])=>g),datasets:[{data:r.map(([,g])=>Math.round(g)),backgroundColor:r.map((g,c)=>a[c%a.length]),borderWidth:2}]},options:{plugins:{legend:{display:!1}},cutout:"65%",responsive:!1}})}catch{l&&(l.style.display="none")}},100)}window.mostrarDonutCategoria=mostrarDonutCategoria;function sugerirStockMinimo(){const t=typeof window._esc=="function"?window._esc:n=>String(n||""),o=new Date;o.setDate(o.getDate()-60);const r={};(window.pedidosFinalizados||[]).forEach(n=>{const l=n.fechaFinalizado||n.entrega||"";l&&new Date(l)<o||(n.productosInventario||[]).forEach(d=>{!d.id||d.id==="libre"||(r[String(d.id)]=(r[String(d.id)]||0)+(Number(d.quantity||d.cantidad)||1))})});const s=(window.products||[]).filter(n=>n.tipo!=="servicio"&&n.activo!==!1&&r[String(n.id)]);if(!s.length){typeof manekiToastExport=="function"&&manekiToastExport("Sin datos de consumo en los \xFAltimos 60 d\xEDas","warn");return}const i=`
    ...
    <table style="width:100%;border-collapse:collapse;">
      ...
      <tbody>${s.map(n=>{const l=r[String(n.id)]||0,d=l/60,g=Math.max(1,Math.ceil(d*14)),c=Number(n.stockMin)||0,h=g!==c?`<span style="color:${g>c?"#10b981":"#f59e0b"};font-weight:700;">${g>c?"\u25B2":"\u25BC"} ${g}</span>`:`<span style="color:#6b7280;">${g} (sin cambio)</span>`;return`<tr>
      ...
      <td style="padding:6px 10px;text-align:center;font-size:.82rem;">${h}</td>
      <td style="padding:6px 10px;text-align:center;">
        <input type="checkbox" checked data-pid="${t(n.id)}" data-nuevo="${g}" class="mkStockMinCb" style="accent-color:#C5973B;width:16px;height:16px;">
      </td>
    </tr>`}).join("")}</tbody>
    </table>
    <div style="margin-top:18px;display:flex;gap:10px;justify-content:flex-end;">
      ...
      <button onclick="_mkAplicarStockMinSugerido()" style="padding:9px 24px;border-radius:10px;background:linear-gradient(135deg,#C5973B,#a8864f);color:white;border:none;cursor:pointer;font-weight:700;">\u{1F916} Aplicar seleccionados</button>
    </div>`;_mkInvModal("mkStockMin","\u{1F916} Stock M\xEDnimo Sugerido",i,"780px")}window.sugerirStockMinimo=sugerirStockMinimo,window._mkAplicarStockMinSugerido=function(){const t=document.querySelectorAll("#mkStockMin_ov .mkStockMinCb:checked");let o=0;t.forEach(r=>{const s=r.dataset.pid,a=Number(r.dataset.nuevo),i=(window.products||[]).find(n=>String(n.id)===String(s));!i||isNaN(a)||(i.stockMin=a,o++)}),o&&(typeof saveProducts=="function"&&saveProducts(),typeof renderInventoryTable=="function"&&renderInventoryTable(),document.getElementById("mkStockMin_ov")?.remove(),typeof manekiToastExport=="function"&&manekiToastExport(`\u2705 Stock m\xEDnimo actualizado en ${o} producto${o!==1?"s":""}`,"ok"))};function archivarProducto(t){const o=(window.products||[]).find(i=>String(i.id)===String(t));if(!o)return;const r=o.activo!==!1,s=r?"archivar":"desarchivar",a=r?`\xBFArchivar "${o.name}"? Dejar\xE1 de aparecer en inventario y b\xFAsquedas, pero se conserva el historial.`:`\xBFDesarchivar "${o.name}"? Volver\xE1 a aparecer en inventario.`;typeof showConfirm=="function"&&showConfirm(a,r?"\u{1F4C1} Archivar":"\u{1F513} Desarchivar").then(i=>{i&&(o.activo=!r,o.updatedAt=new Date().toISOString(),typeof saveProducts=="function"&&saveProducts(),typeof renderInventoryTable=="function"&&renderInventoryTable(),typeof manekiToastExport=="function"&&manekiToastExport(r?`\u{1F4C1} "${o.name}" archivado`:`\u{1F513} "${o.name}" desarchivado`,"ok"))})}window.archivarProducto=archivarProducto;function abrirMovimientoProducto(t){const o=typeof window._esc=="function"?window._esc:u=>String(u||""),r=(window.products||[]).find(u=>String(u.id)===String(t));if(!r){typeof manekiToastExport=="function"&&manekiToastExport("Producto no encontrado","warn");return}const s=Date.now()-90*864e5,a=new Set,i=[],n=u=>{if(!u)return;const v=u.fecha?new Date(u.fecha+(u.hora?"T"+u.hora:"")).getTime():u.timestamp?new Date(u.timestamp).getTime():0;if(v&&v<s)return;const z=u.id||String(u.productoId||t)+"_"+v+"_"+(u.cantidad||0);a.has(z)||(a.add(z),i.push({...u,_ts:v||Date.now()}))};(r.movimientos||[]).forEach(n),(window.stockMovimientos||[]).filter(u=>String(u.productoId)===String(t)).forEach(n),i.sort((u,v)=>v._ts-u._ts);const l=[];for(let u=12;u>=0;u--){const v=new Date(Date.now()-u*7*864e5),z=new Date(v.getTime()-7*864e5),q=`${z.getDate()}/${z.getMonth()+1}`;let N=0,Z=0;i.forEach(D=>{if(D._ts>=z.getTime()&&D._ts<v.getTime()){const J=D.stockDespues!=null&&D.stockAntes!=null?Number(D.stockDespues)-Number(D.stockAntes):0,X=(D.tipo||"").toLowerCase();J>0||X.includes("entrada")||X.includes("compra")||X.includes("ajuste_positivo")?N+=Math.abs(Number(D.cantidad)||Math.abs(J)||1):Z+=Math.abs(Number(D.cantidad)||Math.abs(J)||1)}}),l.push({label:q,entradas:N,salidas:Z})}const d=Math.max(1,...l.map(u=>Math.max(u.entradas,u.salidas))),g=480,c=100,h=Math.floor((g-20)/l.length/2)-1,w=l.map((u,v)=>{const z=10+v*(h*2+4),q=Math.round(u.entradas/d*(c-20)),N=Math.round(u.salidas/d*(c-20));return`
      <rect x="${z}" y="${c-10-q}" width="${h}" height="${q}" fill="#10b981" rx="2" opacity=".85" title="Entradas: ${u.entradas}"/>
      <rect x="${z+h+1}" y="${c-10-N}" width="${h}" height="${N}" fill="#ef4444" rx="2" opacity=".75" title="Salidas: ${u.salidas}"/>
      <text x="${z+h}" y="${c-1}" text-anchor="middle" font-size="8" fill="#9ca3af">${u.label}</text>`}).join(""),I=i.length===0?'<p style="text-align:center;color:#9ca3af;padding:20px 0;font-size:.85rem;">Sin movimientos en los \xFAltimos 90 d\xEDas</p>':`
  ...
  `,B=`
    ...
    ${C}`;_mkInvModal("mkMovProd",`\u{1F4C8} Movimientos \u2014 ${o(r.name||"Producto")} (90d)`,B,"780px")}window.abrirMovimientoProducto=abrirMovimientoProducto;function abrirTendenciaInventario(){const t=window.inventarioSnapshots||[];if(t.length===0){typeof manekiToastExport=="function"&&manekiToastExport("Sin datos hist\xF3ricos a\xFAn. Los snapshots se generan autom\xE1ticamente.","warn");return}const o=[...t].sort((M,C)=>(M.fecha||"").localeCompare(C.fecha||"")),r=o.map(M=>M.fecha||""),s=o.map(M=>Number(M.valorTotal||M.valor||0)),a=540,i=140,n=Math.max(1,...s),l=Math.min(...s),d=n-l||1,c=`<polyline points="${s.map((M,C)=>{const B=20+C/Math.max(1,s.length-1)*(a-40),u=i-20-(M-l)/d*(i-40);return`${B},${u}`}).join(" ")}" fill="none" stroke="#6366f1" stroke-width="2.5" stroke-linejoin="round"/>`,h=s.map((M,C)=>{const B=20+C/Math.max(1,s.length-1)*(a-40),u=i-20-(M-l)/d*(i-40);return`<circle cx="${B}" cy="${u}" r="3.5" fill="#6366f1" opacity=".9"><title>${r[C]}: $${M.toLocaleString("es-MX")}</title></circle>`}).join(""),w=r.filter((M,C)=>C===0||C===r.length-1||C%Math.ceil(r.length/6)===0).map((M,C,B)=>`<text x="${20+r.indexOf(M)/Math.max(1,r.length-1)*(a-40)}" y="${i-2}" text-anchor="middle" font-size="9" fill="#9ca3af">${M.slice(5)}</text>`).join(""),I=s[s.length-1]||0,b=s[0]||0,L=b>0?((I-b)/b*100).toFixed(1):"\u2014",O=Number(L)>=0?"#10b981":"#ef4444",G=`
    <div style="display:flex;gap:12px;margin-bottom:14px;flex-wrap:wrap;">
      <div style="flex:1;min-width:100px;background:#eff6ff;border-radius:10px;padding:10px 14px;text-align:center;">
    ...
    <div style="background:#f9fafb;border-radius:10px;padding:12px;margin-bottom:14px;">
      <svg viewBox="0 0 ${a} ${i}" width="100%" height="140" style="display:block;overflow:visible;">
        <line x1="20" y1="${i-20}" x2="${a-10}" y2="${i-20}" stroke="#e5e7eb" stroke-width="1"/>
        ${c}${h}${w}
      </svg>
